    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
      ...
      //  ipaddress = "192.168.6.41";
        ...
        else
        {
            ...
            " where   clientLoginMaster.clientId='" + txtClientId.Text + "' "+
           "  ";//and clientLoginMaster.UserId='" + txtUser.Text + "' and clientLoginMaster.Password='" + PageMgmt.Encrypted(txtPassword.Text) + "' and clientLoginMaster.Password='" + PageMgmt.Encrypted(txtPassword.Text) + "'
