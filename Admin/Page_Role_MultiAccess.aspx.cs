...
public partial class Shoppingcart_Admin_Page_role_Access : System.Web.UI.Page
{
    ...
    {
        string strcln1 = " SELECT [Role_id],[Role_name],[ActiveDeactive] FROM [RoleMaster] where ActiveDeactive=1 and compid='" + compid + "' and ActiveDeactive='1'   order by Role_name ";
    ...
    {
        //string k1 = "SELECT [Role_id],[Role_name],[ActiveDeactive] FROM [RoleMaster] where ActiveDeactive=1 and compid='" + compid + "'  order by Role_name";       
    ...
    protected void fillgridmenu()
    {
        ...
        if (Rlist.SelectedIndex == 0)//Menu Level Access
        {
            ...
            string k1 = " SELECT Distinct MainMenuMaster.MainMenuName,MainMenuMaster.MainMenuId,MainMenuMaster.MainMenuId "+
                //,Case when( RoleMenuAccessRightTbl.AccessRight IS NULL) then '0' else AccessRight end as AccessRight " +
    ...
    //For Menu
    protected void inserFillSubmenuAfteMnuFullAccess(string lblroleid , string menuid, Boolean CheckEdit_Allow, Boolean CheckDelete_Allow, Boolean CheckDownload_Allow, Boolean CheckInsert_Allows, Boolean CheckUpdate_Allow, Boolean CheckView_Allow,Boolean CheckGo_Allow, Boolean CheckSendMail_Allow)
    {
        string fil = "";
        ...
        if (dt.Rows.Count > 0)
        {
            for (int j = 0; j < dt.Rows.Count; j++)
            {
                ...
                string k11 = "SELECT * from RoleSubMenuAccessRightTbl where RoleId='" + lblroleid + "' and SubMenuId='" + dt.Rows[j]["SubMenuId"].ToString() + "'";
                ...
                if (dt1.Rows.Count == 0)
                {
                    ...
                    " Values( '" + dt.Rows[j]["SubMenuId"].ToString() + "','" + lblroleid + "','1','" + CheckEdit_Allow + "','" + CheckDelete_Allow + "','" + CheckDownload_Allow + "','" + CheckInsert_Allows + "','" + CheckUpdate_Allow + "','" + CheckView_Allow + "','" + CheckGo_Allow + "','" + CheckSendMail_Allow + "')";                                             
                ...
                else
                {
                    ...
                    " where SubMenuId='" + dt.Rows[j]["SubMenuId"].ToString() + "' and RoleId='" + lblroleid + "'";
                    cmd22 = new SqlCommand(str11, con);
                    con.Close(); 
                    con.Open();
                    cmd22.ExecuteNonQuery();
                ...
                FillPagsAfteMnuFullAccess(lblroleid, menuid, CheckEdit_Allow, CheckDelete_Allow, CheckDownload_Allow, CheckInsert_Allows, CheckUpdate_Allow, CheckView_Allow, CheckGo_Allow, CheckSendMail_Allow);
            }
        }
       
    }
    protected void FillPagsAfteMnuFullAccess(string lblroleid, string menuid, Boolean CheckEdit_Allow, Boolean CheckDelete_Allow, Boolean CheckDownload_Allow, Boolean CheckInsert_Allows, Boolean CheckUpdate_Allow, Boolean CheckView_Allow, Boolean CheckGo_Allow, Boolean CheckSendMail_Allow)
    {
        string fil = "";
        ...
        string k1 = " Select Distinct PageMaster.PageName,PageMaster.PageTitle,PageMaster.PageId, MainMenuMaster.MainMenuName,MainMenuMaster.MainMenuId,SubMenuMaster.SubMenuName,SubMenuMaster.SubMenuId,Case when( RolePageAccessRightTbl.AccessRight IS NULL) then '0' else AccessRight end as AccessRight,  Case when( RolePageAccessRightTbl.Edit_Right IS NULL) then '0' else Edit_Right end as Edit_Right,Case when( RolePageAccessRightTbl.Delete_Right IS NULL) then '0' else Delete_Right end as Delete_Right, Case when( RolePageAccessRightTbl.Download_Right IS NULL) then '0' else Download_Right end as Download_Right,Case when( RolePageAccessRightTbl.Insert_Right IS NULL) then '0' else Insert_Right end as Insert_Right, Case when( RolePageAccessRightTbl.Update_Right IS NULL) then '0' else  Update_Right end as Update_Right,Case when( RolePageAccessRightTbl.View_Right IS NULL) then '0' else View_Right end as View_Right, Case when( RolePageAccessRightTbl.Go_Right IS NULL) then '0' else Go_Right end as Go_Right,Case when( RolePageAccessRightTbl.SendMail_Right IS NULL) then '0' else SendMail_Right end as SendMail_Right " +
                        " FROM  RolePageAccessRightTbl Right join PageMaster on PageMaster.PageId=RolePageAccessRightTbl.PageId and    RolePageAccessRightTbl.RoleId='" + lblroleid + "'  inner join MainMenuMaster on MainMenuMaster.MainMenuId= PageMaster.MainMenuId left join SubMenuMaster on SubMenuMaster.SubMenuId= PageMaster.SubMenuId inner join MasterPageMaster on MasterPageMaster.MasterPageId=MainMenuMaster.MasterPage_Id inner join WebsiteSection on MasterPageMaster.WebsiteSectionId=WebsiteSection.WebsiteSectionId inner join WebsiteMaster on WebsiteMaster.ID=WebsiteSection.WebsiteMasterId inner join VersionInfoMaster on VersionInfoMaster.VersionInfoId=WebsiteMaster.VersionInfoId  inner join ProductMaster on ProductMaster.ProductId=VersionInfoMaster.ProductId  where  PageMaster.Active=1 AND MainMenuMaster.MainMenuId='" + menuid + "' AND WebsiteMaster.compid='" + Session["ClientId"] + "' " + fil + " order by MainMenuName,SubMenuName,PageName";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                 string k11;
                 k11 = " SELECT * from RolePageAccessRightTbl where RoleId='" + lblroleid + "' and PageId='" + dt.Rows[j]["PageId"].ToString() + "'";
                    DataTable dt1 = new DataTable();
                    SqlDataAdapter da = new SqlDataAdapter(k11, con);
                    da.Fill(dt1);
                    if (dt1.Rows.Count == 0)
                    {
                        ...
                        " Values( '" + dt.Rows[j]["PageId"].ToString() + "','" + lblroleid + "','1','" + CheckEdit_Allow + "','" + CheckDelete_Allow + "','" + CheckDownload_Allow + "','" + CheckInsert_Allows + "','" + CheckUpdate_Allow + "','" + CheckView_Allow + "','" + CheckGo_Allow + "','" + CheckSendMail_Allow + "')";
                        cmd22 = new SqlCommand(str11, con);
                        con.Open();
                        cmd22.ExecuteNonQuery();                       
                        con.Close();
                    ...
                    else
                    {
                        ...
                        " where PageId='" + dt.Rows[j]["PageId"].ToString() + "' and RoleId='" + lblroleid + "'";
                        cmd22 = new SqlCommand(str11, con);
                        con.Open();
                        cmd22.ExecuteNonQuery();
                        con.Close();
    ...
    protected void DeleteFillSubmenuAfteMnuLimitedAccess(string lblroleid, string menuid, Boolean CheckEdit_Allow, Boolean CheckDelete_Allow, Boolean CheckDownload_Allow, Boolean CheckInsert_Allows, Boolean CheckUpdate_Allow, Boolean CheckView_Allow, Boolean CheckGo_Allow, Boolean CheckSendMail_Allow)
    {
        string fil = "";
        ...
        if (dt.Rows.Count > 0)
        {
            for (int j = 0; j < dt.Rows.Count; j++)
            {
                ...
                SqlCommand cmd22;
                string str11 = " Delete  from RoleSubMenuAccessRightTbl where  RoleId='" + lblroleid + "' and  SubMenuId='" + dt.Rows[j]["SubMenuId"].ToString() + "'";
                cmd22 = new SqlCommand(str11, con);
                con.Open();
                cmd22.ExecuteNonQuery();
                con.Close();

                DeleteFillPagsAfteMnuLimitedAccess(lblroleid ,menuid, CheckEdit_Allow, CheckDelete_Allow, CheckDownload_Allow, CheckInsert_Allows, CheckUpdate_Allow, CheckView_Allow, CheckGo_Allow, CheckSendMail_Allow);
            }
        }

    }
    protected void DeleteFillPagsAfteMnuLimitedAccess(string lblroleid, string menuid, Boolean CheckEdit_Allow, Boolean CheckDelete_Allow, Boolean CheckDownload_Allow, Boolean CheckInsert_Allows, Boolean CheckUpdate_Allow, Boolean CheckView_Allow, Boolean CheckGo_Allow, Boolean CheckSendMail_Allow)
    {
        string fil = "";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                SqlCommand cmd22;
                string str11 = " Delete  from RolePageAccessRightTbl where  RoleId='" + lblroleid + "' and PageId='" + dt.Rows[j]["PageId"].ToString() + "'";
                cmd22 = new SqlCommand(str11, con);
                con.Open();
                cmd22.ExecuteNonQuery();
                con.Close();
    ...
    // For  SubMenu
    protected void inserFillPagsAfteSubmenuFullAccess(string lblroleid,  string Submenu, Boolean CheckEdit_Allow, Boolean CheckDelete_Allow, Boolean CheckDownload_Allow, Boolean CheckInsert_Allows, Boolean CheckUpdate_Allow, Boolean CheckView_Allow, Boolean CheckGo_Allow, Boolean CheckSendMail_Allow)
    {
        string fil = "";
    ...
    protected void RemoveFillPagsAfteSubmenuLimitedAccess(string lblroleid, string submenu, Boolean CheckEdit_Allow, Boolean CheckDelete_Allow, Boolean CheckDownload_Allow, Boolean CheckInsert_Allows, Boolean CheckUpdate_Allow, Boolean CheckView_Allow, Boolean CheckGo_Allow, Boolean CheckSendMail_Allow)
    {
        string fil = "";       
        //  string k1 = "select MainMenuMaster.*,SubMenuMaster.* from  MainMenuMaster  inner join SubMenuMaster on SubMenuMaster.MainMenuId= MainMenuMaster.MainMenuId  inner join MasterPageMaster on MasterPageMaster.MasterPageId=MainMenuMaster.MasterPage_Id inner join WebsiteSection on MasterPageMaster.WebsiteSectionId=WebsiteSection.WebsiteSectionId inner join WebsiteMaster on WebsiteMaster.ID=WebsiteSection.WebsiteMasterId inner join VersionInfoMaster on VersionInfoMaster.VersionInfoId=WebsiteMaster.VersionInfoId  inner join ProductMaster on ProductMaster.ProductId=VersionInfoMaster.ProductId where ProductMaster.ClientMasterId='" + compid + "' and VersionInfoMaster.Active ='True' and WebsiteMaster.compid='"+Session["ClientId"]+"' and MainMenuMaster.Active='1' " + fil + " order by MainMenuName,SubMenuName";
        string k1 = " Select Distinct PageMaster.PageName,PageMaster.PageTitle,PageMaster.PageId, MainMenuMaster.MainMenuName,MainMenuMaster.MainMenuId,SubMenuMaster.SubMenuName,SubMenuMaster.SubMenuId,Case when( RolePageAccessRightTbl.AccessRight IS NULL) then '0' else AccessRight end as AccessRight,  Case when( RolePageAccessRightTbl.Edit_Right IS NULL) then '0' else Edit_Right end as Edit_Right,Case when( RolePageAccessRightTbl.Delete_Right IS NULL) then '0' else Delete_Right end as Delete_Right, Case when( RolePageAccessRightTbl.Download_Right IS NULL) then '0' else Download_Right end as Download_Right,Case when( RolePageAccessRightTbl.Insert_Right IS NULL) then '0' else Insert_Right end as Insert_Right, Case when( RolePageAccessRightTbl.Update_Right IS NULL) then '0' else  Update_Right end as Update_Right,Case when( RolePageAccessRightTbl.View_Right IS NULL) then '0' else View_Right end as View_Right, Case when( RolePageAccessRightTbl.Go_Right IS NULL) then '0' else Go_Right end as Go_Right,Case when( RolePageAccessRightTbl.SendMail_Right IS NULL) then '0' else SendMail_Right end as SendMail_Right " +
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow grdRole in GvRoleName.Rows)
        {
            CheckBox cbItem = (CheckBox)grdRole.FindControl("cbItem");
            
            Label lblroleid = (Label)grdRole.FindControl("lblroleid");
            ...
            if (Rlist.SelectedValue == "2")
            {
                foreach (GridViewRow grd in grdpage.Rows)
                {
                    ...
                    CheckBox CheckSendMail_Allow = (CheckBox)grd.FindControl("CheckBoxSendMail1");
                    if (rd1.SelectedValue != "3")
                    {                    
                    if (rd1.SelectedValue == "1" || rd1.SelectedValue == "2")
                    {
                        string k11;
                        k11 = " SELECT * from RolePageAccessRightTbl where RoleId='" + lblroleid.Text + "' and PageId='" + lblpageid.Text + "'";
                        DataTable dt1 = new DataTable();
                        SqlDataAdapter da = new SqlDataAdapter(k11, con);
                        da.Fill(dt1);
                        if (dt1.Rows.Count == 0)
                        {
                            SqlCommand cmd22 = new SqlCommand();
                            string str11 = " insert into RolePageAccessRightTbl(PageId,RoleId,AccessRight,Edit_Right,Delete_Right,Download_Right,Insert_Right,Update_Right,View_Right,Go_Right,SendMail_Right) " +
                            " Values( '" + lblpageid.Text + "','" + lblroleid.Text + "','" + rd1.SelectedValue + "','" + CheckEdit_Allow.Checked + "','" + CheckDelete_Allow.Checked + "','" + CheckDownload_Allow.Checked + "','" + CheckInsert_Allows.Checked + "','" + CheckUpdate_Allow.Checked + "','" + CheckView_Allow.Checked + "','" + CheckGo_Allow.Checked + "','" + CheckSendMail_Allow.Checked + "')";
                            cmd22 = new SqlCommand(str11, con);
                            con.Open();
                            cmd22.ExecuteNonQuery();
                            inc += 1;
                        ...
                        else
                        {
                            ...
                            " where PageId='" + lblpageid.Text + "' and RoleId='" + lblroleid.Text + "'";
                            cmd22 = new SqlCommand(str11, con);
                            con.Open();
                            cmd22.ExecuteNonQuery();
                            con.Close();
                    ...
                    else if (rd1.SelectedValue == "0")
                    {
                        SqlCommand cmd22;
                        string str11 = " Delete  from RolePageAccessRightTbl where  RoleId='" + lblroleid.Text + "' and PageId='" + lblpageid.Text + "'";
                        cmd22 = new SqlCommand(str11, con);
                        con.Open();
                        cmd22.ExecuteNonQuery();
                        con.Close();
            ...
            else if (Rlist.SelectedValue == "0")
            {
                foreach (GridViewRow grd in grdmain.Rows)
                {
                    ...
                    {
                        string k11;
                        string ss = lblroleid.Text;
                        k11 = "SELECT * from RoleMenuAccessRightTbl where RoleId='" + lblroleid.Text + "' and MenuId='" + lblmainmanu.Text + "'";
                        DataTable dt1 = new DataTable();
                        SqlDataAdapter da = new SqlDataAdapter(k11, con);
                        da.Fill(dt1);
                        ...
                        if (dt1.Rows.Count == 0)
                        {
                            ...
                            " Values( '" + lblmainmanu.Text + "','" + lblroleid.Text + "','" + rd1.SelectedValue + "','" + CheckEdit_Allow.Checked + "','" + CheckDelete_Allow.Checked + "','" + CheckDownload_Allow.Checked + "','" + CheckInsert_Allows.Checked + "','" + CheckUpdate_Allow.Checked + "','" + CheckView_Allow.Checked + "','" + CheckGo_Allow.Checked + "','" + CheckSendMail_Allow.Checked + "')";
                        ...
                        else
                        {
                            ...
                            " where MenuId='" + lblmainmanu.Text + "' and RoleId='" + lblroleid.Text + "'";
                            cmd22 = new SqlCommand(str11, con);
                            con.Open();
                            cmd22.ExecuteNonQuery();
                            con.Close();
                        ...
                        if (updateibchildlevel == true)
                        {
                            if (rd1.SelectedValue == "1")//Full
                            {
                                inserFillSubmenuAfteMnuFullAccess(lblroleid.Text ,lblmainmanu.Text, CheckEdit_Allow.Checked, CheckDelete_Allow.Checked, CheckDownload_Allow.Checked, CheckInsert_Allows.Checked, CheckUpdate_Allow.Checked, CheckView_Allow.Checked, CheckGo_Allow.Checked, CheckSendMail_Allow.Checked);
                            }
                            else if (rd1.SelectedValue == "2")//Limited
                            {
                                DeleteFillSubmenuAfteMnuLimitedAccess(lblroleid.Text,  lblmainmanu.Text, CheckEdit_Allow.Checked, CheckDelete_Allow.Checked, CheckDownload_Allow.Checked, CheckInsert_Allows.Checked, CheckUpdate_Allow.Checked, CheckView_Allow.Checked, CheckGo_Allow.Checked, CheckSendMail_Allow.Checked);
                            }
                        }
                    }
                    else if (rd1.SelectedValue == "0")
                    {
                        SqlCommand cmd22;
                        string str11 = " Delete  from RoleMenuAccessRightTbl where  RoleId='" + lblroleid.Text + "' and MenuId='" + lblmainmanu.Text + "'";
                        cmd22 = new SqlCommand(str11, con);
                        con.Open();
                        cmd22.ExecuteNonQuery();
                        con.Close();
            ...
            else if (Rlist.SelectedValue == "1")
            {
                foreach (GridViewRow grd in Grdsub.Rows)
                {
                    ...
                    if (rd1.SelectedValue == "1" || rd1.SelectedValue == "2")
                    {
                        ...
                        k11 = "SELECT * from RoleSubMenuAccessRightTbl where RoleId='" + lblroleid.Text + "' and SubMenuId='" + lblsubmanu.Text + "'";
                        DataTable dt1 = new DataTable();
                        ...
                        if (dt1.Rows.Count == 0)
                        {
                            SqlCommand cmd22 = new SqlCommand();
                            string str11 = "insert into RoleSubMenuAccessRightTbl(SubMenuId,RoleId,AccessRight,Edit_Right,Delete_Right,Download_Right,Insert_Right,Update_Right,View_Right,Go_Right,SendMail_Right) " +
                            " Values( '" + lblsubmanu.Text + "','" + lblroleid.Text + "','" + rd1.SelectedValue + "','" + CheckEdit_Allow.Checked + "','" + CheckDelete_Allow.Checked + "','" + CheckDownload_Allow.Checked + "','" + CheckInsert_Allows.Checked + "','" + CheckUpdate_Allow.Checked + "','" + CheckView_Allow.Checked + "','" + CheckGo_Allow.Checked + "','" + CheckSendMail_Allow.Checked + "')";
                        ...
                        else
                        {
                            ...
                            " where SubMenuId='" + lblsubmanu.Text + "' and RoleId='" + lblroleid.Text + "'";
                        ...
                        if (updateibchildlevel == true)
                        {
                            if (rd1.SelectedValue == "1")//Full
                            {
                                inserFillPagsAfteSubmenuFullAccess(lblroleid.Text, lblsubmanu.Text, CheckEdit_Allow.Checked, CheckDelete_Allow.Checked, CheckDownload_Allow.Checked, CheckInsert_Allows.Checked, CheckUpdate_Allow.Checked, CheckView_Allow.Checked, CheckGo_Allow.Checked, CheckSendMail_Allow.Checked);
                            }
                            else if (rd1.SelectedValue == "2")//Limited
                            {
                                RemoveFillPagsAfteSubmenuLimitedAccess(lblroleid.Text, lblsubmanu.Text, CheckEdit_Allow.Checked, CheckDelete_Allow.Checked, CheckDownload_Allow.Checked, CheckInsert_Allows.Checked, CheckUpdate_Allow.Checked, CheckView_Allow.Checked, CheckGo_Allow.Checked, CheckSendMail_Allow.Checked);
                            }
                        }
                    }
                    else if (rd1.SelectedValue == "0")
                    {
                        SqlCommand cmd22;
                        string str11 = " Delete  from RoleSubMenuAccessRightTbl where  RoleId='" + lblroleid.Text + "' and  SubMenuId='" + lblsubmanu.Text + "'";
                        cmd22 = new SqlCommand(str11, con);
                        con.Open();
                        cmd22.ExecuteNonQuery();
                        con.Close();
