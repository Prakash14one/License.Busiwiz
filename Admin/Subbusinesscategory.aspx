<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Subbusinesscategory.aspx.cs" Inherits="Admin_Subbusinesscategory" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table cellpadding="0" cellspacing="0" style="width: 625px">
        <tr>
            <td class="hdng">
                Add/Manage Sub Business Category<asp:ScriptManager ID="ScriptManager1" runat="server">
                </asp:ScriptManager>
            </td>
        </tr>
        <tr>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:ButtonField ButtonType="Image" ItemStyle-Width="60px" CommandName="edit1" HeaderText="Edit" ImageUrl="~/images/edit.gif"
                                Text="Button" />
                             <asp:BoundField HeaderText="Business Category" DataField="businesscategoryname" />
                            <asp:BoundField HeaderText="Sub category Name" DataField="subcategoryname" />
                            <asp:BoundField HeaderText="Sub category Description" DataField="subcategorydesc"  />
