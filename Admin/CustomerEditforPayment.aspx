<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master"  AutoEventWireup="true" CodeFile="CustomerEditforPayment.aspx.cs" Inherits="CustomerEditforPayment" Title="Untitled Page" %>
...
else
{
  ...
  return false;
    ...
    <table id="adminsubcontentbg" cellpadding="0" cellspacing="0">
        <tr>
            <td class="hdng">
                Customer Edit for Payment<asp:ScriptManager ID="ScriptManager1" runat="server">
                </asp:ScriptManager>
        ...
        <tr>
            <td colspan="2">
                <table id="Table1" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="subhd" colspan="4">
                            Please select any other Subscription plan if you want</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="column2">
                            <asp:DropDownList ID="ddlsubscriptionplan" runat="server" Width="145px" AutoPostBack="True" OnSelectedIndexChanged="ddlsubscriptionplan_SelectedIndexChanged">
                    ...
                    <tr>
                        ...
                        <td class="column2">
                            <asp:UpdatePanel id="UpdatePanelReminder" runat="server" UpdateMode="Conditional">
                                <contenttemplate>
<asp:Label id="lblamt" runat="server" Font-Bold="False" ForeColor="#C00000"></asp:Label> <asp:Label id="Label2" runat="server" Font-Bold="False" Text="$" ForeColor="#C00000"></asp:Label> 
</contenttemplate>
                            </asp:UpdatePanel>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="column1" style="height: 23px">
                        </td>
                        <td class="column2" style="height: 23px">
