<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true"
    CodeFile="CustomerListforPayment.aspx.cs" Inherits="CustomerListforPayment" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table cellpadding="0" cellspacing="0" width="645px">
        ...
        <tr>
            ...
            <td class="column2" style="padding-top: 2px;">
            ...
            <td class="column2" colspan="4">
                <asp:Panel ID="Panel1" runat="server" Height="500px" ScrollBars="Auto" Width="645px">
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        EmptyDataText="There is no data." PageSize="5" CssClass="GridBack">
                        <Columns>
                            <asp:ButtonField ButtonType="Button" CommandName="edit1" HeaderText="Make Payment"
                                Text="Pay" />
