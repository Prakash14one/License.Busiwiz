<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master"  AutoEventWireup="true" CodeFile="EditClientInfo.aspx.cs" Inherits="EditClientInfo" Title="Untitled Page" %>
  ...
  <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <table cellpadding="0" cellspacing="0" id="pagetbl">
        ...
        <tr>
            ...
            <td class="column2">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtLoginPassword"
                    ErrorMessage="*" ValidationGroup="1" Width="4px"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td class="column1">
                Confirm Password</td>
        ...
        <tr>
            ...
            <td class="column2" colspan="2">
                <asp:DropDownList ID="ddlsubscriptionplan" runat="server" AutoPostBack="True" DataTextField="PricePlanName"
                    DataValueField="ClientPricePlanId" OnSelectedIndexChanged="ddlsubscriptionplan_SelectedIndexChanged"
                    Width="151px">
        ...
        <tr>
            ...
            <td class="column2" colspan="2">
                <asp:UpdatePanel ID="UpdatePanelReminder" runat="server" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddlsubscriptionplan" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
            <td class="column2">
        ...
        <tr>
            <td class="column1">
                Country :</td>
            <td class="column2">
                <asp:DropDownList ID="ddlCountry" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged" Width="138px">
                </asp:DropDownList>
