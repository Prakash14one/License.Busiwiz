<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Order_Payment_Confirmation_static.aspx.cs" Inherits="Admin_Order_Payment_Confirmation_static" %>
    ...
    <table id="pagetbl" cellpadding="0" cellspacing="0">
       ...
       <%--  <tr>
            ...
            <td class="column1" >
              ...
              Order Detail :</td>
            <td class="column2" >
                             <asp:DropDownList ID="Ddl_orderdetail" runat="server" Height="20px" 
                                 Width="159px" AutoPostBack="True" 
                                 onselectedindexchanged="Ddl_orderdetail_SelectedIndexChanged"></asp:DropDownList> 
               </td>
                <td class="column1" >
              Company Name :</td>
            <td class="column2" >
