<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Businesscategory.aspx.cs" Inherits="Admin_Businesscategory" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table cellpadding="0" cellspacing="0" style="width: 625px">
        <tr>
            <td class="hdng">
                Add/ManageBusiness Category<asp:ScriptManager ID="ScriptManager1" runat="server">
                </asp:ScriptManager>
            </td>
        </tr>
        <tr>
                    ...
                    <%--    <tr>
                        ...
                        <tr>
                            ...
                            <td class="column2" colspan="2" style="padding-top: 10px;">
                                ...
                                <asp:TextBox ID="txtdesc" runat="server" TextMode="MultiLine" Width="267px" Height="82px"
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:ButtonField ButtonType="Image" ItemStyle-Width="60px" CommandName="edit1" HeaderText="Edit" ImageUrl="~/images/edit.gif"
                             ...
                             <%--<asp:BoundField HeaderText="Business Type" DataField="bustypename" />--%>
                            <asp:BoundField HeaderText="Business category Name" DataField="businesscategoryname" />
                            <asp:BoundField HeaderText="Business category Description" DataField="businesscategorydesc"  />
