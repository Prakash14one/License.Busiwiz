...
public partial class AdminClientInfo : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            string str = "INSERT INTO ClientMaster " +
               ...
               ",TechSupportPhoneNo,TechSupportFaxNo,TechSupportEmail,FTP,FTPUserName,FTPPassword, LoginName,LoginPassword )" +
               ...
               "'" + txtTechSupportPhoneNo.Text + "' , '" + txtTechSupportFaxNo.Text + "','" + txtTechSupEmail.Text + "','" + txtFTP.Text + "','" + txtFTPUserName.Text + "','" + txtFTPPassword.Text + "','" +  txtLoginName.Text  + "','" + txtLoginPassword.Text + "')";
            SqlCommand cmd = new SqlCommand(str, con);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            string str = "update   ClientMaster  set " +
               ...
               ",TechSupportPhoneNo='" + txtTechSupportPhoneNo.Text + "',TechSupportFaxNo='" + txtTechSupportFaxNo.Text + "',TechSupportEmail ='" + txtTechSupEmail.Text + "',FTP='" + txtFTP.Text + "',FTPUserName='" + txtFTPUserName.Text + "',FTPPassword='" + txtFTPPassword.Text + "', LoginName='" + txtLoginName.Text + "',LoginPassword ='" + txtLoginPassword.Text + "' " +
