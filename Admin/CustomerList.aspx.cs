...
public partial class CustomerListAdmin : System.Web.UI.Page
{
...
// " WHERE     (ProductMaster.ClientMasterId = '" + Session["ClientId"].ToString() + "')";
        string str = "SELECT     OrderMaster.OrderId AS Expr1, CompanyMaster.CompanyName, CompanyMaster.ContactPerson, CompanyMaster.ContactPersonDesignation,  " +
                     ...
                     " OrderMaster.Password, OrderMaster.Domain, OrderMaster.HostId, CompanyMaster.CompanyId  , CompanyMaster.CompanyWebsite, " +
                     ...
                     "  PricePlanMaster.PricePlanName, PricePlanMaster.PricePlanAmount, ProductMaster.ProductId, ProductMaster.ClientMasterId, " +
                      ...
                      " LicenseMaster.SiteMasterId, LicenseMaster.CompanyId, LicenseMaster.LicenseKey, LicenseMaster.HashKey, LicenseMaster.LicenseDate, " +
                      " LicenseMaster.DatabaseName, case    PricePlanMaster.AllowIPTrack when 1 then 'Yes' else 'No' end as AllowIPTrack " + 
        " ,PricePlanMaster.* FROM         TempDomainMaster RIGHT OUTER JOIN " +
                      " LicenseMaster RIGHT OUTER JOIN CompanyMaster LEFT OUTER JOIN " +
                      " PricePlanMaster ON CompanyMaster.PricePlanId = PricePlanMaster.PricePlanId LEFT OUTER JOIN " +
                      " ProductMaster ON CompanyMaster.ProductId = ProductMaster.ProductId ON LicenseMaster.CompanyId = CompanyMaster.CompanyId ON " +
                      " TempDomainMaster.CompanyId = CompanyMaster.CompanyId LEFT OUTER JOIN " +
        ...
        str = str + " order by CompanyMaster.CompanyId desc ";
