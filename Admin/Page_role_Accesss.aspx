<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master"
    AutoEventWireup="true" CodeFile="Page_role_Accesss.aspx.cs" Inherits="Shoppingcart_Admin_Page_role_Access"
    Title="Untitled Page" %>
                        ...
                        <td align="left">
                            <asp:Panel ID="pnlpage" runat="server"  Visible="False" ScrollBars="Horizontal">
                                <div style="clear: both;">
                                 ...
                                 <asp:Label ID="Labelj4" runat="server" Text="Filter by Main Manu"></asp:Label>
                                ...
                                <label style="width:170px;">
                                <asp:Label ID="Label4" runat="server" Text="Functionality Title"></asp:Label>
                                ...
                                <div style="clear: both;">
                                 ...
                                 <asp:Panel ID="Panel1" runat="server" Width="940px" Height="900px"  ScrollBars="Horizontal">
                                <asp:GridView ID="grdpage" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Page title" ItemStyle-Width="15%" HeaderStyle-HorizontalAlign="Left" SortExpression="PageName">
                                            <ItemTemplate>                                          
                                             <asp:Label ID="lblpagenamee" runat="server" Font-Underline="true" Text='<%#Bind("Pagename") %>' ForeColor="Black"  ></asp:Label>                                                    
                                                    <br />
                                             (
                                             <asp:Label ID="lblpagename" runat="server" Font-Underline="true" Text='<%#Bind("PageTitle") %>' ForeColor="Black"  Font-Size="9px" ></asp:Label>
                                             )
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="25%">
                                            <HeaderTemplate>
                                                ...
                                                <asp:RadioButtonList ID="rlheader" runat="server" AutoPostBack="false" OnSelectedIndexChanged="rlheader_SelectedIndexChanged"
                                                    RepeatDirection="Horizontal">
                                            ...
                                            <ItemTemplate>
                                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="false" SelectedValue='<%#Bind("AccessRight") %>'
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" SortExpression="Insert_Right" ItemStyle-Width="5%" Visible="false">
                                            <HeaderTemplate>
                                                <asp:Label ID="lblInsert" runat="server" Text="Insert"></asp:Label>
                                                <asp:CheckBox ID="chkInsert" runat="server" Checked="true" AutoPostBack="true" OnCheckedChanged="chkInsert_chachedChanged" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="CheckBoxInsert1" runat="server" Checked='<%#Bind("Insert_Right") %>' />
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" SortExpression="Update_Right" ItemStyle-Width="7%" Visible="false">
                                            <HeaderTemplate>
                                                <asp:Label ID="lblUpdate" runat="server" Text="Update"></asp:Label>
                                                <asp:CheckBox ID="chkUpdate" runat="server" AutoPostBack="true" Checked="true" OnCheckedChanged="chkUpdate_chachedChanged" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="CheckBoxUpdate1" runat="server" Checked='<%#Bind("Update_Right") %>' />
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" SortExpression="View_Right" ItemStyle-Width="5%" Visible="false">
                                            <HeaderTemplate>
                                                <asp:Label ID="lblView" runat="server" Text="View"></asp:Label>
                                                <asp:CheckBox ID="chkView" runat="server" Checked="true" AutoPostBack="true" OnCheckedChanged="chkView_chachedChanged" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="CheckBoxView1" runat="server" Checked='<%#Bind("View_Right") %>' />
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" SortExpression="Go_Right" ItemStyle-Width="3%" Visible="false">
                                            <HeaderTemplate>
                                                <asp:Label ID="lblGo" runat="server" Text="Go"></asp:Label>
                                                <asp:CheckBox ID="chkGo" runat="server" Checked="true" AutoPostBack="true" OnCheckedChanged="chkGo_chachedChanged" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="CheckBoxGo1" runat="server" Checked='<%#Bind("Go_Right") %>'  />
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Send Mail" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="5%" SortExpression="SendMail_Right" Visible="false">
                                            <HeaderTemplate>
                                                <asp:Label ID="lblSendMail" runat="server" Text="Send Mail"></asp:Label>
                                                <asp:CheckBox ID="chkSendMail" runat="server" Checked="true" AutoPostBack="true" OnCheckedChanged="chkSendMail_chachedChanged" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="CheckBoxSendMail1" runat="server" Checked='<%#Bind("SendMail_Right") %>' />
                                            </ItemTemplate>
