...
public class PageConn
{
   ...
   // public SqlConnection servermasterconn;
    public static string commonip = "PRAKASH\\SQL2017INSTA";
    public PageConn()
    {
        ...
        //    //OADB_Developer
        //}
        dynconn.ConnectionString = "Data Source =" + commonip + ";Initial Catalog=Licensejobcenter.OADB; User ID=sa; Password=Om2012++; Persist Security Info=true; ";
    ...
    { 
        ...
        liceco.ConnectionString = "Data Source=" + commonip + ";Initial Catalog=License.Busiwiz; User ID=sa; Password=Om2012++; Persist Security Info=true; ";
        return liceco;
    }
    public static SqlConnection serverconn()
    {
        ...
        strEnc = PageConnXYZX.GetC(HttpContext.Current.Session["Comid"].ToString());
        //C3SATELLITESERVER_Developer
         servermasterconn.ConnectionString = @"Data Source =" + commonip + "; Initial Catalog = C3SATELLITESERVER; User ID=sa; Password=06De1963++; Persist Security Info=true;";
         servermasterconn.ConnectionString =" Data Source =C3\\C3SERVERMASTER,30000; Initial Catalog = C3SATELLITESERVER; User ID=sa; Password=06De1963++; Persist Security Info=true; ";
         servermasterconn.ConnectionString = " Data Source =" + commonip + "; Initial Catalog = C3SATELLITESERVER; User ID=sa; Password=Om2012++; Persist Security Info=true; ";
    ...
    public static SqlConnection busclient()
    {
        ...
        if (dtcheck1.Rows.Count > 0)
        {
            ...
            bus.ConnectionString = @"Data Source =TCP:C1_sql.safestserver.com,30000; Initial Catalog = jobcenter.BUSICONTROLDB; User ID=sa; Password=06De1963++; Persist Security Info=true;";
            bidname = "[" + Convert.ToString(dtcheck1.Rows[0]["DatabaseName"]) + "]";           
        }
          bus.ConnectionString = @"Data Source =" + commonip + "; Initial Catalog = jobcenter.BUSICONTROLDB; User ID=sa; Password=Om2012++; Persist Security Info=true;";
        return bus;
    }
    public static SqlConnection UserLog()
    {
       ...
       userlog.ConnectionString = "Data Source =" + commonip + "; Initial Catalog = jobcenter.USERLOGDB; User ID=sa; Password=Om2012++; Persist Security Info=true;";
    ...
    public static SqlConnection intmsg()
    {
        ...
        msgint.ConnectionString = @"Data Source =" + commonip + "; Initial Catalog = jobcenter.INTMSGDB; User ID=Sa; Password=Om2012++; Persist Security Info=true;";
        intmsg11 = msgint.Database;
        if (intmsg11=="")
       {
           intmsg11 = "jobcenter.INTMSGDB";
       }
        return msgint;
    }
    ...
    public static SqlConnection extmsg()
    {
        ...
        //    msgext.ConnectionString = @"Data Source =TCP:192.168.1.219,30000; Initial Catalog = jobcenter.EXTMSGDB_Developer; User ID=IndiaDeveloper; Password=Om2012++; Persist Security Info=true;";
        //}
        ...
        msgext.ConnectionString = @"Data Source =" + commonip + "; Initial Catalog = jobcenter.EXTMSGDB; User ID=sa; Password=Om2012++; Persist Security Info=true;";
