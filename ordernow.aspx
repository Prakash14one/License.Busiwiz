<%@ Page Language="C#" MasterPageFile="~/Master/Main.master" AutoEventWireup="true"
    CodeFile="ordernow.aspx.cs" Inherits="New_Account_SignUp_Form" Title="New Account SignUp Form" %>
                 ...
                 <asp:Panel ID="Panel1" runat="server" Visible="false">
                    ...
                    <tr>
                        ...
                        <td style="width: 15%">
                             <asp:Label ID="Label2" ForeColor="#5badff" runat="server" Text="$">
                                ...
                                <asp:Label ID="lblplanamt" ForeColor="#5badff" runat="server" Text="">
                                </asp:Label>
                     ...
                     <tr>
                        <td>
                            <label>
                                Hosting Portal Server Plan Detail
                            </label>
                        </td>
                        <td colspan="2">
                           
                                 <asp:LinkButton ID="linkHostingplan" runat="server" ForeColor="#5badff" OnClick="LinkButton1_Click"> </asp:LinkButton>
                           
                            <asp:LinkButton ID="LinkButton3" ForeColor="#999999" runat="server" Font-Italic="true"
                                    OnClick="LinkButton2_Click">Change Plan</asp:LinkButton>
                        </td>
                        <td>
                         <asp:Label ID="Label5" ForeColor="#5badff" runat="server" Text="$">
                                </asp:Label>
                                <asp:Label ID="lblHostAmt" ForeColor="#5badff" runat="server" Text="">
                                </asp:Label>
                                  <asp:Label ID="lblserverplndetailid" runat="server" Visible="False"></asp:Label>
                        </td>
                    </tr>
                    </asp:Panel>
                    <tr>
                        <td>
                             <asp:GridView ID="gv_orderdetail" runat="server" ShowHeader="false" CssClass="mGridcss" PagerStyle-CssClass="pgr" AutoGenerateColumns="false"  ShowFooter="true" 
                             BorderStyle="None" GridLines="None" BorderWidth="0px"
                            Width="100%" DataKeyNames="Id" OnRowDataBound="gvpopup_RowDataBound" onrowcommand="gvpopup_RowCommand">
                                                            <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="">
                                                                ...
                                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="" FooterStyle-HorizontalAlign="Right">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblfe1" runat="server" Text='<%# Bind("PricePlanName") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                     <FooterTemplate >                                                            
                                                                                <asp:Label ID="lbltotal" runat="server" ForeColor="#5badff"  Text="Total Amt." ></asp:Label>
                                                                ...
                                                                <asp:TemplateField ItemStyle-Width="82px" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"  HeaderText="">
                                                                    <ItemTemplate>
                                                                       <asp:Label ID="lblgvamt" runat="server" Text='<%# Bind("PricePlanAmount") %>'></asp:Label>
                                                                         <asp:Label ID="lblid" runat="server" Text='<%# Bind("PricePlanId") %>' Visible="false"></asp:Label>
                                                                    ...
                                                                    <FooterTemplate>   
                                                                      <asp:Label ID="Label6" ForeColor="#5badff" runat="server" Text="$" >
                                                                    </asp:Label>                                                         
                                                                                <asp:Label ID="lblgv_total" runat="server" ForeColor="#5badff"  Text="" ></asp:Label>
                                                             ...
                                                             <FooterStyle BackColor="#FFFFFF" Font-Bold="True"  ForeColor="#7eadff"   />
                                                        </asp:GridView>   
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                <asp:Label ID="Label6" ForeColor="#5badff" runat="server" Text="$" Visible="false" >
                                </asp:Label>
                                <asp:Label ID="lblamt" ForeColor="#5badff" runat="server" Text="" Visible="false">
                                </asp:Label>
