<%@ Page Title="" Language="C#" MasterPageFile="~/MainHome.master" AutoEventWireup="true"
    CodeFile="ForgotPassword.aspx.cs" Inherits="ShoppingCart_Admin_ForgotPassword" %>
                ...
                <asp:Panel ID="Panel2" runat="server" Width="100%">
                    <table width="100%" align="center">
                        <tr>
                            <td colspan="2">
                                <label>
                                    <asp:Label ID="Label12" runat="server" Text="Forgot Password" Width="300px" Font-Size="18px"></asp:Label>
                                </label>
                            </td>
                        </tr>
                        <tr>
