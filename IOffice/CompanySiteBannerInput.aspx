<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ShoppingCart/Admin/Master/mp_Admin.master" CodeFile="CompanySiteBannerInput.aspx.cs" Inherits="ShoppingCart_Admin_CompanySiteBannerInput" %>
      ...
      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>  
         ...
         <%-- <div style="/*margin: 3px 0px 0px 3px;*/padding: 12px;width: 99%;min-height: 300px;border: 2px solid #1991A9;border-radius: 18px 0px 20px 0px;text-align: -webkit-auto;">--%>
                   <div style="margin-top: 6px; margin-left: 97px;width: 1051px;    min-height:   319px;border: 2px solid #1991A9;">
                   <div style="float:left;">
                     <asp:Label ID="Label11" runat="server" Text="Select Banners"></asp:Label>
                    &nbsp; &nbsp;
                           </div>   
                       ...
                       <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
                           ...
                           <asp:ListItem Value="0">Banner1</asp:ListItem>
                           <asp:ListItem Value="1">Banner2</asp:ListItem>
                           <asp:ListItem Value="2">Banner3</asp:ListItem>
                           <asp:ListItem Value="3">Banner4</asp:ListItem>
                       </asp:DropDownList>
                      ...
                      <td>
                       <asp:Label ID="lblmsg" runat="server" Visible="False" 
                        ...
                        <td>
                         ...
                         <tr>
                      <td width="20%">
                          <asp:Label ID="lbl1" runat="server" Text="" Font-Size="Medium" Visible="false"></asp:Label>
                           <asp:Label ID="lbimage1" runat="server" Text="" Font-Size="Medium" ></asp:Label>
                      </td>
                       <td  width="20%">
                       ...
                       <td  width="20%" >
                               ...
                               Visible="false" />
                           <asp:Button ID="edit1" runat="server" Text="Edit" onclick="edit1_Click" ToolTip="Image Editing" />
                      <asp:Button ID="Button3" runat="server" Text="Cancel" 
                       ...
                       <td  width="20%" align="right">
                        ...
                        <asp:Button ID="edit11" runat="server" Text="Edit" onclick="edit11_Click"  ToolTip="Text Editing"/>
                      ...
                      <td colspan="4">
                            <asp:Image ID="Image1"   runat="server" 
                                 style="width: 642px;    height: 215px; margin-bottom: 9px;" />
                        ...
                        <td>
                         ...
                         <tr>
                      <td width="20%">
                          <asp:Label ID="lbl2" runat="server" Text=""  Font-Size="Medium" Visible="false"></asp:Label>
                          <asp:Label ID="lbimage2" runat="server" Text="" Font-Size="Medium" ></asp:Label>
                      </td>
                       <td  width="20%">
                      ...
                      <asp:Button ID="Button5" runat="server" Text="Cancel" 
                           ...
                           <asp:Button ID="edit2" runat="server" Text="Edit" ToolTip="Image Editing" onclick="edit2_Click" />
                      </td>
                       <td  width="20%"   >
                       ...
                       <td  width="20%" align="right" >
                        ...
                        <asp:Button ID="edit21" runat="server" Text="Edit" onclick="edit21_Click" ToolTip="Text Editing" />
                        </td>
                      </tr>
                      <tr>
                      ...
                      <td colspan="4">
                        ...
                        <td>
                         ...
                         <tr>
                      <td width="20%">
                          <asp:Label ID="lbl3" runat="server" Text="" Font-Size="Medium" Visible="false" ></asp:Label>
                          <asp:Label ID="lbimage3" runat="server" Text="" Font-Size="Medium" ></asp:Label>
                      </td>
                       <td  width="20%">
                      ...
                      <asp:Button ID="Button7" runat="server" Text="Cancel" 
                           ...
                           <asp:Button ID="edit3" runat="server" Text="Edit" onclick="edit3_Click" ToolTip="Image Editing" />
                      </td>
                       <td  width="20%">
                       ...
                       <td  width="20%" align="right">
                        ...
                        <asp:Button ID="edit31" runat="server" Text="Edit" onclick="edit31_Click" ToolTip="Text Editing" />
                      </td>
                        </tr>
                        <tr>
                      ...
                      <td colspan="4">
                        ...
                        <td>
                         ...
                         <tr>
                      <td width="20%">
                          <asp:Label ID="lbl4" runat="server" Text="" Font-Size="Medium" Visible="false"></asp:Label>
                          <asp:Label ID="lbimage4" runat="server" Text="" Font-Size="Medium" ></asp:Label>
                      </td>
                       <td  width="20%">
                      ...
                      <asp:Button ID="Button8" runat="server" Text="Cancel" 
                           ...
                           <asp:Button ID="edit4" runat="server" Text="Edit" onclick="edit4_Click"  ToolTip="Image Editing"/>
                      </td>
       ...
       <div     style= " background-color: #65BBD1;width:348.6px;float: left; margin-top: 6px; margin-left: 96px;height: 30px;border-bottom-width: 3px;border-bottom-style: solid;border-bottom-color: #FFF;">
       <h1 style="    font-size:small;color: #FFFFFF;text-align: -webkit-auto; font-weight: normal; letter-spacing: 0.05em; font-family: Calibri; padding-top: -12px; padding-right: 7px; padding-bottom: 7px;padding-left: 7px;">
           <asp:TextBox ID="TextBox5" runat="server" Height="22px" style="font-family: Calibri;font-size: 17px;"></asp:TextBox></h1> 
           <asp:Button ID="Button2" runat="server" Text="Edit" style="float:right;" 
               onclick="Button2_Click" Visible="false"/>
                
        <div style="background-color: #FFFFFF;width: 321px;float: left;padding-right: 10px;margin-top: -75px;padding-left: 10px;margin-right: 10px;font-family: Calibri;color: #666;font-size: 15px;letter-spacing: .05em;padding-bottom: 5px;border-top-width: 2px;border-right-width: 2px;border-left-width: 2px;border-top-style: solid;border-right-style: solid;border-left-style: solid;border-top-style: solid; border-top-color: #65BBD1; border-right-color: #65BBD1;border-left-color: #65BBD1;border-bottom-width: 2px;border-bottom-style: solid;border-bottom-color: #65BBD1;min-height: 181px;">
        
          
           <asp:TextBox ID="TextBox6" runat="server" height="177px" Width="310px"  
                Visible="false" TextMode="MultiLine" 
                style="font-family: Calibri;font-size: 15px;" 
                 ></asp:TextBox>
       </div>
       <div style="width: 340px;height: 2px;margin-right: auto;margin-left: auto;background-image: url(Images/bottom_shadow.png);background-repeat: no-repeat;float: left;">
    </div>
       </div>
       
       <div     style= " background-color: #65BBD1;width: 330.6px; margin-left: 15px;float: left; margin-top: 6px;height: 30px;border-bottom-width: 3px;border-bottom-style: solid;border-bottom-color: #FFF;">
       <h1 style="    font-size:small;color: #FFFFFF;text-align: -webkit-auto; font-weight: normal; letter-spacing: 0.05em; font-family: Calibri; padding-top: -12px; padding-right: 7px; padding-bottom: 7px;padding-left: 7px;"> 
        <asp:TextBox ID="TextBox9" runat="server" Height="22px" style="font-family: Calibri; font-size: 17px;"></asp:TextBox></h1>
       <asp:Button ID="Button4" runat="server" Text="Edit" style="float:right;" 
               onclick="Button4_Click" Visible="false"/>
        <div style="background-color: #FFFFFF;width: 310px;float: left;padding-right: 10px;margin-top: -75px;padding-left: 10px;margin-right: 10px;font-family: Calibri;color: #666;font-size: 15px;letter-spacing: .05em;padding-bottom:10px;border-top-width: 2px;border-right-width: 2px;border-left-width: 2px;border-top-style: solid;border-right-style: solid;border-left-style: solid;border-top-style: solid; border-top-color: #65BBD1; border-right-color: #65BBD1;border-left-color: #65BBD1;border-bottom-width: 2px;border-bottom-style: solid;border-bottom-color: #65BBD1;min-height: 181px;">
        
          
           <asp:TextBox ID="TextBox8" runat="server" height="177px" Width="310px"  
                Visible="false" TextMode="MultiLine" style="font-family: Calibri;font-size: 15px;"></asp:TextBox>
       </div>
       <div style="width: 340px;height: 2px;margin-right: auto;margin-left: auto;background-image: url(Images/bottom_shadow.png);background-repeat: no-repeat;float: left;">
    </div>
       </div>
    <div     style= " background-color: #65BBD1;width: 344.6px; float: left; margin-top: 6px; margin-top: -33px;margin-left: 805px;height: 30px;border-bottom-width: 3px;border-bottom-style: solid;border-bottom-color: #FFF;">
       <h1 style="    font-size:small;color: #FFFFFF;text-align: -webkit-auto; font-weight: normal; letter-spacing: 0.05em; font-family: Calibri; padding-top: -12px; padding-right: 7px; padding-bottom: 7px;padding-left: 7px;">  <asp:TextBox ID="TextBox7" runat="server" Height="22px" style="font-family: Calibri; font-size: 17px;"></asp:TextBox></h1>
       <asp:Button ID="Button6" runat="server" Text="Edit" style="float:right;" 
               onclick="Button7_Click" Visible="false"/>
                
        <div style="background-color: #FFFFFF;width: 321px;float: left;padding-right: 10px;margin-top: -75px;padding-left: 10px;margin-right: 10px;font-family: Calibri;color: #666;font-size: 15px;letter-spacing: .05em;padding-bottom: 5px;border-top-width: 2px;border-right-width: 2px;border-left-width: 2px;border-top-style: solid;border-right-style: solid;border-left-style: solid;border-top-style: solid; border-top-color: #65BBD1; border-right-color: #65BBD1;border-left-color: #65BBD1;border-bottom-width: 2px;border-bottom-style: solid;border-bottom-color: #65BBD1;min-height: 181px;">
        
          
           <asp:TextBox ID="TextBox10" runat="server" height="177px" Width="310px"  
                Visible="false" TextMode="MultiLine" style="font-family: Calibri;font-size: 15px;"></asp:TextBox>
       </div>
       <div style="width: 340px;height: 2px;margin-right: auto;margin-left: auto;background-image: url(Images/bottom_shadow.png);background-repeat: no-repeat;float: left;">
    </div>
        ...
        <div >
         <asp:Button ID="Button1" runat="server" Text="Submit" onclick="Button1_Click" 
                style=" margin-left: -208px; margin-top: 348px;
    position: relative;" />
        </div>
            </asp:Panel>
 </ContentTemplate>
