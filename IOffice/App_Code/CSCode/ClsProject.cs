...
public class ClsProject
{
    ...
    public static int Updateactuccostproject(string MissionId, decimal ActualCost, decimal ShortageExcess, String StatusId)
    {
        SqlCommand cmd = new SqlCommand();
    ...
    public static int SpProjectEvaluationAddData(string masterid, string employeeid, string evaluationnote, string percentage)
    {
        // get a configured DbCommand object
        DbCommand comm = DataAccess.CreateCommand();
