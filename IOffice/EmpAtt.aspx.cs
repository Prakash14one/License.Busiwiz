...
public partial class EmpAtt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //DataTable ff = select("select * from WHTimeZone where compid='" + ViewState["Compid"] + "'");
        //ddltimezone.SelectedIndex = ddltimezone.Items.IndexOf(ddltimezone.Items.FindByValue(ff.Rows[2]["TimeZone"].ToString()));
        //ddltimezone.SelectedValue = ff.Rows[2]["TimeZone"].ToString();
