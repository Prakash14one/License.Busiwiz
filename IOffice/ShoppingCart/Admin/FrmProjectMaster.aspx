<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="FrmProjectMaster.aspx.cs" Inherits="Admin_Admin_files_FrmProjectMaster"
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Width="100%">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="width: 70%">
                                                    <label>
                                                        <asp:CheckBox ID="chk" runat="server" Checked="false" AutoPostBack="True" OnCheckedChanged="chk_CheckedChanged" />
                                                    </label>
                                                </td>
                                            </tr>
                                        </table>
                                                        ...
                                                        <asp:Panel ID="pnldoclist" runat="server">
                                                            <asp:GridView ID="GridView2" runat="server" EmptyDataText="No Record Found." CssClass="mGrid"
                                                                ...
                                                                <asp:Label ID="lblprn" runat="server" Text='<%#Bind("PRN") %>'></asp:Label>
                                                                    ...
                                                                    <asp:ButtonField ButtonType="Image" HeaderImageUrl="~/Account/images/delete.gif" ImageUrl="~/Account/images/delete.gif" HeaderText="Delete" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="2%" CommandName="del"></asp:ButtonField>
                                                                </Columns>
                                                            </asp:GridView>
                                                        </asp:Panel>
                                                    </td>
                                ...
                                <asp:Panel ID="Panel14" runat="server" Width="100%">
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td style="width: 70%;">
                                                <label>
                                                    <asp:DropDownList Width="250px" ID="ddlsearchByStore" runat="server" AutoPostBack="True"  OnSelectedIndexChanged="ddlsearchByStore_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </label>
                                            </td>
                                        </tr>
                                    ...
                                    <table width="100%">
                                            ...
                                            <td colspan="2">
                                                <cc11:PagingGridView ID="grid" runat="server" AutoGenerateColumns="False" DataKeyNames="ProjectId"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Edit" HeaderImageUrl="~/Account/images/edit.gif" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="2%" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="ImageButton48" runat="server" CommandName="Edit" CommandArgument='<%# Eval("ProjectId") %>' ToolTip="Edit" ImageUrl="~/Account/images/edit.gif" />
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Delete" HeaderImageUrl="~/ShoppingCart/images/trash.jpg" HeaderStyle-Width="2%" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="llinkbb" runat="server" CommandName="Delete" ToolTip="Delete" ImageUrl="~/Account/images/delete.gif" OnClientClick="return confirm('Do you wish to delete this record?');">
                                                                </asp:ImageButton>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" Width="2%" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderImageUrl="~/Account/images/viewprofile.jpg" HeaderStyle-Width="2%"
                                                            HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="lbladdd" runat="server" CommandArgument='<%# Eval("ProjectId") %>' CommandName="view" ToolTip="View Profile" Height="20px" ImageUrl="~/Account/images/viewprofile.jpg" Width="20px"></asp:ImageButton>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" Width="2%" />
                                                        </asp:TemplateField>
                                                    </Columns>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <asp:Panel ID="Panel21" runat="server" BackColor="#CCCCCC" BorderColor="Black" Width="550px"
                                                    BorderStyle="Solid">
                                                    <table bgcolor="#CCCCCC" cellpadding="0" cellspacing="0" width="450px" >
                                                        <tr>
                                                            <td align="center" bgcolor="#CCCCCC">
                                                                <table bgcolor="#CCCCCC" cellpadding="0" cellspacing="0" style="width:488px">
                                                                    <tr>
                                                                        <td style="text-align: left; font-weight: bolder;">
                                                                            <label>
                                                                                <asp:Label ID="Label28" runat="server" Text="Uploded Documents"></asp:Label>
                                                                            </label>
                                                                        </td>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center">
                                                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="10"
                                                                                    Width="480" CssClass="mGrid" GridLines="Both" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                                ...
                                                <cc1:ModalPopupExtender ID="ModalPopupExtenderAddnew" runat="server" BackgroundCssClass="modalBackground"  Enabled="True" PopupControlID="Panel21" TargetControlID="HiddenButton222">
