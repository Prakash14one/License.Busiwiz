<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    ValidateRequest="false" AutoEventWireup="true" CodeFile="FrmWmaster.aspx.cs"
    Inherits="Admin_FrmWMaster" Title="OnlineMis" %>
        ...
        <ContentTemplate>
            ...
            <fieldset>
                ...
                <div style="float: right;">
                    <asp:Button ID="btnadd" runat="server" Text="Add Weekly Goal" OnClick="btnadd_Click"
                        CssClass="btnSubmit" />
                </div>
                <asp:Panel ID="Pnladdnew" runat="server" Visible="false">
                    <table cellspacing="3" width="100%">
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td style="width: 30%" align="right">
                                                <label>
                                                    <asp:Label ID="Label4" runat="server" Text="Add Weekly Goal For"></asp:Label>
                                                </label>
                                            </td>
                                            <td style="width: 70%">
                                                <label>
                                ...
                                <asp:Panel ID="Panel16" runat="server" Width="100%" Visible="true">
                                    <table width="100%">
                                        <tr>
                                            <td align="right" style="width: 30%">
                                                <label>
                                                    <asp:Label ID="Label3" runat="server" Text="Select Year"></asp:Label>
                                                </label>
                                            </td>
                                            <td align="left">
                                               <%--  <label>
                                ...
                                <asp:Panel ID="pnlradio" runat="server" Visible="False">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label29" runat="server" Text="Set Goals Related To"></asp:Label>
                                                </label>
                                            </td>
                                            <td style="text-align: right; width: 70%;">
                                                <label>
                                                    <asp:RadioButtonList ID="RadioButtonList3" runat="server" RepeatDirection="Horizontal"
                                                        ...
                                                        <asp:ListItem Selected="True" Text=" Monthly Goals of Department" Value="0"></asp:ListItem>
                                ...
                                <asp:Panel ID="pnlradio1" runat="server" Visible="False">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label30" runat="server" Text="Set Goals Related To"></asp:Label>
                                                </label>
                                            </td>
                                            <td style="text-align: right; width: 70%;">
                                                <label>
                                                    <asp:RadioButtonList ID="RadioButtonList4" runat="server" RepeatDirection="Horizontal"
                                                        ...
                                                        <asp:ListItem Selected="True" Text=" Monthly Goals of Division" Value="0"></asp:ListItem>
                                                        <asp:ListItem Value="1" Text="Weekly Goals of Business/Department"></asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </label>
                                            </td>
                                        </tr>
                                ...
                                <asp:Panel ID="pnlradio2" runat="server" Visible="False">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label31" runat="server" Text="Set Goals Related To"></asp:Label>
                                                </label>
                                            </td>
                                            <td style="text-align: right; width: 70%;">
                                                <label>
                                                    <asp:RadioButtonList ID="RadioButtonList5" runat="server" RepeatDirection="Horizontal"
                                                        ...
                                                        <asp:ListItem Selected="True" Text=" Monthly Goals of Employee" Value="0"></asp:ListItem>
                                                        <asp:ListItem Value="1" Text="Weekly Goals of Business/Department/Division"></asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </label>
                                            </td>
                                        </tr>
                                ...
                                <asp:Panel ID="Panel15" runat="server" Visible="False">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label35" runat="server" Text="Link this goal to weekly goals of"></asp:Label>
                                                </label>
                                            </td>
                                            <td style="text-align: right; width: 70%;">
                                                <label>
                                                    <asp:DropDownList ID="DropDownList6" AutoPostBack="true" runat="server" Width="250px"
                                                        ...
                                                        <asp:ListItem Selected="True" Value="0" Text="Business Weekly Goal"></asp:ListItem>
                                                        <asp:ListItem Value="1" Text="Department Weekly Goal"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </label>
                                            </td>
                                        </tr>
                                ...
                                <asp:Panel ID="Panel14" runat="server" Visible="False">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label36" runat="server" Text="Link this goal to weekly goals of"></asp:Label>
                                                </label>
                                            </td>
                                            <td style="text-align: right; width: 70%;">
                                                <label>
                                                    <asp:DropDownList ID="DropDownList7" AutoPostBack="true" runat="server" Width="250px"
                                                        ...
                                                        <asp:ListItem Selected="True" Value="0" Text="Business Weekly Goal"></asp:ListItem>
                                                        <asp:ListItem Value="1" Text="Department Weekly Goal"></asp:ListItem>
                                                        <asp:ListItem Value="2" Text="Division Weekly Goal"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </label>
                                            </td>
                                        </tr>
                                ...
                                <asp:Panel ID="Panel5" runat="server" Visible="true">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label7" runat="server" Text="Monthly Goal Name"></asp:Label>
                                            ...
                                            <td style="text-align: left; width: 70%;">
                                                <label>
                                                    <asp:DropDownList ID="ddly" Width="455px" runat="server" OnSelectedIndexChanged="ddly_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </label>
                                                <label>
                                ...
                                <asp:Panel ID="pnlmonthly1" runat="server" Visible="false">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label32" runat="server" Text="Business Weekly Goal"></asp:Label>
                                                </label>
                                            </td>
                                            <td style="text-align: right; width: 70%;">
                                                <label>
                                ...
                                <asp:Panel ID="pnlmonthly2" runat="server" Visible="false">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label37" runat="server" Text="Department Weekly Goal"></asp:Label>
                                                </label>
                                            </td>
                                            <td style="text-align: right; width: 70%;">
                                                <label>
                                ...
                                <asp:Panel ID="pnlmonthly3" runat="server" Visible="false">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label40" runat="server" Text="Division Weekly Goal"></asp:Label>
                                                </label>
                                            </td>
                                            <td style="text-align: right; width: 70%;">
                                                <label>
                                ...
                                <asp:Panel ID="Panel7" runat="server" Visible="true">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label8" runat="server" Text="Weekly Goal Title"></asp:Label>
                                                    ...
                                                    <asp:RegularExpressionValidator ID="REG1" runat="server" ErrorMessage="*" SetFocusOnError="True"
                                                        ValidationExpression="^([a-z?.,A-Z0-9_\s]*)" ControlToValidate="txttitle" ValidationGroup="1"></asp:RegularExpressionValidator>
                                                </label>
                                            </td>
                                            <td style="text-align: left; width: 70%;">
                                                <label>
                                ...
                                <asp:Panel ID="Panel6" runat="server" Visible="false">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label9" runat="server" Text="Week"></asp:Label>
                                                    <asp:Label ID="Label21" runat="server" Text="*" CssClass="labelstar"></asp:Label>
                                                    <asp:RequiredFieldValidator ID="ReqredFalidator1" ControlToValidate="ddlweek" SetFocusOnError="true"
                                                        runat="server" InitialValue="0" ErrorMessage="*" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
                                                </label>
                                            </td>
                                            <td style="width: 70%;">
                                                <label>
                                                    <asp:DropDownList ID="ddlweek" AppendDataBoundItems="true" runat="server" Width="250px">
                                                    </asp:DropDownList>
                                                </label>
                                            </td>
                                        </tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Panel ID="Panel22" runat="server" Visible="true">
                                    <table width="100%">
                                        <tr>
                                            <td style="text-align: right; width: 30%;">
                                                <label>
                                                    <asp:Label ID="Label26" runat="server" Text="Create a new project also for same title and details ?"></asp:Label>
                                                </label>
                                            </td>
                                            <td style="text-align: left; width: 70%;">
                                                <label>
            ...
            <fieldset>
                <legend>
                    <asp:Label ID="Label19" runat="server" Text="List of Weekly Goals"></asp:Label>
                </legend>
                <table width="100%">
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:Panel ID="Panel11" runat="server" Width="100%" Visible="true">
                                <table width="100%">
                                    <tr>
                                        <td style="text-align: right; width: 30%;">
                                            <label>
                                                <asp:Label ID="Label14" runat="server" Text="Select Weekly Goal by"></asp:Label>
                                            </label>
                                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Panel ID="Panel17" runat="server" Width="100%" Visible="true">
                                <table width="100%">
                                    <tr>
                                        <td align="right" style="width: 30%">
                                            <label>
                                                <asp:Label ID="Label33" runat="server" Text="Select Year"></asp:Label>
                                            </label>
                                        </td>
                                        <td align="left">
                                            <%-- <label>
                                            ...
                                            <label>
                                                <asp:DropDownList ID="ddlyear" runat="server" AutoPostBack="True" Width="70px" OnSelectedIndexChanged="ddlyear_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </label>
                                            <label>
                                            ...
                                            <label>
                                                <asp:DropDownList ID="ddlmonth" runat="server" AutoPostBack="True" Width="130px"
                                                    OnSelectedIndexChanged="ddlmonth_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </label>
                                            <label>
                                                <asp:Label ID="Label34" runat="server" Text="Weekly"></asp:Label>
                                            </label>
                                            <label>
                                        ...
                                        <td align="left">
                                            <label>
                                                <asp:DropDownList ID="dropdowndepartment" runat="server" AutoPostBack="true" Width="250px"
                                                    ...
                                                    <asp:ListItem Value="1" Text="Monthly Goals of Department"></asp:ListItem>
                                                    <asp:ListItem Value="2" Text="Weekly Goals of Business"></asp:ListItem>
                                                </asp:DropDownList>
                                            </label>
                                        </td>
                                    </tr>
                            ...
                            <asp:Panel ID="paneldivision" runat="server" Width="100%" Visible="false">
                                <table width="100%">
                                    <tr>
                                        <td align="right" style="width: 30%">
                                            <label>
                                                <asp:Label ID="Label39" runat="server" Text="Filter by Related Goals"></asp:Label>
                                            </label>
                                        </td>
                                        <td align="left">
                                            <label>
                                                <asp:DropDownList ID="dropdowndivision" runat="server" AutoPostBack="true" Width="250px"
                                                    ...
                                                    <asp:ListItem Value="0" Selected="True" Text="-Select-"></asp:ListItem>
                                                    <asp:ListItem Value="1" Text="Monthly Goals of Division"></asp:ListItem>
                                                    <asp:ListItem Value="2" Text="Weekly Goals of Business"></asp:ListItem>
                                                    <asp:ListItem Value="3" Text="Weekly Goals of Department"></asp:ListItem>
                                                </asp:DropDownList>
                                            </label>
                                        </td>
                                    </tr>
                                        ...
                                        <td align="left">
                                            <label>
                                                <asp:DropDownList ID="dropdownemployee" runat="server" AutoPostBack="true" Width="250px"
                                                    ...
                                                    <asp:ListItem Value="0" Selected="True" Text="-Select-"></asp:ListItem>
                                                    <asp:ListItem Value="1" Text="Monthly Goals of Employee"></asp:ListItem>
                                                    <asp:ListItem Value="2" Text="Weekly Goals of Business"></asp:ListItem>
                                                    <asp:ListItem Value="3" Text="Weekly Goals of Department"></asp:ListItem>
                                                    <asp:ListItem Value="4" Text="Weekly Goals of Division"></asp:ListItem>
                                                </asp:DropDownList>
                                            </label>
                                        </td>
                                    </tr>
                            ...
                            <asp:Panel ID="Panel12" runat="server" Width="100%" Visible="true">
                                <table width="100%">
                                    <tr>
                                        <td align="right" style="width: 30%">
                                            <label>
                                                <asp:Label ID="Label17" runat="server" Text="Monthly Goal Name"></asp:Label>
                                            </label>
                                        </td>
                                        <td align="left">
                                            <label>
                            ...
                            <asp:Panel ID="Panel18" runat="server" Visible="false">
                                <table width="100%">
                                    <tr>
                                        <td style="text-align: right; width: 30%;">
                                            <label>
                                                <asp:Label ID="Label42" runat="server" Text="Business Weekly Goal"></asp:Label>
                                            </label>
                                        </td>
                                        <td style="text-align: right; width: 70%;">
                                            <label>
                            ...
                            <asp:Panel ID="Panel19" runat="server" Visible="false">
                                <table width="100%">
                                    <tr>
                                        <td style="text-align: right; width: 30%;">
                                            <label>
                                                <asp:Label ID="Label43" runat="server" Text="Department Weekly Goal"></asp:Label>
                                            </label>
                                        </td>
                                        <td style="text-align: right; width: 70%;">
                                            <label>
                                                <asp:DropDownList ID="DropDownList10" runat="server" Width="250px" AutoPostBack="True"
                            ...
                            <asp:Panel ID="Panel20" runat="server" Visible="false">
                                <table width="100%">
                                    <tr>
                                        <td style="text-align: right; width: 30%;">
                                            <label>
                                                <asp:Label ID="Label44" runat="server" Text="Division Weekly Goal"></asp:Label>
                                            </label>
                                        </td>
                                        <td style="text-align: right; width: 70%;">
                                            <label>
                                                <asp:DropDownList ID="DropDownList11" runat="server" Width="250px" AutoPostBack="True"
                                                ...
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="center" style="font-size: 18px; font-weight: bold; color: #000000">
                                                            <asp:Label ID="Label23" runat="server" Font-Italic="true" Text="Business : "></asp:Label>
                                                            <asp:Label ID="lblBusiness" runat="server" Font-Italic="true"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="font-size: 18px; font-weight: bold; color: #000000">
                                                            <asp:Label ID="Label11" runat="server" Text=" List of Weekly Goals" Font-Italic="true"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <tr style="vertical-align: top; height: 80%">
                                        <td colspan="2">
                                            <cc11:PagingGridView ID="grid" runat="server" AutoGenerateColumns="False" DataKeyNames="masterid"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Business" HeaderStyle-Width="13%" SortExpression="Wname"
                                                    ...
                                                    <asp:TemplateField HeaderText="Department" HeaderStyle-Width="13%" SortExpression="Departmentname"
                                                        HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Division" HeaderStyle-Width="13%" SortExpression="BusinessName"
                                                        HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbldasdsaeptname" runat="server" Text='<%#Bind("BusinessName")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Employee" HeaderStyle-Width="15%" SortExpression="EmployeeName"
                                                        HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbldasempdsaeptname" runat="server" Text='<%#Bind("EmployeeName")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Week" SortExpression="Week" HeaderStyle-Width="17%"
                                                        HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Related Goal Name" SortExpression="monthname" HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbldasempdsamoneptname" runat="server" Text='<%#Bind("monthname")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Budgeted Cost Planned" HeaderStyle-Width="9%" SortExpression="budgetedcost"
                                                    ...
                                                    <asp:TemplateField HeaderText="Status" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="3%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lweekmonsdfdseptname" runat="server" Text='<%#Bind("StatusName")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
