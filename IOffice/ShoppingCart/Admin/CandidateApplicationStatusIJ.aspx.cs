...
public partial class ShoppingCart_Admin_CandidateApplicationStatusIJ : System.Web.UI.Page
{
    ...
    {
        string qry = "select * from CandidateApplicationStatusMasterIJ where PageStatusName='" + txtdocumenttype.Text + "'";
        ...
        else
        {
           ...
           // SqlCommand cmd = new SqlCommand(qry1, con);           
            SqlCommand cmd = new SqlCommand("insertCandidateStatusIJ", con);
    ...
    {
        string qry = "select * from CandidateApplicationStatusMasterIJ where PageStatusName='" + txtdocumenttype.Text + "' and  id <> '" + ViewState["id"].ToString() + "'";
        SqlCommand cmd1 = new SqlCommand(qry, con);
        SqlDataAdapter da1 = new SqlDataAdapter(cmd1);
        DataTable dt1 = new DataTable();
        if (con.State.ToString() != "Open")
        ...
        else
        {
            ...
            SqlCommand cmd = new SqlCommand("updateCandidateStatusIJ", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@PageStatusName", txtdocumenttype.Text);
            cmd.Parameters.AddWithValue("@StatusShortName", txtshortname.Text);
            cmd.Parameters.AddWithValue("@Active", ddlstactive.SelectedValue);
    ...
    protected void grdsecquestuion_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "edit")
        {
            ...
            string qry = "Select * from CandidateApplicationStatusMasterIJ where id='" + e.CommandArgument.ToString() + "'";
            SqlCommand cmd = new SqlCommand(qry, con);
        ...
        if (e.CommandName == "delete")
        {
            ...
            btnsubmit.Visible = false;
            btnadddd.Visible = true;
            string qry1 = "Select * from CandidateApplicationStatusMasterIJ where id='" + e.CommandArgument.ToString() + "'";
            ...
            else
            {
                ...
                //SqlCommand cmd = new SqlCommand(qry, con);
                SqlCommand cmd = new SqlCommand("deleteCandidateStatusIJ", con);
                cmd.CommandType = CommandType.StoredProcedure;
    ...
    public void Bindgrid()
    {
        ...
        {
            ViewState["str"] = "Select * from CandidateApplicationStatusMasterIJ";
        }
        if (ddlstapplicationstatus.SelectedValue == "Active")
        {
            ViewState["str"] = "Select * from CandidateApplicationStatusMasterIJ where Active='True'";
        }
        if (ddlstapplicationstatus.SelectedValue == "Inactive")
        {
            ViewState["str"] = "Select * from CandidateApplicationStatusMasterIJ where Active='False'";
        }
