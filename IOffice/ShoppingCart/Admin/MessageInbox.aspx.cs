...
public partial class Account_MessageInbox : System.Web.UI.Page
{
    SqlConnection con;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Session["PageName"] = "MessageInbox.aspx";
    ...
    protected void SelectMsgforInbox()
    {
        ...
        //dt =  clsMessage.SelectMsgforInbox(Convert.ToInt32(Session["PartyId"].ToString())) ;
        string mes1 = "";
        string mes2 = "";
        string mes3 = "";
        string mes4 = "";
        ...
        gridInbox.VirtualItemCount = GetRowCount(str2);
        ...
        {
            DataTable dt = GetDataPage(gridInbox.PageIndex, gridInbox.PageSize, sortExpression, mes);
    ...
    protected void gridInbox_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
