<%@ Page Title="" Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="RuleAddManageView.aspx.cs" Inherits="ShoppingCart_Admin_RuleAddManage" %>
            ...
            <div class="products_box">
                <fieldset>
                    ...
                    <div style="float: right;">
                        <asp:Button ID="btnadd" runat="server" CssClass="btnSubmit" Text="Add Rule" Visible="false" OnClick="btnadd_Click" />
                    </div>
                    <div style="clear: both;">
                    </div>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td style="width: 70%">
                                    ...
                                    <label>
                                        <asp:Label runat="server" ID="Label25" Text="" CssClass="labelcount"></asp:Label>
                                        <span id="Span2"></span>
                                        ...
                                        <table style="width: 100%">
                                            <tr>
                                                ...
                                                <td style="width: 70%">
                                                    ...
                                                    <label>
                                                        <asp:Label runat="server" ID="Label24" Text="" CssClass="labelcount" Visible="false"></asp:Label>
                                                        <span id="Span3"></span>
                                                        <asp:Label ID="lblinvstiename" runat="server" Text="" CssClass="labelcount" Visible="false"></asp:Label>
                                                    </label>
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <tr>
                                ...
                                <td style="width: 70%;">
                                    ...
                                    <label>
                                        <asp:Label runat="server" ID="Label27" Text=" " CssClass="labelcount"></asp:Label>
                                        <span id="Span1">5</span>
                                        <asp:Label ID="lblkjsadfgh" runat="server" Text="" CssClass="labelcount"></asp:Label>
                                    </label>
                                </td>
                            </tr>
                            <tr>
