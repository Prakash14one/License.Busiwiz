...
public partial class ShoppingCart_Admin_CanadaFaderalTD1 : System.Web.UI.Page
{
    ...
    protected void fillPayrolltax()
    {
        ...
        string str = "  Select [PayrollTaxMaster].[PayRollTax_Id],[PayrollTaxMaster].[Tax_Name]+' : '+ CountryMaster.CountryName+' : '+StateMasterTbl.StateName +' : '+Convert(nvarchar,PayrolltaxMaster.start_date,101) +' : '+Convert(nvarchar,PayrolltaxMaster.end_date,101) as tax_name " +
                    ...
                    "  inner join StateMasterTbl on StateMastertbl.StateId=PayrolltaxMaster.State_id  " +
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        string str = " select * from CanadaFederalTd1 where EmployeeId='" + ddlemployee.SelectedValue + "' and TaxTearId='" + ddltaxyear.SelectedValue + "' and [PayrollTaxMasterId] = '"+ddpayrolldeduction.SelectedValue+"' and Whid='" + ddlstore.SelectedValue + "'  ";
        ...
        else
        {
            ...
            double temp = item1 + item2 + item3 + item4 + item5 + item6 + item7 + item8 + item9 + item10 + item11 + item12;
            TextBox3.Text = temp.ToString();




            String avginsert = "Insert Into CanadaFederalTd1 (EmployeeId,TaxTearId,PayrollTaxMasterId,Date,Whid,compid,[1BasicpersonalAmount],[2ChildAmount],[3AgeAmount],[4PensionIncomeAmount],[5TutionEducationtextbookAmount],[6DisabilityAmount],[7Spouseorcommonlawamount],[8CaregiverAmount],[9Amountforinfirmdependantsage18orolder],[10Amountstransferredfromyourspouseorcommonlawpartner],[11Amountstransferred],[12Amountstransferredfromadependant],[13TotalClaimAmount],[14Morethanoneemployerorpayer],[15Totalincomelessthantotalclaimamount],[16Nonresidents],[17Deductionforlivinginaprescribedzone],[18Additionaltaxtobededucted],[19Signature],[20SignatureDate],[21taxyear]) " +
                               " values ('" + ddlemployee.SelectedValue + "','" + ddltaxyear.SelectedValue + "','" + ddpayrolldeduction.SelectedValue + "','" + System.DateTime.Now.ToShortDateString() + "','" + ddlstore.SelectedValue + "','" + Session["Comid"].ToString() + "','" + TextBox15.Text + "','" + TextBox14.Text + "','" + TextBox13.Text + "','" + TextBox12.Text + "','" + TextBox11.Text + "','" + TextBox10.Text + "','" + TextBox9.Text + "','" + TextBox8.Text + "','" + TextBox7.Text + "','" + TextBox6.Text + "','" + TextBox5.Text + "','" + TextBox4.Text + "','" + TextBox3.Text + "','" + CheckBox1.Checked + "','" + CheckBox2.Checked + "','" + CheckBox3.Checked + "','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox17.Text + "','" + TextBox16.Text + "','"+TextBox20.Text+"')";
    ...
    {
        string str = "select CanadaFederalTd1.*,EmployeeMaster.EmployeeName,WareHouseMaster.Name as WName from CanadaFederalTd1 inner join EmployeeMaster on EmployeeMaster.EmployeeMasterID=CanadaFederalTd1.EmployeeId  inner join WareHouseMaster on CanadaFederalTd1.Whid=WareHouseMaster.WareHouseId where CanadaFederalTd1.compid='" + Session["comid"] + "' order by EmployeeMaster.EmployeeName";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "vi")
        {
            ...
            string strsel = "select * from CanadaFederalTd1 where Id='" + ViewState["MasterId"] + "'";
            ...
            TextBox4.Text = dtview.Rows[0]["12Amountstransferredfromadependant"].ToString();
            ...
            TextBox17.Text = dtview.Rows[0]["19Signature"].ToString();
            TextBox16.Text = dtview.Rows[0]["20SignatureDate"].ToString();
            TextBox20.Text = dtview.Rows[0]["21taxyear"].ToString();
            CheckBox1.Checked =Convert.ToBoolean (dtview.Rows[0]["14Morethanoneemployerorpayer"].ToString());
            CheckBox2.Checked = Convert.ToBoolean(dtview.Rows[0]["15Totalincomelessthantotalclaimamount"].ToString());
        ...
        {
            string st2 = "Delete from CanadaFederalTd1 where Id=" + mm;
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        string str = " select * from CanadaFederalTd1 where EmployeeId='" + ddlemployee.SelectedValue + "' and TaxTearId='" + ddltaxyear.SelectedValue + "' and [PayrollTaxMasterId] = '" + ddpayrolldeduction.SelectedValue + "' and Whid='" + ddlstore.SelectedValue + "' and Id<>'" + ViewState["MasterId"] + "' ";
        ...
        else
        {
            ...
            String avginsert = "Update CanadaFederalTd1 set EmployeeId='" + ddlemployee.SelectedValue + "',TaxTearId='" + ddltaxyear.SelectedValue + "',PayrollTaxMasterId='" + ddpayrolldeduction.SelectedValue + "',Date='" + System.DateTime.Now.ToShortDateString() + "',Whid='" + ddlstore.SelectedValue + "',compid='" + Session["Comid"].ToString() + "',[1BasicpersonalAmount]='" + TextBox15.Text + "',[2ChildAmount]='" + TextBox14.Text + "',[3AgeAmount]='" + TextBox13.Text + "',[4PensionIncomeAmount]='" + TextBox12.Text + "',[5TutionEducationtextbookAmount]='" + TextBox11.Text + "',[6DisabilityAmount]='" + TextBox10.Text + "',[7Spouseorcommonlawamount]='" + TextBox9.Text + "',[8CaregiverAmount]='" + TextBox8.Text + "',[9Amountforinfirmdependantsage18orolder]='" + TextBox7.Text + "',[10Amountstransferredfromyourspouseorcommonlawpartner]='" + TextBox6.Text + "',[11Amountstransferred]='" + TextBox5.Text + "',[12Amountstransferredfromadependant]='" + TextBox4.Text + "',[13TotalClaimAmount]='" + TextBox3.Text + "',[14Morethanoneemployerorpayer]='" + CheckBox1.Checked + "',[15Totalincomelessthantotalclaimamount]='" + CheckBox2.Checked + "',[16Nonresidents]='" + CheckBox3.Checked + "',[17Deductionforlivinginaprescribedzone]='" + TextBox2.Text + "',[18Additionaltaxtobededucted]='" + TextBox1.Text + "',[19Signature]='" + TextBox17.Text + "',[20SignatureDate]='" + TextBox16.Text + "',[21taxyear]='" + TextBox20.Text + "' where Id='" + ViewState["MasterId"] + "' ";
    ...
    {
        string stremp = "select EmployeeMaster.EmployeeMasterID,EmployeeMaster.EmployeeName+':'+DesignationMaster.DesignationName+':'+cast(EmployeeMaster.EmployeeMasterID as Nvarchar(50)) as EmployeeName   from EmployeeMaster inner join DesignationMaster on EmployeeMaster.DesignationMasterId=DesignationMaster.DesignationMasterId inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID  inner join BatchMaster on EmployeeBatchMaster.Batchmasterid=BatchMaster.ID where EmployeeBatchMaster.Batchmasterid='" + DropDownList2.SelectedValue + "' ";
        SqlCommand cmdemp = new SqlCommand(stremp, con);
        SqlDataAdapter adpemp = new SqlDataAdapter(cmdemp);
        DataSet dsemp = new DataSet();
        adpemp.Fill(dsemp);
    ...
    {
        string str = "select CanadaFederalTd1.*,EmployeeMaster.EmployeeName,WareHouseMaster.Name as WName from CanadaFederalTd1 inner join EmployeeMaster on EmployeeMaster.EmployeeMasterID=CanadaFederalTd1.EmployeeId inner join WareHouseMaster on CanadaFederalTd1.Whid=WareHouseMaster.WareHouseId where CanadaFederalTd1.compid='" + Session["Comid"].ToString() + "' and CanadaFederalTd1.EmployeeId='" + DropDownList3.SelectedValue + "' and CanadaFederalTd1.Date between '" + TextBox18.Text + "' and '" + TextBox19.Text + "' order by EmployeeMaster.EmployeeName";
        //select EmployeePayrollMaster.LastName+':'+EmployeePayrollMaster.FirstName+':'+EmployeePayrollMaster.Intials as EmployeeName from EmployeePayrollMaster
        SqlCommand cmd = new SqlCommand(str, con);
        SqlDataAdapter adp = new SqlDataAdapter(cmd);
        DataSet ds = new DataSet();
