        ...
        <ContentTemplate>
            <div class="products_box">
             <div style="float: left;padding:1%;">
                ...
                <fieldset>
                <legend><asp:Label ID="lblms" runat="server" Text=""></asp:Label></legend>
                      <div style="float: right;">
                    <label>
                        <asp:Button ID="btnaddacc" runat="server" Text="Add Device" 
                                 CssClass="btnSubmit" onclick="btnaddacc_Click" />
                     ...
                     <tr>
                        ...
                        <label>
                          <asp:TextBox ID="txtattedeviceno" runat="server" onKeydown="return mask(event)" onkeyup="return check(this,/[\\/!@#$%^'_.&*a-zA-Z()>+:;={}[]|\/]/g,/^[\0-9\s]+$/,'div1',10)"
                                        ...
                                        <cc1:FilteredTextBoxExtender ID="FilteredTetender4" runat="server" Enabled="True" TargetControlID="txtattedeviceno" ValidChars="0123456789">
            </cc1:FilteredTextBoxExtender>
                        </label>
                        <label>  <asp:Label ID="Label20" runat="server" Text="Max " CssClass="labelcount" ></asp:Label><span id="div1" class="labelcount">10</span>
                        ...
                        <label>
                          <asp:TextBox ID="txtattedevicename" runat="server" onKeydown="return mask(event)" onkeyup="return check(this,/[\\/!@#$%^'.&*()>+:;={}[]|\/]/g,/^[\a-zA-Z0-9_\s]+$/,'Span1',30)"
                                        MaxLength="30" ></asp:TextBox>
                                                  </label>
                                                  <label>  <asp:Label ID="Label10" runat="server" Text="Max " CssClass="labelcount" ></asp:Label><span id="Span1" class="labelcount">30</span>
                       ...
                       <tr>
                        ...
                        <label><asp:Label ID="Label14" runat="server" Text="Max " CssClass="labelcount" ></asp:Label><span id="Span2" class="labelcount">30</span>
                                    <asp:Label ID="Label15" runat="server" Text="(A-Z 0-9 _)" CssClass="labelcount"></asp:Label></label>
                         </td>
                    </tr>
                      <tr>
                         <td style="width:25%" >
                         <label><asp:Label ID="Label34" runat="server" Text="IP Address"></asp:Label>  <asp:Label ID="Label35" runat="server" Text="*" CssClass="labelstar"></asp:Label></label>
                       
                         </td>
                         <td>  <label>   
                
                <asp:TextBox ID="txtIpAddress" runat="server" MaxLength="3" Width="40px" onkeypress="return mask(event)" onkeyup="return checktextboxmaxlength(this,3,event)" ></asp:TextBox>  
               
            <cc1:FilteredTextBoxExtender ID="txtEndzip_FilteredTextBoxExtender" runat="server" Enabled="True" TargetControlID="txtIpAddress" ValidChars="0123456789">
            </cc1:FilteredTextBoxExtender>
              </label> 
              <label>  <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                         ControlToValidate="txtIpAddress" ErrorMessage="*" SetFocusOnError="true"  Display="Dynamic"
                         ValidationGroup="1"></asp:RequiredFieldValidator>    <asp:Label ID="Label36" runat="server" Text="(0-255)" CssClass="labelcount"></asp:Label></label>
         
           
              
                    <label>
                <asp:TextBox ID="txtip1" runat="server" MaxLength="3" Width="40px"  onkeypress="return mask(event)" onkeyup="return checktextboxmaxlength(this,3,event)" ></asp:TextBox>  
               
            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True" TargetControlID="txtip1" ValidChars="0123456789">
            </cc1:FilteredTextBoxExtender>
            </label>  
            <label>  <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                         ControlToValidate="txtip1" ErrorMessage="*" SetFocusOnError="true"  Display="Dynamic"
                         ValidationGroup="1"></asp:RequiredFieldValidator>  <asp:Label ID="Label37" runat="server" Text="(0-255)" CssClass="labelcount"></asp:Label></label>
           
           
               
                 
                     <label>
                <asp:TextBox ID="txtip2" runat="server" MaxLength="3" Width="40px"  onkeypress="return mask(event)" onkeyup="return checktextboxmaxlength(this,3,event)" ></asp:TextBox>   
              
            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" Enabled="True" TargetControlID="txtip2" ValidChars="0123456789">
            </cc1:FilteredTextBoxExtender>
             </label>
            <label><asp:RequiredFieldValidator ID="RequFieldValidator4" runat="server" 
                         ControlToValidate="txtip2" ErrorMessage="*" SetFocusOnError="true"  Display="Dynamic"
                         ValidationGroup="1"></asp:RequiredFieldValidator>   <asp:Label ID="Label38" runat="server" Text="(0-255)" CssClass="labelcount"></asp:Label></label>
            
                
                      <label>
                <asp:TextBox ID="txtip3" runat="server" MaxLength="3" Width="40px"  onkeypress="return mask(event)" onkeyup="return checktextboxmaxlength(this,3,event)" ></asp:TextBox>   
               
            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" Enabled="True" TargetControlID="txtip3" ValidChars="0123456789">
            </cc1:FilteredTextBoxExtender>
           </label> <label>     <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                         ControlToValidate="txtip3" ErrorMessage="*" SetFocusOnError="true"  Display="Dynamic"
                         ValidationGroup="1"></asp:RequiredFieldValidator>  <asp:Label ID="Label39" runat="server" Text="(0-255)" CssClass="labelcount"></asp:Label></label>
                        ...
                        <label>
                          <asp:TextBox ID="txtverno" runat="server" onKeydown="return mask(event)" onkeyup="return check(this,/[\\/!@#$%^'.&*()>+:;={}[]|\/]/g,/^[\a-zA-Z0-9_\s]+$/,'Span3',30)"
                               ...
                               ></asp:TextBox>
                                    ...
                                    <label>  <asp:Label ID="Label18" runat="server" Text="Max " CssClass="labelcount" ></asp:Label><span id="Span3" class="labelcount">30</span>
                    ...
                    --%>         
                        ...
                        <label>
                          <asp:TextBox ID="txtmake" runat="server" onKeydown="return mask(event)" onkeyup="return check(this,/[\\/!@#$%^'.&*()>+:;={}[]|\/]/g,/^[\a-zA-Z0-9_\s]+$/,'Span4',30)"
                                        MaxLength="30"></asp:TextBox>
                                             ...
                                             <label> <asp:Label ID="Label24" runat="server" Text="Max " CssClass="labelcount" ></asp:Label><span id="Span4" class="labelcount">30</span>
                       ...
                       <tr>
                        ...
                        <label>
                          <asp:TextBox ID="txtmodel" runat="server" onKeydown="return mask(event)" onkeyup="return check(this,/[\\/!@#$%^'.&*()>+:;={}[]|\/]/g,/^[\a-zA-Z0-9_\s]+$/,'Span5',30)"
                                        ...
                                        <label> <asp:Label ID="Label28" runat="server" Text="Max " CssClass="labelcount" ></asp:Label><span id="Span5" class="labelcount">30</span>
                     ...
                     ValidationGroup="1" Height="73px"  TextMode="MultiLine"
               onKeydown="return mask(event)" onkeyup="return check(this,/[\\/!@#$%^'&*>+.:;={}()[]|\/]/g,/^[\a-zA-Z0-9_\s]+$/,'div2',150)" 
                  MaxLength="150" 
                onkeypress="return checktextboxmaxlength1(this,150,event)" Width="370px"></asp:TextBox>
                
                   <asp:Label ID="Label32" runat="server" Text="Max" CssClass="labelcount" ></asp:Label> <span id="div2" class="labelcount">
                                       150</span> <asp:Label ID="Label33" runat="server" Text="(A-Z 0-9 _ )"  CssClass="labelcount"></asp:Label>        </label>
                         </td>
                    </tr>
                       ...
                       <tr>
                         ...
                         <td style="width:25%" >
                           ...
                           <td> <asp:Button ID="ImageButton9" runat="server" CssClass="btnSubmit" Text="Update" OnClick="ImageButton9_Click"
                ...
                <fieldset>
                  ...
                  <%--  <div style="clear: both;">
                    ...
                    <tr>
                    <td >
                    <label><asp:Label ID="Label41" runat="server" Text="Filter by Business">
                            </asp:Label></label>
                            <label>
                            
                              <asp:DropDownList ID="ddlbussnessfilter" runat="server" 
                        onselectedindexchanged="ddlbussnessfilter_SelectedIndexChanged" 
                        AutoPostBack="True" >
                         </asp:DropDownList>
                            </label>
                            <label></label>
                            <label><asp:Label ID="Label3" runat="server" Text="Search">
                            </asp:Label></label>
                            <label><asp:TextBox ID="txtserach" runat="server" AutoPostBack="True" 
                            ontextchanged="txtserach_TextChanged" ></asp:TextBox></label>
                    </td>
                    </tr>
                    </table>
                     <label>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                  EmptyDataText="No Record Found. " CssClass="mGrid"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Attendance Device Name" SortExpression="AttendanceDeviceName" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <asp:TemplateField HeaderText="Attendance<br>Device Number " SortExpression="AttendanceDeviceNo" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <asp:TemplateField HeaderText="Edit" ItemStyle-Width="2%" HeaderImageUrl="~/Account/images/edit.gif"
                                            HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="edit" runat="server" ToolTip="Edit" CommandArgument='<%# Bind("Id") %>' CommandName="Edit"
