...
public partial class Admin_Admin_files_FrmProjectMaster : System.Web.UI.Page
{
    ...
    protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (RadioButtonList1.SelectedValue == "2")//Division
        {
            ...
            //----NEW
            pnlOnlyBusiness.Visible = true;
            DDLwarehous();
           // DDLonlyBusiness_SelectedIndexChanged(sender, e);
        }
    ...
    protected void FillParty()
    {
        ...
        //ddlpartyname.SelectedIndex = ddlpartyname.Items.IndexOf(ddlpartyname.Items.FindByText("Documents"));
    }
