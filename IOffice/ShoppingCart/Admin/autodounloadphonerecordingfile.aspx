<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="autodounloadphonerecordingfile.aspx.cs" Inherits="ShoppingCart_Admin_AddNewServiceCall"
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div  class="products_box">
                                         ...
                                         <asp:Panel ID="Panel2" runat="server" Width="100%">
                                             <table width="100%">
                                                 <tr>
                                                     <td align="right">
                                                         <label>
                                                         <asp:Label ID="lbldoyou" runat="server" Text="Do you wish to setup rules to auto retrieve documents from FTP?" Visible="false"></asp:Label>
                                                         </label>
                                                         ...
                                                         <asp:Button ID="Button3" runat="server" CssClass="btnSubmit" OnClick="RadioButtonList1_SelectedIndexChanged1" Text="Add New" />
                                                     </td>
                                                 </tr>
                                             </table>
                                         </asp:Panel>
                                                     ...
                                                     <td>
                                                         <table cellspacing="3" width="100%">
                                                             ...
                                                             <tr>
                                                                 <td class="auto-style1">
                                                                     <label>
                                                                     <asp:Label ID="Label37" runat="server" Text="Set the location to pick up files from"></asp:Label>
                                                                     </label>
                                                                 </td>
                                                                 <td style="width: 80%">
                                                                     <label>
                                                                     <asp:DropDownList ID="ddl_location" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlbusiness_SelectedIndexChanged1">
                                                             ...
                                                             <asp:Panel ID="pnl_main" runat="server" Visible="false">
                                                                 <asp:Panel ID="pnl_ftp" runat="server" Visible="false">
                                                                     <tr>
                                                                         <td class="auto-style1">
                                                                             <label>
                                                                             <asp:Label ID="Label3" runat="server" Text=" FTP URL/IP Address"></asp:Label>
                                                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtftpserver" ErrorMessage="*" ValidationGroup="1"></asp:RequiredFieldValidator>
                                                                             <asp:RegularExpressionValidator ID="REG11" runat="server" ControlToValidate="txtftpserver" Display="Dynamic" ErrorMessage="Invalid Character" SetFocusOnError="True" ValidationExpression="^([_@.\\:/a-zA-Z0-9\s]*)" ValidationGroup="1"></asp:RegularExpressionValidator>
                                                                             </label>
                                                                         </td>
                                                                         <td>
                                                                             <label>
                                                                             <asp:TextBox ID="txtftpserver" runat="server" Enabled="False" MaxLength="30" onKeydown="return mak('Span2',100,this)"></asp:TextBox>
                                                                             </label>
                                                                             <label>
                                                                             <asp:Label ID="Label18" runat="server" CssClass="labelcount" Text="Max"></asp:Label>
                                                                     ...
                                                                     <tr>
                                                                         <td class="auto-style1">
                                                                             ...
                                                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtFtpName" ErrorMessage="*" ValidationGroup="1"></asp:RequiredFieldValidator>
                                                                             </label>
                                                                         </td>
                                                                         <td>
                                                                             <label>
                                                                             <asp:TextBox ID="txtFtpName" runat="server" Enabled="False" MaxLength="10" onKeydown="return mak('Span3',10,this)"></asp:TextBox>
                                                                             <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True" TargetControlID="txtFtpName" ValidChars="0147852369" />
                                                                             </label>
                                                                             <label>
                                                                     ...
                                                                     <tr>
                                                                         <td class="auto-style1">
                                                                             ...
                                                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUsername" ErrorMessage="*" ValidationGroup="1"></asp:RequiredFieldValidator>
                                                                             <asp:RegularExpressionValidator ID="RegularExpressionValidator56" runat="server" ControlToValidate="txtUsername" Display="Dynamic" ErrorMessage="*" SetFocusOnError="True" ValidationExpression="^([a-zA-Z0-9@._]*)" ValidationGroup="1"></asp:RegularExpressionValidator>
                                                                             </label>
                                                                         </td>
                                                                         <td>
                                                                             <label>
                                                                             <asp:TextBox ID="txtUsername" runat="server" Enabled="False" MaxLength="30" onKeydown="return mask(event)" onkeyup="return check(this,/[\\/!#$%^'&amp;*()&gt;+:;={}[]|\/]/g,/^[\a-zA-Z0-9_.@ \s]+$/,'Span4',30)" ValidationGroup="1"></asp:TextBox>
                                                                             </label>
                                                                             <label>
                                                                             <asp:Label ID="Label29" runat="server" CssClass="labelcount" Text="Max"></asp:Label>
                                                                     ...
                                                                     <tr>
                                                                         <td class="auto-style1">
                                                                             ...
                                                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtPwd" ErrorMessage="*" ValidationGroup="1"></asp:RequiredFieldValidator>
                                                                             <asp:RegularExpressionValidator ID="RegularExpressionValidator20" runat="server" ControlToValidate="txtPwd" Display="Dynamic" ErrorMessage="Invalid Character" SetFocusOnError="True" ValidationExpression="^([_.+-@a-zA-Z0-9\s]*)" ValidationGroup="1"></asp:RegularExpressionValidator>
                                                                             </label>
                                                                         </td>
                                                                         <td>
                                                                             <label>
                                                                             <asp:TextBox ID="txtPwd" runat="server" Enabled="False" MaxLength="30" onKeydown="return mak('Span5',30,this)" TextMode="Password" Width="200px"></asp:TextBox>
                                                                             </label>
                                                                             <label>
                                                                 ...
                                                                 <asp:Panel ID="pnl_folder" runat="server" Visible="false">
                                                                     <tr>
                                                                         <td class="auto-style1">
                                                                             <label>
                                                                             <asp:Label ID="Label38" runat="server" Text=" Folder Path"></asp:Label>
                                                                             </label>
                                                                         </td>
                                                                         <td>
                                                                             <label>
                                                                             <asp:TextBox ID="txt_folder" runat="server" MaxLength="30" ValidationGroup="1"></asp:TextBox>
                                                                             </label>
                                                                             <label>
                                                                             </label>
                                                                         </td>
                                                                 ...
                                                                 <tr>
                                                                     <td class="auto-style1">
                                                                         ...
                                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2226" runat="server" ControlToValidate="txtautoretrival" ErrorMessage="*" ValidationGroup="1"></asp:RequiredFieldValidator>
                                                                         </label>
                                                                     </td>
                                                                     <td>
                                                                         <label>
                                                                         <asp:TextBox ID="txtautoretrival" runat="server" Enabled="False" MaxLength="4" onKeydown="return mak('Span1',4,this)"></asp:TextBox>
                                                                         <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3fsd" runat="server" Enabled="True" TargetControlID="txtautoretrival" ValidChars="0147852369" />
                                                                         </label>
                                                                         <label>
                                                                         <asp:Label ID="Label20" runat="server" CssClass="labelcount" Text="Max"></asp:Label>
                                                                 ...
                                                                 <tr>
                                                                     ...
                                                                     <td>
                                                                         <label>
                                                                         <asp:CheckBox ID="Chkautoprcss" runat="server" Text="Active ?" Visible="false" />
                                                                         </label>
                                                                         <br />
                                                                         <a onclick="ShowMyModalPopup121();"></a></td>
                                                                 </tr>
                                                                 <tr>
                                                                     <td class="auto-style1"></td>
                                                                     <td>
                                                                         <label>
                                                                         <asp:Label ID="Label10" runat="server" Text="Do you wish to create rules to atuo organize your documents?" Visible="false"></asp:Label>
                                                                         </label>
                                                                         <label>
                                                                         <a onclick="ShowMyModalPopup1();"></a>
                                                                         </label>
                                                                     </td>
                                                                 </tr>
                                                                 <tr>
                                                                     <td class="auto-style1"></td>
                                                                     <td>
                                                                         <asp:RadioButtonList ID="rbtnlistsetrules" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rbtnlistsetrules_SelectedIndexChanged" RepeatDirection="Vertical" Visible="false">
                                                  ...
                                                  Set fixed document process rule
                                                    <a onclick="ShowMyModalPopup1234();">See more details.</a>
                                                                     ...
                                                                     <td colspan="2">
                                                                         <asp:Panel ID="pnlsetrule" runat="server" Visible="False" Width="100%">
                                                                             <fieldset>
                                                                                 ...
                                                                                 <table width="100%">
                                                                                     <tr>
                                                                                         <td colspan="2">Please note that the below document title, cabinet, drawer, folder, party name and document description will be given to all documents retrieved from your FTP account. </td>
                                                                                     </tr>
                                                                                     <tr>
                                                                                         <td style="width: 20%">
                                                                                             <label>
                                                                                             <asp:Label ID="Label22" runat="server" Text="Document Title"></asp:Label>
                                                                                             <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtdoctitle" Display="Dynamic" ErrorMessage="Invalid Character" SetFocusOnError="True" ValidationExpression="^([a-zA-Z0-9\s_]*)" ValidationGroup="1"></asp:RegularExpressionValidator>
                                                                                             </label>
                                                                                         </td>
                                                                                         <td style="width: 80%">
                                                                                             <label>
                                                                                             <asp:TextBox ID="txtdoctitle" runat="server" MaxLength="30" onKeydown="return mask(event)" onkeyup="return check(this,/[\\/!#$%^'@.&amp;*()&gt;+:;={}[]|\/]/g,/^[\a-zA-Z0-9_ \s]+$/,'Span6',30)" Width="300px"></asp:TextBox>
                                                                                             </label>
                                                                                             <label>
                                                                                             <asp:Label ID="Label23" runat="server" CssClass="labelcount" Text="Max"></asp:Label>
                                                                                     ...
                                                                                     <tr>
                                                                                         ...
                                                                                         <td>
                                                                                             <label>
                                                                                             <asp:DropDownList ID="ddldoctype" runat="server" DataTextField="doctype" DataValueField="DocumentTypeId" Width="500px">
                                                                                             </asp:DropDownList>
                                                                                             </label>
                                                                                             <label>
                                                                                             <asp:ImageButton ID="imgAdd" runat="server" AlternateText="Add New" Height="20px" ImageAlign="Bottom" ImageUrl="~/ShoppingCart/images/AddNewRecord.jpg" OnClick="imgAdd_Click" ToolTip="Add New " Width="20px" />
                                                                                             </label>
                                                                                             <label>
                                                                                             <asp:ImageButton ID="imgRefresh" runat="server" AlternateText="Refresh" Height="20px" ImageAlign="Bottom" ImageUrl="~/ShoppingCart/images/DataRefresh.jpg" OnClick="imgRefresh_Click" ToolTip="Refresh" Width="20px" />
                                                                                             </label>
                                                                                         </td>
                                                                                     </tr>
                                                                                     <tr>
                                                                                         <td>
                                                                                             ...
                                                                                             <asp:RequiredFieldValidator ID="RiredFiealidator2" runat="server" ControlToValidate="ddldt" ErrorMessage="*" SetFocusOnError="true" ValidationGroup="1"></asp:RequiredFieldValidator>
                                                                                             </label>
                                                                                         </td>
                                                                                         <td>
                                                                                             <label>
                                                                                             ...
                                                                                             <label>
                                                                                             <asp:ImageButton ID="ImageButton4" runat="server" AlternateText="Add New" Height="20px" ImageUrl="~/ShoppingCart/images/AddNewRecord.jpg" onclick="ImageButton4_Click" ToolTip="AddNew" Width="20px" />
                                                                                             </label>
                                                                                             <label>
                                                                                             <asp:ImageButton ID="ImageButton5" runat="server" AlternateText="Refresh" Height="20px" ImageUrl="~/ShoppingCart/images/DataRefresh.jpg" onclick="ImageButton5_Click" ToolTip="Refresh" Width="20px" />
                                                                                             </label>
                                                                                         </td>
                                                                                     </tr>
                                                                                     <tr>
                                                                                         ...
                                                                                         <td>
                                                                                             ...
                                                                                             <label>
                                                                                             <asp:ImageButton ID="imgAdd2" runat="server" AlternateText="Add New" Height="20px" ImageAlign="Bottom" ImageUrl="~/ShoppingCart/images/AddNewRecord.jpg" OnClick="imgAdd2_Click" ToolTip="Add New " Width="20px" />
                                                                                             </label>
                                                                                             <label>
                                                                                             <asp:ImageButton ID="imgRefresh2" runat="server" AlternateText="Refresh" Height="20px" ImageAlign="Bottom" ImageUrl="~/ShoppingCart/images/DataRefresh.jpg" OnClick="imgRefresh2_Click" ToolTip="Refresh" Width="20px" />
                                                                                             </label>
                                                                                         </td>
                                                                                     </tr>
                                                                                     <tr>
                                                                                         <td>
                                                                                             ...
                                                                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtdocdesc" ErrorMessage="*" ValidationGroup="1"></asp:RequiredFieldValidator>
                                                                                             <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtdocdesc" Display="Dynamic" ErrorMessage="Invalid Character" SetFocusOnError="True" ValidationExpression="^([_a-zA-Z0-9\s]*)" ValidationGroup="1"></asp:RegularExpressionValidator>
                                                                                             </label>
                                                                                         </td>
                                                                                         <td>
                                                                                             <label>
                                                                                             <asp:TextBox ID="txtdocdesc" runat="server" MaxLength="100" onKeydown="return mask(event)" onkeypress="return checktextboxmaxlength(this,100,event)" onkeyup="return check(this,/[\\/!@#$%^'&amp;*()&gt;+:;={}[]|\/]/g,/^[\a-zA-Z0-9_. \s]+$/,'Span3',100)" TextMode="MultiLine" Width="350px"></asp:TextBox>
                                                                                             </label>
                                                                                             <label>
                                                                 ...
                                                                 <tr>
                                                                     <td class="auto-style1"></td>
                                                                     <td>
                                                                         <asp:Button ID="imgbtnsubmit" runat="server" CssClass="btnSubmit" OnClick="imgbtnsubmit_Click1" Text="Submit" ValidationGroup="1" />
                                                                         <asp:Button ID="imgbtnUpdate" runat="server" CssClass="btnSubmit" OnClick="imgbtnUpdate_Click" Text="Update" ValidationGroup="1" Visible="False" />
                                                                         <asp:Button ID="imgbtnReset" runat="server" CssClass="btnSubmit" OnClick="imgbtnReset_Click" Text="Cancel" />
                                                                     </td>
                                                                 </tr>
                                                             </asp:Panel>
                                                         </table>
                ...
                <fieldset>
                    <legend>
                        <asp:Label ID="lbllegend" runat="server" Text="List of Phone Recording Download setup"></asp:Label>
                    </legend>
                    <table width="100%">
                        <tr>
                            <td>
                                                ...
                                                <asp:GridView ID="GridFTP" runat="server" AllowPaging="True" AllowSorting="true"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Business" SortExpression="Wname" HeaderStyle-HorizontalAlign="Left">
                                                         ...
                                                         <asp:TemplateField HeaderText="Source of Files" SortExpression="location" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="FTP URL/IP Address" SortExpression="FTP" HeaderStyle-HorizontalAlign="Left">
                                                          ...
                                                          <asp:TemplateField HeaderText="FTP Port" SortExpression="Ftppath" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblautoret1" runat="server" Text='<%# Bind("Ftppath") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Auto Retrieval Time (Mins)" SortExpression="AutoRetrival"
                                                          ...
                                                          <asp:TemplateField HeaderText="Active" SortExpression="DocumentAutoApprove"
                                                            HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
