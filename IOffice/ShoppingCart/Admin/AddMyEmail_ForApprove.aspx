<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="AddMyEmail_ForApprove.aspx.cs" Inherits="Account_AddCompanyEmail"
    Title="Untitled Page" %>
    ...
    <asp:UpdatePanel ID="UpdatePanelUserMng" runat="server">
        <ContentTemplate>
            ...
            <div class="products_box">
                <fieldset>
                    ...
                    <div style="float: right;">
                        <asp:Button ID="btnadddd" runat="server" Text="Add New Email" CssClass="btnSubmit"
                           Visible="false" OnClick="btnadddd_Click" />
                    </div>
                    <div style="clear: both;">
                    </div>
                ...
                <fieldset>
                    <legend>
                        <asp:Label ID="Label25" runat="server" Text="List of Panding Approvel Email Accounts"></asp:Label>
                    </legend>
                    <table width="100%">
                        <tr>
                            <td>
                                <div style="float: right;">
                                    ...
                                    Visible="false"    CausesValidation="False" OnClick="Button1_Click" />
                            ...
                            <td>
                                ...
                                <label>
                                    <asp:DropDownList ID="ddlbusinessfil" runat="server" Width="203px" AutoPostBack="True"
                                       OnSelectedIndexChanged="ddlbusinessfil_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </label>
                                <label>
                                ...
                                <label>
                                    <asp:DropDownList ID="ddlempfil" runat="server" Width="203px" AutoPostBack="True"
                                        OnSelectedIndexChanged="ddlempfil_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </label>
                            </td>
                        </tr>
                                            ...
                                            <td>
                                                <cc11:PagingGridView AutoGenerateColumns="False" ID="GridEmail" runat="server" Width="100%"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Approve Email" HeaderStyle-HorizontalAlign="Left"
                                                            HeaderStyle-Width="5%">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="ImageButton49" runat="server" ToolTip="Approve Email" ImageUrl="~/Account/images/viewprofile.jpg"
