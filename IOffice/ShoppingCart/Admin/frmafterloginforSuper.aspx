<%@ Page Title="" Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="frmafterloginforSuper.aspx.cs" Inherits="Add_Employee_Payroll_Master" %>
            ...
            <table id="subinnertbl" width="100%">
                ...
                <tr>
                    <td style="border: 1px solid #000000; width: 50%">
                        <asp:Panel ID="Panel1" runat="server" Height="350" Width="100%">
                            ...
                            <tr>
                                <td style="text-align: right; width: 50%">
                                    &nbsp;<asp:LinkButton ID="taskmore" Text="More.." runat="server" OnClick="taskmore_Click"
                                        CssClass="btnSubmit"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
                    <td style="border: 1px solid #000000; width: 50%; text-align: right;">
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #000000; width: 50%">
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 100%">
                                    <asp:Panel ID="Panel5" runat="server" Height="300px" Width="100%">
                                        <table style="width: 100%">
                                            <tr>
                                                <td>
                ...
                <tr>
                    <td style="border: 1px solid #000000; width: 50%">
                        <table style="width: 100%">
                            <tr>
                                <td style="text-align: right; width: 50%;">
                                    <asp:LinkButton ID="LinkButton1" Text="Add Leave Request.." runat="server" OnClick="LinkButton1_Click"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
                    <td style="border: 1px solid #000000; width: 50%; text-align: right;">
                        <asp:LinkButton ID="LinkButton2" Text="More.." runat="server" OnClick="LinkButton2_Click"></asp:LinkButton>
                    </td>
                </tr>
            </table>
        </div>
