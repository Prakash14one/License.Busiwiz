<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="PurchaseInvoice.aspx.cs" Inherits="ShoppingCart_Admin_PurchaseInvoice"
    Title="Untitled Page" %>
                                                                ...
                                                                <td width="75%">
                                                                    <label>
                                                                        <asp:DropDownList ID="ddlCategory" runat="server" Width="450px">
                                                                         ...
                                                                         <label>
                                                                            <asp:ImageButton ID="imgcat" runat="server" Height="20px" ImageUrl="~/ShoppingCart/images/AddNewRecord.jpg"
                                                                                ToolTip="AddNew" Width="20px" ImageAlign="Bottom" 
                                                                        onclick="imgcat_Click" />
                                                                        </label>
                                                                        <label>
                                                                            <asp:ImageButton ID="imgcatref" runat="server" AlternateText="Refresh" Height="20px"
                                                                                ImageUrl="~/ShoppingCart/images/DataRefresh.jpg" ToolTip="Refresh" Width="20px"
                                                                                ImageAlign="Bottom" onclick="imgcatref_Click"  />
                                                                        </label>
                                                                         <label>
                                                                ...
                                                                <td width="75%">
                                                                    <label>
                                                                        <asp:DropDownList ID="ddlItemname" runat="server" Width="346px">
                                                                          ...
                                                                          <label>
                                                                            <asp:ImageButton ID="imgitemadd" runat="server" Height="20px" ImageUrl="~/ShoppingCart/images/AddNewRecord.jpg"
                                                                              onclick="imgcat_Click"   ToolTip="AddNew" Width="20px" ImageAlign="Bottom" />
                                                                        </label>
                                                                        <label>
                                                                            <asp:ImageButton ID="imgitemref" runat="server" AlternateText="Refresh" Height="20px"
                                                                                ImageUrl="~/ShoppingCart/images/DataRefresh.jpg" ToolTip="Refresh" Width="20px"
                                                                                ImageAlign="Bottom" onclick="imgitemref_Click"  />
                                                                        </label>
                                                                           <label>
                                                                    ...
                                                                    <label>
                                                                        <asp:TextBox ID="txtBar" runat="server" onKeydown="return mask(event)" onkeyup="return check(this,/[\\/!@#$%^'.&*()>+:;={}[]|\/]/g,/^[\a-zA-Z0-9_ \s]+$/,'Span12',20)"
                                                                            ...
                                                                            <label><asp:Label ID="Label13" runat="server"
                                                                                Text="Max" CssClass="labelcount"></asp:Label>
                                                                                <span id="Span12" class="labelcount">20</span>
                                                                ...
                                                                <td width="75%">
                                                                    <label>
                                                                        <asp:DropDownList ID="ddlProductNo" runat="server" Width="348px">
                                                                           ...
                                                                           <label>
                                                                            <asp:ImageButton ID="tmgprodno" runat="server" Height="20px" ImageUrl="~/ShoppingCart/images/AddNewRecord.jpg"
                                                                                onclick="imgcat_Click" ToolTip="AddNew" Width="20px" ImageAlign="Bottom" />
                                                                        </label>
                                                                        <label>
                                                                            <asp:ImageButton ID="imgprodref" runat="server" AlternateText="Refresh" Height="20px"
                                                                                ImageUrl="~/ShoppingCart/images/DataRefresh.jpg" ToolTip="Refresh" Width="20px"
                                                                                ImageAlign="Bottom" onclick="imgprodref_Click"  />
                                                                        </label>
                                                                      <label>
                                                    ...
                                                    <asp:Panel ID="Panel2" Visible="false" runat="server">
                                                        <table align="left">
                                                            ...
                                                            Display="Dynamic" ErrorMessage="*" ValidationGroup="1"></asp:RequiredFieldValidator>--%>
                                                                ...
                                                                <td valign="bottom">
                                                                    <label>
                                                                        <asp:Label ID="Label32" runat="server" Text="Expiry Date"></asp:Label><asp:RequiredFieldValidator
                                                        ...
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Category Name" HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("Category") %>'></asp:Label></ItemTemplate>
