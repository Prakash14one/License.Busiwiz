<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ShoppingCart/Admin/Master/mp_Admin.master"
    CodeFile="add_floor.aspx.cs" Inherits="add_floor" Title="Add Floor" %>
    ...
    <div class="products_box">
        ...
        <fieldset>
            ...
            <div style="float: right;">
                <asp:Button ID="btnadddd" runat="server" Text="Add New Floor" Width="180px" CssClass="btnSubmit"
...
></asp:RangeValidator>
                        ...
                        <td style="width: 25%">
                            <label>
                                ...
                                <asp:RegularExpressionValidator ID="REG1" runat="server" ErrorMessage="Invalid Character"
                                    SetFocusOnError="True" ValidationExpression="^([a-zA-Z0-9\s]*)" ControlToValidate="txtfloor"
                                    ValidationGroup="save"></asp:RegularExpressionValidator>
                            </label>
                        </td>
                        <td valign="middle">
                            <label>
                                <asp:TextBox ID="txtfloor" runat="server" MaxLength="25" onKeydown="return mask(event)"
                        ...
                        <tr>
                            <td width="25%">
                                <label style="width: 350px;">
                                    Take me to add room after adding this floor</label>
                            </td>
                            <td>
                                <asp:CheckBox ID="chkNavigation" runat="server" Text="" ForeColor="#006699" OnCheckedChanged="chkNavigation_CheckedChanged" />
                            </td>
                        </tr>
                    <tr>
                        <td style="width: 25%">
        ...
        <fieldset>
            <legend>
                <asp:Label ID="Label4" runat="server" Text="List of Floors"></asp:Label>
            </legend>
                                                ...
                                                <table width="850Px">
                                                    <tr align="center">
                                                        <td align="center" style="text-align: center; font-size: 18px; font-weight: bold;">
                                                            <asp:Label ID="Label24" runat="server" Font-Italic="True" Text="List of Floors"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <%--  <tr>
