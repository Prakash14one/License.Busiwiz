...
<table width="100%" id="subinnertbl">
        <tr>
            ...
            <td   colspan="1" bgcolor="#CCCCCC" style="width:55%; font-family: Calibri; font-weight: bold; font-size: 14px; color: #000000;">
               
                 <asp:Label ID="lbltitle" runat="server"   ></asp:Label>
                </td>
                <td align="left" bgcolor="#CCCCCC" style="width:45%;font-family: Calibri; font-weight: bold; font-size: 14px; color: #000000;">
                <asp:Panel ID="pnlshow" runat="server" Visible="true"  >
                
               <asp:Label ID="lblcay"   runat="server" Text="Current Accounting year" >
                               
                                </asp:Label><br />
                                 <asp:Label ID="lblb"   runat="server" Text="Business " >
                             ...
                             <asp:Label ID="lblacdate" runat="server" Text="year ending on "></asp:Label>   
                               <asp:Label ID="lblopenaccy"   runat="server" >
                               
                                </asp:Label>
                         
                                &nbsp; <asp:HyperLink id="lblop" runat="server" Target="_blank" Text="Change"></asp:HyperLink>
