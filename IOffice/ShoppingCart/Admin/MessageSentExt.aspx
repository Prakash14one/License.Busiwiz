<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="MessageSentExt.aspx.cs" Inherits="Account_MessageSentExt"
    Title="Untitled Page" %>
...
function ChangeCheckBoxState(id, checkState)
    ...
    <div class="products_box">
        ...
        <table width="100%">
            <tr>
                <td style="width: 150px">
                    <label>
                        <asp:Label ID="Label1" runat="server" Text="Sent" Font-Size="Large" Font-Bold="False"></asp:Label>
                    </label>
                </td>
                <td>
                    <table width="100%">
                        <tr>
                            <td valign="bottom" style="width: 8%">
                                <asp:Button ID="imgbtndiscard" runat="server" Text="Discard" CssClass="btnSubmit"
                            ...
                            <td colspan="2" align="center">
                                <asp:Panel ID="pnlgrid" runat="server">
                                    <table width="100%">
                                                    ...
                                                    <table width="100%">
                                                        <tr align="center">
                                                            <td align="center" style="text-align: center; font-size: 18px; font-weight: bold;">
                                                                <asp:Label ID="Label28" runat="server" Font-Italic="True" Text="List of External Message Sent"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                        ...
                                        <tr>
                                            <td align="left">
                                                <cc11:PagingGridView ID="grdSentMailList" runat="server" CssClass="mGrid" PagerStyle-CssClass="pgr"
                                                    AlternatingRowStyle-CssClass="alt" DataKeyNames="MsgId" GridLines="Both" AutoGenerateColumns="False"
                                                    OnRowDataBound="grdSentMailList_RowDataBound" AllowPaging="True" OnPageIndexChanging="grdSentMailList_PageIndexChanging"
                                                    OnRowCommand="grdSentMailList_RowCommand" EmptyDataText="There is no Message."
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%--<asp:BoundField DataField="MsgDate" HeaderText="Date" SortExpression="MsgDate" DataFormatString="{0:MM/dd/yyyy-HH:mm}">
                                                        ...
                                                        <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign="Left" SortExpression="Date"
                                                            ...
                                                            <ItemTemplate>
                                                                <a href='MessageViewSentExt.aspx?MsgId=<%# Eval("MsgId")%>' style="color: Black">
                                                                    <%#  Eval("MsgDate","{0:MM/dd/yyyy-HH:mm}")%>
                                                                </a>
                                                                <%-- <a href="MessageViewSent.aspx?MsgDetailId=<%# Eval("MsgDetailId")%>">
                                                    <b><font color="black">
        ...
        <asp:Panel ID="panelfilter" runat="server" BorderStyle="Outset" Height="240px" Width="1100px"
