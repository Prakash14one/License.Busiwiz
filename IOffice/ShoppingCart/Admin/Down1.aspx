<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master" 
    AutoEventWireup="true" CodeFile="Down1.aspx.cs" Inherits="Down" Title="Untitled Page" %>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal"
                                                ...
                                                <asp:ListItem Selected="True">FTP</asp:ListItem>
                                                    ...
                                                    <td>
                                                        <asp:Panel ID="pnldesignation" runat="server">
                                                            <asp:GridView ID="grdDesignation" runat="server" DataKeyNames="FolderId" AllowPaging="True"
                                                                ...
                                                                AllowSorting="True" ShowFooter="True" AutoGenerateColumns="False" EmptyDataText="No Folder Path available in Auto Document Download"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Document Auto Process"
                                                                        SortExpression="DocumentAutoApprove">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="ablautoupp" runat="server" Text='<%# Eval("DocumentAutoApprove")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <%-- <asp:TemplateField HeaderText="Default Title">
                            <ItemTemplate>
                                <asp:Label ID="lblDocTitleName" runat="server" Text='<%# Eval("DocumentTittle")%>'></asp:Label>
                            </ItemTemplate>                           
                        </asp:TemplateField>--%>
                                ...
                                <asp:Label ID="lblDocumentDescription" runat="server" Text='<%# Eval("DocumentDescription")%>'></asp:Label>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                            ...
                                                            <asp:Label ID="lbbvs" runat="server" Text="(Note : Max 25 records will be retrieved at  a time)"></asp:Label>
