...
public partial class AnnouncementType : System.Web.UI.Page
{
    SqlConnection con;
    ...
    private void fn_SaveGrade()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("sp_AnnouncementType", con);
            cmd.CommandType = CommandType.StoredProcedure;


            cmd.Parameters.Add("@AnnouncementType", SqlDbType.VarChar).Value = txttype.Text;
    ...
    private void fn_update()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("sp_AnnouncementTypeupdate", con);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    protected void btnadddd_Click(object sender, EventArgs e)
    {
        ...
        lbllegend.Text = "Add New Announcement Type";
        lblmsg.Text = "";
    }
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select ID from tblAnnouncementType  where AnnouncementType = '" + txttype.Text + "' and  BusinessID='" + ddlschool.SelectedValue + "'", con);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                //window.open("yoururl.aspx?empid=" + empid + "&date=" + dateofjoining);

                string te = "add_announcement.aspx?announceid=" + dt.Rows[0]["ID"] + "&sid=" + ddlschool.SelectedValue;
    ...
    protected void GVC_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Edit")
        {
            ...
            pnladdd.Visible = true;
            btnadddd.Visible = false;
            lbllegend.Text = "Edit Announcement Type";
            lblmsg.Text = "";
            ...
            SqlDataAdapter da = new SqlDataAdapter("select * from tblAnnouncementType where ID='" + mm + "'", con);
            DataTable dt = new DataTable();
            da.Fill(dt);

            txttype.Text = dt.Rows[0]["AnnouncementType"].ToString();
        ...
        if (e.CommandName == "Delete")
        {
            ...
            //else
            //{
            string str1 = "Delete  From tblAnnouncementType Where ID= " + mm1 + " ";
