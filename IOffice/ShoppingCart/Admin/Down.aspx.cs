                                                ...
                                                if (System.IO.File.GetAttributes(Location2 + f2.Name).ToString() != System.IO.FileAttributes.Hidden.ToString())
                                                {
                                                    ...
                                                    if (foldername != "")
                                                    {
                                                        ...
                                                        if (DocId > 0)
                                                        {
                                                            ...
                                                            {
                                                                System.IO.File.Copy(Location2 + f2.Name, Location + filename1);
                                                            }
                                                            System.IO.File.SetAttributes(Location2 + filename3, System.IO.FileAttributes.Hidden);
                                                            if (Convert.ToString(extension1) == ".pdf")
                                                            {
                                                                ...
                                                                foreach (System.IO.FileInfo f in dir.GetFiles(filename1))
                                                                {
                                                                    ...
                                                                    {
                                                                        System.IO.File.Copy(Location2 + f.Name, Location + filename1);
                                                                    }
                                                                    System.IO.File.SetAttributes(Location2 + filename3, System.IO.FileAttributes.Hidden);
