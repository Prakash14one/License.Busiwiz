...
public partial class Add_AttendenceRule_Master : System.Web.UI.Page
{
    ...
    protected void edit()
    {
        ...
        DataTable ds11 = ClsStore.SelectStorename();
        if (ds11.Rows.Count > 0)
        {
            ddlwarehouse.DataSource = ds11;
            ddlwarehouse.DataTextField = "Name";
            ddlwarehouse.DataValueField = "WareHouseId";
            ddlwarehouse.DataBind();
        }
  ...
  " ,Overtimepara='0',overtimeruleno='" + opid + "',Generalapprovalrule='" + chkgenralrule.Checked + "',Considerinoutrangeintance='" + granceperi + "',rulegreatertime='" + chkgreatertime.Checked + "',rulegreatertimeinstance='" + txtouttimegreater.Text + "',Maxuserhours='" + txtallowusereg.Text + "',overtomeapproval='" + chkappsuper.Checked + "',howdoovertime='" + chkoverhowdo.Checked + "',nooverflunc='" + checkbox.Checked + "'";
    ...
    protected void ddlwarehouse_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string str = "Select distinct EmployeeMasterID,EmployeeName from   dbo.EmployeeMaster INNER JOIN dbo.DesignationMaster ON dbo.DesignationMaster.DesignationMasterId = dbo.EmployeeMaster.DesignationMasterId INNER JOIN dbo.WareHouseMaster ON dbo.EmployeeMaster.Whid = dbo.WareHouseMaster.WareHouseId where  EmployeeMaster.Active=1 AND dbo.WareHouseMaster.Status=1 order by EmployeeName";//and DesignationMaster.DesignationName in ('Office Manager','Administrative Assistant','CEO','Admin')  Whid='" + ddlwarehouse.SelectedValue + "' AND
