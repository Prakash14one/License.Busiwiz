                        ...
                        <div>
                            <h2>
                                ...
                                <asp:Image ID="Image2" runat="server" ImageUrl="~/ShoppingCart/images/HelpIconHHH.png"
                                 ...
                                 <asp:Image ID="Image1" runat="server" ImageUrl="~/ShoppingCart/images/HelpIconHHH.png"  Height="30px"
                             style="position: absolute; margin: 0px 0px 0px -30px;"  Visible="false"     />
                              
                                  <asp:LinkButton ID="btn_readMore" runat="server" OnCommand="clickHelp" OnClientClick="aspnetForm.target ='_blank';"> 
                                      <asp:Image ID="Image3" runat="server" ImageUrl="~/ShoppingCart/images/HelpIcon.png" Height="30px"
                                   style="position: absolute; margin: 0px 0px 0px 100px;"  Visible="true" />
                                ...
                                <ContentTemplate>
                                    <asp:Panel ID="pnlshow" runat="server" Visible ="false">
                                        <table width="100%" cellpadding="1" cellspacing="1">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblcay" runat="server" Text="Business" ForeColor="White" Visible="false"></asp:Label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:HyperLink ID="lblop" runat="server" ForeColor="White" Target="_blank" Text="Year"  Visible="false"></asp:HyperLink>
                                                </td>
                                                <td>
                                                    <%--<asp:Label ID="lblopenaccy" runat="server" Font-Bold="True" ForeColor="White" ></asp:Label>--%>
                                                    <asp:LinkButton ID="lblopenaccy" runat="server" ForeColor="White"  Visible="false"
                                                        onclick="lblopenaccy_Click"></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
