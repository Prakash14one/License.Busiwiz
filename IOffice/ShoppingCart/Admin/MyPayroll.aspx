...
CodeFile="MyPayroll.aspx.cs" Inherits="MyPayroll" Title="Untitled Page" %>
    ...
    <asp:UpdatePanel ID="UpdatePanelUserMng" runat="server">
        <ContentTemplate>
            <div class="products_box">
                ...
                <fieldset>
                    <legend>
                        <asp:Label ID="lblheadmessage" runat="server" Text="List of My Payroll setup Page"></asp:Label>
                    </legend>
                    <tr>
                        <td>
                           
                          
                                <asp:DropDownList ID="ddlstproductname" runat="server" AutoPostBack="true" onselectedindexchanged="ddlstproductname_SelectedIndexChanged"   Visible="false"
                                >
                                </asp:DropDownList>
                                ...
                                <td>
                                    <div id="mydiv" class="closed">
                                        <table width="850Px">
                                             ...
                                             <tr align="center">
                                                <td align="center" style="text-align: center; font-size: 20px; font-weight: bold;">
                                                    <asp:Label ID="Label1" runat="server" ForeColor="Black" Font-Italic="true"></asp:Label>
                                                    <asp:Label ID="Label2" runat="server" Font-Italic="true" Font-Size="20px" Text=" Employee Name : "></asp:Label>
                                                    <asp:Label ID="lblempn" runat="server" Font-Italic="true" Font-Size="20px"></asp:Label>
