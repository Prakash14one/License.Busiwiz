...
using System.Net;
using System.Text;
public partial class Add_Employee_Attendancefrm : System.Web.UI.Page
{
    string timezone = "";
    string plusminus = "";
    // string hour = "";
    ...
    SqlConnection cnn;
        //=new SqlConnection(PageConn.connnn);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        GridEmpInTime.Columns[0].Visible = false;
       ...
       // lblwrongdate.Visible = false;
        ...
        //   time22.Text = DateTime.Now.ToString("hh:mm ss tt");
    ...
    protected void timecalculate()
    {
        ...
        // string str = "select TimeZoneMaster.gmt from  [BatchMaster] inner join [TimeZoneMaster] on TimeZoneMaster.Id=BatchMaster.BatchTimeZone where BatchMaster.CompanyId='" + Session["Company_id"] + "' and  BatchMaster.ID='" + ddlbatchmaster.SelectedValue + "'";
        string str = "select TimeZoneMaster.gmt from  [BatchMaster] inner join WHTimeZone on WHTimeZone.ID=BatchMaster.BatchTimeZone inner join [TimeZoneMaster] on TimeZoneMaster.Id=WHTimeZone.TimeZone Where BatchMaster.Whid='" + ddlwarehouse.SelectedValue + "' and  BatchMaster.ID='" + ddlbatchmaster.SelectedValue + "'";
    ...
    {
        string str = "select ID,Name from BatchMaster where BatchMaster.Whid='" + ddlwarehouse.SelectedValue + "' order by Name ";
        SqlCommand cmd = new SqlCommand(str, cnn);
        SqlDataAdapter adp = new SqlDataAdapter(cmd);
    ...
    private void FillGridInTimeEmp()
    {


        GridEmpInTime.Columns[0].Visible = true;


        string str = "select distinct EmployeeMaster.EmployeeMasterID,EmployeeMaster.EmployeeName,EmployeeMaster.DeptID  from EmployeeMaster inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID where Batchmasterid ='" + ddlbatchmaster.SelectedValue + "' and EmployeeMaster.DeptID=" + drpdepartment1.SelectedValue + " and NOT EXISTS  (select AttendenceEntryMaster.EmployeeID,AttendenceEntryMaster.Date,AttendenceEntryMaster.OutTime,AttendenceEntryMaster.InTime from AttendenceEntryMaster WHERE  EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID and AttendenceEntryMaster.InTimeforcalculation!=''  and AttendenceEntryMaster.OutTimeforcalculation='00:00' and (AttendenceEntryMaster.Date='" + Label1date.Text + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(1).ToShortDateString() + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(-1).ToShortDateString() + "')) order by EmployeeName ";
        SqlDataAdapter adp = new SqlDataAdapter(str, cnn);

        DataSet ds = new DataSet();
        adp.Fill(ds);

        GridEmpInTime.DataSource = ds;
        GridEmpInTime.DataBind();
        GridEmpInTime.Columns[0].Visible = false;
    ...
    private void fillGridOut2()
    {
        string str = "";
        GridView1.Columns[0].Visible = true;
        GridView1.Columns[1].Visible = true;
        GridView1.Columns[2].Visible = true;
        string strde = " Select * from AttandanceRule where StoreId='" + ddlwarehouse.SelectedValue + "'";
        ...
        if (dtde.Rows.Count > 0)
        {
            if (Convert.ToBoolean(dtde.Rows[0]["rulegreatertime"]) == true)
            {
                ...
                string strs = "SELECT BatchTiming.Totalhours,BatchTiming.StartTime,BatchTiming.EndTime FROM BatchTiming where BatchMasterId='" + ddlbatchmaster.SelectedValue + "'";
                SqlDataAdapter adpa = new SqlDataAdapter(strs, cnn);
                DataTable dt = new DataTable();
                adpa.Fill(dt);
                if (dt.Rows.Count > 0)
                {
                    string sc = "";
                    if (drpdepartment2.SelectedIndex == 0)
                    {
                    ...
                    {
                        sc = "  EmployeeMaster.DeptID=" + drpdepartment2.SelectedValue + " and";
                    ...
                    if (ori == "1")
                    {
                        str = "SELECT distinct EmployeeMaster.EmployeeMasterID,EmployeeMaster.DeptID, EmployeeMaster.EmployeeName, AttendenceEntryMaster.AttendanceId,AttendenceEntryMaster.Date, AttendenceEntryMaster.EmployeeID,AttendenceEntryMaster.OutTimeforcalculation,AttendenceEntryMaster.InTimeforcalculation " +
                                "FROM EmployeeMaster  inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID   inner join AttendenceEntryMaster on EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID  Where  " + sc + "   (AttendenceEntryMaster.OutTimeforcalculation='00:00') and (AttendenceEntryMaster.Date='" + serdate + "') and Batchmasterid='" + ddlbatchmaster.SelectedValue + "'  order by EmployeeMaster.EmployeeName asc";
                    ...
                    {
                        str = "SELECT distinct EmployeeMaster.EmployeeMasterID,EmployeeMaster.DeptID, EmployeeMaster.EmployeeName, AttendenceEntryMaster.AttendanceId,AttendenceEntryMaster.Date, AttendenceEntryMaster.EmployeeID,AttendenceEntryMaster.OutTimeforcalculation,AttendenceEntryMaster.InTimeforcalculation " +
                                "FROM EmployeeMaster  inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID   inner join AttendenceEntryMaster on EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID  Where  " + sc + "  (Outtime<='" + tt.ToString().Remove(5, 3) + "') and  (AttendenceEntryMaster.OutTimeforcalculation='00:00') and (AttendenceEntryMaster.Date='" + serdate + "') and Batchmasterid='" + ddlbatchmaster.SelectedValue + "'  order by EmployeeMaster.EmployeeName asc";
        ...
        else
        {
            ...
            if (drpdepartment2.SelectedIndex > 0)
            {
                ...
                str = "SELECT distinct EmployeeMaster.EmployeeMasterID,EmployeeMaster.DeptID, EmployeeMaster.EmployeeName, AttendenceEntryMaster.AttendanceId,AttendenceEntryMaster.Date, AttendenceEntryMaster.EmployeeID,AttendenceEntryMaster.OutTimeforcalculation,AttendenceEntryMaster.InTimeforcalculation " +
                             "FROM EmployeeMaster  inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID   inner join AttendenceEntryMaster on EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID  Where  EmployeeMaster.DeptID=" + drpdepartment2.SelectedValue + " and  (AttendenceEntryMaster.OutTimeforcalculation='00:00') and (AttendenceEntryMaster.Date='" + Label1date.Text + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(1).ToShortDateString() + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(-1).ToShortDateString() + "') and Batchmasterid='" + ddlbatchmaster.SelectedValue + "'  order by EmployeeMaster.EmployeeName asc";
            }
            else
            {
                str = "SELECT distinct EmployeeMaster.EmployeeMasterID,EmployeeMaster.DeptID, EmployeeMaster.EmployeeName, AttendenceEntryMaster.AttendanceId,AttendenceEntryMaster.Date, AttendenceEntryMaster.EmployeeID,AttendenceEntryMaster.OutTimeforcalculation,AttendenceEntryMaster.InTimeforcalculation " +
                             "FROM  EmployeeMaster  inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID   inner join AttendenceEntryMaster on EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID  Where (AttendenceEntryMaster.OutTimeforcalculation='00:00') and (AttendenceEntryMaster.Date='" + Label1date.Text + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(1).ToShortDateString() + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(-1).ToShortDateString() + "') and Batchmasterid='" + ddlbatchmaster.SelectedValue + "'  order by EmployeeMaster.EmployeeName asc";
            }
        }
        if (Label1date.Text != "")
        {
            ...
            if (str != "")
            {
                ...
                if (ds.Tables[0].Rows.Count != 0)
                {
                    ...
                    {
                        string str3 = ds.Tables[0].Rows[i]["OutTimeforcalculation"].ToString();
                        string str4 = ds.Tables[0].Rows[i]["AttendanceId"].ToString();
                        string str5 = ds.Tables[0].Rows[i]["InTimeforcalculation"].ToString();
                        if (str3 == "00:00" && str5 != "")
                        {



                            string str2 = "SELECT distinct EmployeeNo, EmployeeMaster.EmployeeMasterID,EmployeeMaster.DeptID, EmployeeMaster.EmployeeName, AttendenceEntryMaster.AttendanceId,AttendenceEntryMaster.Date, AttendenceEntryMaster.EmployeeID,AttendenceEntryMaster.OutTime " +
                                            "FROM  EmployeeMaster INNER JOIN AttendenceEntryMaster ON AttendenceEntryMaster.EmployeeID=EmployeeMaster.EmployeeMasterID inner join EmployeePayrollMaster ON EmployeePayrollMaster.EmpId=EmployeeMaster.EmployeeMasterID where   AttendenceEntryMaster.AttendanceId='" + str4 + "'  order by EmployeeMaster.EmployeeName asc";
    ...
    protected void drpEmployeeCategory_SelectedIndexChanged(object sender, EventArgs e)
    {
        FillGridInTimeEmp();
    }

    protected void GridEmpInTime_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        GridEmpInTime.PageIndex = e.NewPageIndex;
        FillGridInTimeEmp();
    }


    protected void GridEmpInTime_PageIndexChanging1(object sender, GridViewPageEventArgs e)
    {
        GridEmpInTime.PageIndex = e.NewPageIndex;
        FillGridInTimeEmp();
    }
                ...
                if (dsipa.Rows.Count < 3)
                {
                    ...
                    if (ds.Rows.Count > 0)
                    {
                        ViewState["Whid"] = ds.Rows[0]["Whid"].ToString();
                          Session["comid"] = ds.Rows[0]["Compid"].ToString();
                        ...
                        if (chkAttAvailable.Rows.Count > 0)
                        {
                            ...
                            if (flattt == 0)
                            {
                                ...
                                ipaddress = Request.ServerVariables["REMOTE_ADDR"].ToString();
                                string str3 = "insert into AttandanceLog(IpAddress,Barcode,Comid,Successfull,Datetime,Empid)values('" + ipaddress + "','" + txtbartext.Text + "','" +   Session["comid"] + "','1','" + DateTime.Now.ToString() + "','" + ViewState["EmployeeID"] + "')";
                            ...
                            else
                            {
                                ...
                                if (flattt == 4)
                                {
                                    ...
                                    lblmsg.Text = "You are not able to check in / check out at this time.Your last entry time was at  <" + ViewState["lastminit"] + ">, you are blocked from making another entry for <" + ViewState["restmini"] + "> minutes.";
                                }
                                else
                                {
                    ...
                    else
                    {
                        ...
                        string str3 = "insert into AttandanceLog(IpAddress,Barcode,Comid,Successfull,Datetime)values('" + ipaddress + "','" + txtbartext.Text + "','" +   Session["comid"] + "','0','" + DateTime.Now.ToString() + "')";
                        cnn.Open();
                        SqlCommand cmd1 = new SqlCommand(str3, cnn);
                        //dr.Close();
                        cmd1.ExecuteNonQuery();
                        string str31 = "insert into AttandanceTempBanIpTable(IpAddress,Compid,Datetime)values('" + ipaddress + "','" +   Session["comid"] + "','" + DateTime.Now.ToString() + "')";
                        //dr.Close();
    ...
    protected void btnsignin_Click(object sender, EventArgs e)
    {
        ...
        //            // lbldt.Text = DateTime.Now.ToShortTimeString();
        //            // lbltime.Text = Convert.ToString(DateTime.Today.ToShortDateString());


        //            if (txtusername.Text == dt.Rows[0]["UserName"].ToString() && txtpassword.Text == ClsEncDesc.Decrypted(dt.Rows[0]["Password"].ToString()))
        //            {
        //                TimeSpan t1 = TimeSpan.Parse(dt.Rows[0]["StartTime"].ToString());
        //                TimeSpan t2 = TimeSpan.Parse(time22.Text);
        //                string strr = "SELECT Top(1)  OutTimeforcalculation FROM AttendenceEntryMaster where EmployeeID='" + Session["EmployeeID1"] + "' order by AttendanceId Desc ";
        //                SqlDataAdapter adpll = new SqlDataAdapter(strr, cnn);
        //                DataTable dsll = new DataTable();
        //                adpll.Fill(dsll);
        //                if (dsll.Rows.Count > 0)
        ...
        //                        if (siniourcount == 2)
        //                        {
        //                            Label10.Text = "Sorry,Your attendence not approved,contact supervisor/admin and approved that.";
        ...
        //else
        //{
        //    lblbarmsg.Text = "Sorry,you have not allowed IP :" + ipaddress;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Entry")
        {
            ...
            Session["AttendanceId"] = GridView1.SelectedDataKey.Value;
            Label  lblemp=(Label) GridView1.Rows[GridView1.SelectedIndex].FindControl("lblemp");
            Session["EmployeeID1"] = lblemp.Text;
            panel2.Visible = false;
    ...
    private DataSet fillDept()
    {
        string str = "select id,Departmentname from DepartmentmasterMNC where Whid='" + ddlwarehouse.SelectedValue + "'";

        SqlDataAdapter adp = new SqlDataAdapter(str, cnn);
        DataSet ds = new DataSet();

        adp.Fill(ds);
        drpdepartment1.DataSource = ds;


        drpdepartment1.DataValueField = "id";
        drpdepartment1.DataTextField = "Departmentname";


        drpdepartment1.DataBind();
        drpdepartment1.Items.Insert(0, "All");
    ...
    private DataSet FillDept2()
    {

        string str = "select id,Departmentname from DepartmentmasterMNC where Whid='" + ddlwarehouse.SelectedValue + "'";


        SqlDataAdapter adp1 = new SqlDataAdapter(str, cnn);
        DataSet ds1 = new DataSet();
        adp1.Fill(ds1);
        drpdepartment2.DataSource = ds1;

        drpdepartment2.DataValueField = "id";
        drpdepartment2.DataTextField = "Departmentname";

        drpdepartment2.DataBind();
        drpdepartment2.Items.Insert(0, "All");
        return ds1;
    ...
    private void Company()
    {
        ...
        string str1 = "select CompanyName from CompanyMaster where [Compid]='" + Session["comid"] + "'";
    ...
    private void FillGridIn2()
    {
        ...
        if (dtde.Rows.Count > 0)
        {
            if (Convert.ToBoolean(dtde.Rows[0]["rulegreatertime"]) == true)
            {
                ...
                string str = "SELECT BatchTiming.Totalhours,BatchTiming.StartTime,BatchTiming.EndTime FROM BatchTiming where BatchMasterId='" + ddlbatchmaster.SelectedValue + "'";
                SqlDataAdapter adpa = new SqlDataAdapter(str, cnn);
                DataTable dt = new DataTable();
                adpa.Fill(dt);
                if (dt.Rows.Count > 0)
                {
                    string sc = "";
                    if (drpdepartment1.SelectedIndex == 0)
                    {
                    ...
                    {
                        sc = " and EmployeeMaster.DeptID=" + drpdepartment1.SelectedValue;
                    ...
                    if (ori == "1")
                    {
                        str1 = "select  Distinct EmployeeNo,  EmployeeMaster.EmployeeMasterID,EmployeeMaster.EmployeeName  from EmployeeMaster inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID inner join EmployeePayrollMaster ON EmployeePayrollMaster.EmpId=EmployeeMaster.EmployeeMasterID where Batchmasterid='" + ddlbatchmaster.SelectedValue + "' " + sc + " and  NOT EXISTS  (select AttendenceEntryMaster.EmployeeID,AttendenceEntryMaster.Date,AttendenceEntryMaster.OutTime,AttendenceEntryMaster.InTime from AttendenceEntryMaster WHERE  EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID and AttendenceEntryMaster.InTimeforcalculation!=''  and AttendenceEntryMaster.OutTimeforcalculation='00:00' and (AttendenceEntryMaster.Date='" + serdate + "')) order by EmployeeName ";

                    }
                    else
                    {
                        str1 = "select Distinct EmployeeNo, EmployeeMaster.EmployeeMasterID,EmployeeMaster.EmployeeName  from EmployeeMaster inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID inner join EmployeePayrollMaster ON EmployeePayrollMaster.EmpId=EmployeeMaster.EmployeeMasterID  where Batchmasterid='" + ddlbatchmaster.SelectedValue + "'" + sc + " and  NOT EXISTS  (select AttendenceEntryMaster.EmployeeID,AttendenceEntryMaster.Date,AttendenceEntryMaster.OutTime,AttendenceEntryMaster.InTime from AttendenceEntryMaster WHERE  EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID and AttendenceEntryMaster.InTimeforcalculation!=''  and AttendenceEntryMaster.OutTimeforcalculation='00:00' and Outtime<='" + tt.ToString().Remove(5, 3) + "' and (AttendenceEntryMaster.Date='" + serdate + "' )) order by EmployeeName ";
        ...
        else
        {
            if (drpdepartment1.SelectedIndex == 0)
            {
                str1 = "select Distinct EmployeeNo, EmployeeMaster.EmployeeMasterID,EmployeeMaster.EmployeeName  from EmployeeMaster inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID inner join EmployeePayrollMaster ON EmployeePayrollMaster.EmpId=EmployeeMaster.EmployeeMasterID where Batchmasterid='" + ddlbatchmaster.SelectedValue + "' and NOT EXISTS  (select AttendenceEntryMaster.EmployeeID,AttendenceEntryMaster.Date,AttendenceEntryMaster.OutTime,AttendenceEntryMaster.InTime from AttendenceEntryMaster WHERE  EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID and AttendenceEntryMaster.InTimeforcalculation!=''  and AttendenceEntryMaster.OutTimeforcalculation='00:00' and (AttendenceEntryMaster.Date='" + Label1date.Text + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(1).ToShortDateString() + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(-1).ToShortDateString() + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(1).ToShortDateString() + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(-1).ToShortDateString() + "')) order by EmployeeName ";
            }
            else
            {
                str1 = "select distinct EmployeeNo, EmployeeMaster.EmployeeMasterID,EmployeeMaster.EmployeeName,EmployeeMaster.DeptID  from EmployeeMaster inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID inner join EmployeePayrollMaster ON EmployeePayrollMaster.EmpId=EmployeeMaster.EmployeeMasterID where Batchmasterid ='" + ddlbatchmaster.SelectedValue + "' and EmployeeMaster.DeptID=" + drpdepartment1.SelectedValue + " and NOT EXISTS  (select AttendenceEntryMaster.EmployeeID,AttendenceEntryMaster.Date,AttendenceEntryMaster.OutTime,AttendenceEntryMaster.InTime from AttendenceEntryMaster WHERE  EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID and AttendenceEntryMaster.InTimeforcalculation!=''  and AttendenceEntryMaster.OutTimeforcalculation='00:00' and (AttendenceEntryMaster.Date='" + Label1date.Text + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(1).ToShortDateString() + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(-1).ToShortDateString() + "')) order by EmployeeName ";
            }
        }
        ...
        {
            GridEmpInTime.DataSource = null;
            GridEmpInTime.DataBind();
        }
    }
    protected void drpdepartment1_SelectedIndexChanged(object sender, EventArgs e)
    {
        //if (drpdepartment1.SelectedIndex == 0)
        //{
    ...
    protected void drpdepartment2_SelectedIndexChanged(object sender, EventArgs e)
    {
        fillGridOut2();
    }


    protected void GridEmpInTime_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Enter")
        {
            
            GridEmpInTime.SelectedIndex = Convert.ToInt32(e.CommandArgument);
            Session["EmployeeID1"] = GridEmpInTime.SelectedDataKey.Value.ToString();
            ViewState["EmployeeID"] = GridEmpInTime.SelectedDataKey.Value.ToString();
            panel1.Visible = false;

                //string mil = "select InTime from AttendenceEntryMaster where EmployeeID='" + ViewState["EmployeeID"] + "' and Date='" + Label1date.Text + "'";
                //SqlDataAdapter damil = new SqlDataAdapter(mil, cnn);
    ...
    protected void GridEmpInTime_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        lblmsg.Visible = true;
        lblmsg.Text = ViewState["EmployeeID"].ToString();
        string str = "select InTime,EmployeeID,OutTime,Date from AttendenceEntryMaster where EmployeeID=" + GridEmpInTime.SelectedDataKey.Value + " and Date='" + Label1date.Text + "' ";
        ...
        if (dr.HasRows)
        {
            while (dr.Read())
            {
                ...
                string str2 = dr["InTime"].ToString();
                string str3 = dr["EmployeeID"].ToString();
                string str4 = dr["OutTime"].ToString();
                Session["EmployeeId1"] = dr["EmployeeID"].ToString();
    ...
    {
        Fillddlbatch();
        if (ddlbatchmaster.SelectedIndex != -1)
        {
            ddlbatchmaster_SelectedIndexChanged(sender, e);
        }
         DataTable dtde=select( " Select * from AttandanceRule where StoreId='" + ddlwarehouse.SelectedValue + "'");

         if (dtde.Rows.Count > 0)
         {
             if (Convert.ToString(dtde.Rows[0]["withoutverification"]) == "True")
             {
                 pnlrul8.Visible = true;
                 pnlruldis8.Visible = false;
             }
             else
             {
                 pnlruldis8.Visible = true;
                 pnlrul8.Visible = false;
             }
         }
    }
    protected int restbar(string para)
    {
        int cip = 0;
        int uip = 0;
        int flag = 0;
        ...
        else
        {
            ...
            pass = ClsEncDesc.Encrypted(txtpassword.Text);
            vv = 1;
        }

        if (vv == 1)
        {
            DataTable dic = ClsIp.selectIPrestrictionallow(Convert.ToString(Session["Compid"]));
            if (dic.Rows.Count > 0)
            {
                DataTable dcf = ClsIp.selectIPrest(0, userId, pass, Convert.ToString(Session["Compid"]));
                if (dcf.Rows.Count > 0)
                {
                    cip = 1;
                    DataTable iprest = ClsIp.selectIPrestriction(ipaddress, 0, userId, pass, Convert.ToString(Session["Compid"]));
                    ...
                    {
                        DataTable iprestuser = ClsIp.selectIPrestriction(ipaddress, 1, userId, pass, Convert.ToString(Session["Compid"]));
                ...
                {
                    DataTable dcfe = ClsIp.selectIPrest(1, userId, pass, Convert.ToString(Session["Compid"]));
                ...
                if ((flag != 1 && cip == 1) || (flag != 1 && uip == 1))
                {
                    ...
                    DataTable iprestuseri = ClsIp.selectmultiIP(ip1, ipz1, ip2, ipz2, cip, uip, userId, pass, Convert.ToString(Session["Compid"]));
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        //            string str1 = "select Distinct EmployeeMaster.Whid, CompanyMaster.CompanyName,CompanyMaster.Compid,WareHouseMaster.Name, EmployeeBarcodeMaster.Employee_Id,EmployeeMaster.EmployeeName,BatchMaster.Name as Bid,BatchMaster.Id from BatchMaster inner join EmployeeBatchMaster on EmployeeBatchMaster.Batchmasterid=BatchMaster.ID inner join EmployeeMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID inner join EmployeeBarcodeMaster on EmployeeBarcodeMaster.Employee_Id= EmployeeMaster.EmployeeMasterID inner join WareHouseMaster on  WareHouseMaster.WarehouseId=EmployeeMaster.whid inner join CompanyMaster on CompanyMaster.compid=WareHouseMaster.comid  where  Barcode='" + txtbartext.Text + "'";
        //            lblbarmsg.Text = "";
        //            //string str1 = "select Distinct EmployeeBarcodeMaster.Employee_Id,EmployeeMaster.EmployeeName from EmployeeBarcodeMaster inner join EmployeeMaster on EmployeeMaster.EmployeeMasterID=EmployeeBarcodeMaster.Employee_Id where EmployeeBarcodeMaster.Whid='" + ddlwarehouse.SelectedValue + "' and Barcode='" + txtbartext.Text + "'";
        //            SqlDataAdapter adp = new SqlDataAdapter(str1, cnn);
        //            DataTable ds = new DataTable();
        //            adp.Fill(ds);
        //            if (ds.Rows.Count > 0)
        ...
        //                Fillddlbatch();
        //                ddlbatchmaster.SelectedIndex = ddlbatchmaster.Items.IndexOf(ddlbatchmaster.Items.FindByValue(ds.Rows[0]["Id"].ToString()));
        //                ddlbatchmaster_SelectedIndexChanged(sender, e);
        ...
        //                        string stra = "SELECT BatchTiming.Totalhours,BatchTiming.StartTime,BatchTiming.EndTime FROM BatchTiming where BatchMasterId='" + ddlbatchmaster.SelectedValue + "'";
        //                        SqlDataAdapter adpa = new SqlDataAdapter(stra, cnn);
        //                        DataTable dt = new DataTable();
        //                        adpa.Fill(dt);
        //                        if (dt.Rows.Count > 0)
        //                        {
        ...
        //                            {
        //                                strapp = "SELECT Distinct EmployeeMaster.EmployeeMasterID,AttendenceEntryMaster.InTimeforcalculation,AttendenceEntryMaster.InTime,AttendenceEntryMaster.AttendanceId,AttendenceEntryMaster.Date,AttendenceEntryMaster.OutTime,AttendenceEntryMaster.InTime " +
        //                                    "FROM  EmployeeMaster  inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID   inner join AttendenceEntryMaster on EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID  Where (EmployeeMasterID='" + ds.Rows[0]["Employee_Id"] + "') and (AttendenceEntryMaster.OutTimeforcalculation='00:00') and (AttendenceEntryMaster.Date='" + serdate + "') and Batchmasterid='" + ddlbatchmaster.SelectedValue + "'";
        ...
        //                            {
        //                                strapp = "SELECT Distinct EmployeeMaster.EmployeeMasterID,AttendenceEntryMaster.InTimeforcalculation,AttendenceEntryMaster.InTime,AttendenceEntryMaster.AttendanceId,AttendenceEntryMaster.Date,AttendenceEntryMaster.OutTime,AttendenceEntryMaster.InTime " +
        //                                   "FROM  EmployeeMaster  inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID   inner join AttendenceEntryMaster on EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID  Where (EmployeeMasterID='" + ds.Rows[0]["Employee_Id"] + "') and (AttendenceEntryMaster.OutTimeforcalculation='00:00')and (AttendenceEntryMaster.Outtime<='" + tt.ToString().Remove(5, 3) + "') and (AttendenceEntryMaster.Date='" + serdate + "') and Batchmasterid='" + ddlbatchmaster.SelectedValue + "'";
        ...
        //                    strapp = "SELECT Distinct EmployeeMaster.EmployeeMasterID,AttendenceEntryMaster.InTimeforcalculation,AttendenceEntryMaster.InTime,AttendenceEntryMaster.AttendanceId,AttendenceEntryMaster.Date,AttendenceEntryMaster.OutTime,AttendenceEntryMaster.InTime " +
        //                     "FROM  EmployeeMaster  inner join EmployeeBatchMaster on EmployeeBatchMaster.Employeeid=EmployeeMaster.EmployeeMasterID   inner join AttendenceEntryMaster on EmployeeMaster.EmployeeMasterID=AttendenceEntryMaster.EmployeeID  Where (EmployeeMasterID='" + ds.Rows[0]["Employee_Id"] + "') and (AttendenceEntryMaster.OutTimeforcalculation='00:00') and (AttendenceEntryMaster.Date='" + Label1date.Text + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(1).ToShortDateString() + "' or  AttendenceEntryMaster.Date='" + Convert.ToDateTime(Label1date.Text).AddDays(-1).ToShortDateString() + "') and Batchmasterid='" + ddlbatchmaster.SelectedValue + "'";
        //                }
        //                SqlDataAdapter adpl = new SqlDataAdapter(strapp, cnn);
        //                DataTable dsl = new DataTable();
        //                adpl.Fill(dsl);
    ...
    protected void AttandanceEntryNotesupdate()
    {
        ...
        string str3 = "update AttandanceEntryNotes set OutTimeNote='" + TextBox3.Text + "' where AttendanceId=" + Session["AttendanceId"] + "";
    ...
    protected void AttandanceEntryNotes()
    {
        ...
        if (Convert.ToString(dt.Rows[0]["AttendanceId"]) != "")
        {
            ...
            string str3 = "insert into AttandanceEntryNotes(IntimeNote,AttendanceId)values('" + txtnote.Text + "','" + dt.Rows[0]["AttendanceId"] + "')";
            //dr.Close();
            SqlCommand cmd1 = new SqlCommand(str3, cnn);
            //dr.Close();
            cmd1.ExecuteNonQuery();
