...
{
      SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["JobcenterLicense"].ConnectionString);
   ...
   // DBCommands1 dbss1 = new DBCommands1();
    ...
    protected void fillgrid()
    {
        ...
        //where WareHouseMaster.comid='" + Session["Comid"] + "'" + wfil + "
        string strgrd = "select distinct Id, WareHouseMaster.Name as Wname,AttendanceDeviceName,AttendanceDeviceNo,Location,IpAddress  from AttendanceDeviceTbl inner join WareHouseMaster on WareHouseMaster.WareHouseId=AttendanceDeviceTbl.Whid   Order by AttendanceDeviceTbl.AttendanceDeviceName  ";
