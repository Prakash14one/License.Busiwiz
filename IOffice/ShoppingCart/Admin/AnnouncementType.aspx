<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ShoppingCart/Admin/Master/mp_Admin.master"
    CodeFile="AnnouncementType.aspx.cs" Inherits="AnnouncementType" Title="AnnouncementType" %>
...
<div class="products_box">
        ...
        <fieldset>
            ...
            <div style="float: right;">
                <asp:Button ID="btnadddd" runat="server" Text="Add New Announcement Type"
                    ...
                    <tr>
                        <td width="25%">
                            <label style="width: 350px;">
                               Take me to add announcement after adding this announcement type</label>
                        </td>
                        <td>
        ...
        <fieldset>
            <legend>
                <asp:Label ID="Label4" runat="server" Text="List of Announcement Types"></asp:Label>
            </legend>
                                                ...
                                                <table width="850Px">
                                                    <tr align="center">
                                                        <td align="center" style="text-align: center; font-size: 18px; font-weight: bold;">
                                                            <asp:Label ID="Label24" runat="server" Font-Italic="True" Text="List of Announcement Types"></asp:Label>
                                                        </td>
                                                    </tr>
                                                  <%--  <tr>
                                            ...
                                            <asp:GridView ID="GVC" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Announcement Type">
                                                     <ItemTemplate>
                                                            <asp:Label ID="lblroomtypenname" runat="server" Text='<%# Eval("AnnouncementType") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Left" Width="25%" />
                                                    </asp:TemplateField>
