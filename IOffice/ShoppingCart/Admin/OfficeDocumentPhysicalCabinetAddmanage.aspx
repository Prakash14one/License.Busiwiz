<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="OfficeDocumentPhysicalCabinetAddmanage.aspx.cs"
    Inherits="ShoppingCart_Admin_DocumentMainType" Title="Office Document Physical Cabinet:Addmanage.aspx" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="products_box">
                <fieldset>
                    <legend>
                        <asp:Label ID="Label6" runat="server" Text="Add New Office Document Cabinet" Visible="False">
                        </asp:Label>
                    </legend>
                    <div style="float: right;">
                        <asp:Button ID="btnadd" runat="server" Text="Add New Office Document Cabinet" CssClass="btnSubmit"
                    ...
                    <asp:Panel ID="pnladd" runat="server" Visible="false">
                        <table id="subinnertbl" width="100%" cellspacing="3">
                            ...
                            <tr>
                                <td style="width: 30%">
                                    <label>
                                        <asp:Label runat="server" ID="Label8" Text="Cabinet Description" Visible="true"></asp:Label>
                ...
                <fieldset>
                    <legend>
                        <asp:Label ID="lbllegend" runat="server" Text="List of Office Document Cabinets"></asp:Label>
                    </legend>
                    <table width="100%">
                        <tr>
                            <td colspan="2">
                                                    ...
                                                    <table width="100%">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" align="center" style="text-align: center; font-size: 18px; font-weight: bold;">
                                                                <asp:Label ID="Label1" runat="server" Font-Italic="true" Text="List of Office Document Cabinets"
                                        ...
                                        <tr>
                                            <td>
                                                <cc11:PagingGridView AutoGenerateColumns="False" BorderWidth="1px" ID="griddocmaintype"
                                                    ...
                                                    AllowSorting="true" OnSorting="griddocmaintype_Sorting" OnRowCommand="griddocmaintype_RowCommand"
                                                    PageSize="20">
