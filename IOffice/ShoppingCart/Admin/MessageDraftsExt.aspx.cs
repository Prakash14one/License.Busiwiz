...
public partial class Account_MessageDraftsExt : System.Web.UI.Page
{
    SqlConnection con;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["PageName"] = "MessageDraftsExt.aspx";
    ...
    protected void SelectMsgforDraft()
    {
        ...
        str = "  " + PageConn.extmsg11 + ".dbo.MsgMasterExt.MsgDate, " + PageConn.extmsg11 + ".dbo.MsgMasterExt.MsgSubject, " + PageConn.extmsg11 + ".dbo.MsgStatusMasterExt.MsgStatusName," + PageConn.extmsg11 + ".dbo.MsgDetailExt.MsgStatusId," + PageConn.extmsg11 + ".dbo.MsgMasterExt.FromPartyId," + PageConn.extmsg11 + ".dbo.MsgDetailExt.ToEmailId, " + PageConn.extmsg11 + ".dbo.MsgMasterExt.MsgId FROM " + PageConn.extmsg11 + ".dbo.MsgDetailExt INNER JOIN " + PageConn.extmsg11 + ".dbo.MsgMasterExt ON " + PageConn.extmsg11 + ".dbo.MsgDetailExt.MsgId = " + PageConn.extmsg11 + ".dbo.MsgMasterExt.MsgId INNER JOIN " + PageConn.extmsg11 + ".dbo.MsgStatusMasterExt ON " + PageConn.extmsg11 + ".dbo.MsgDetailExt.MsgStatusId = " + PageConn.extmsg11 + ".dbo.MsgStatusMasterExt.MsgStatusId left join Party_master on Party_master.PartyID=" + PageConn.extmsg11 + ".dbo.MsgMasterext.FromPartyId left join PartytTypeMaster on PartytTypeMaster.PartyTypeId=Party_master.PartyTypeId  where ((" + PageConn.extmsg11 + ".dbo.MsgMasterExt.FromEmail = '" + ViewState["lb"] + "'))  and " + PageConn.extmsg11 + ".dbo.MsgDetailExt.MsgStatusId in(3) " + mes1 + " " + mes2 + " " + mes3 + " " + mes3 + " " + mes4 + " " + mes5 + " " + mes6 + " " + mes7 + " " + mes8 + " " + mes9 + " " + mes10 + " " + mes11 + " " + mes12 + " " + mes13 + " " + mes14 + " " + mes15 + " " + mes16 + " " + mes17 + " " + mes18 + " " + mes19 + "";
        ...
        //{
        //    //  dt = clsMessage.SelectMsgforDraftExt(Convert.ToInt32(Session["PartyId"].ToString()));

        //    str = "SELECT  distinct MsgMasterExt.MsgDate, MsgMasterExt.MsgSubject, MsgStatusMasterExt.MsgStatusName,MsgDetailExt.MsgStatusId,MsgMasterExt.FromPartyId,MsgDetailExt.ToEmailId, MsgMasterExt.MsgId FROM MsgDetailExt INNER JOIN MsgMasterExt ON MsgDetailExt.MsgId = MsgMasterExt.MsgId INNER JOIN MsgStatusMasterExt ON MsgDetailExt.MsgStatusId = MsgStatusMasterExt.MsgStatusId where FromPartyId = '" + Convert.ToInt32(Session["PartyId"].ToString()) + "' and MsgMasterExt.FromEmail='" + ddlempemail.SelectedItem.Text + "'and MsgMasterExt.FromEmail='" + ddlempemail.SelectedItem.Text + "' and MsgDetailExt.MsgStatusId in(3) " + mes1 + " " + mes2 + " " + mes3 + " " + mes3 + " " + mes4 + " " + mes5 + " " + mes6 + " " + mes7 + " " + mes8 + " " + mes9 + " " + mes10 + " " + mes11 + " " + mes12 + " " + mes13 + " " + mes14 + " " + mes15 + " " + mes16 + " " + mes17 + " " + mes18 + " " + mes19 + " order by Msgdate desc";
        //    SqlDataAdapter da = new SqlDataAdapter(str, con);
        //    da.Fill(dt);
        //}
        ...
        //   // dt = clsMessage.SelectMsgforDraftExt(Convert.ToInt32(dtorgeml.Rows[0][1].ToString()));

        //    str = "SELECT  distinct MsgMasterExt.MsgDate, MsgMasterExt.MsgSubject, MsgStatusMasterExt.MsgStatusName,MsgDetailExt.MsgStatusId,MsgMasterExt.FromPartyId,MsgDetailExt.ToEmailId, MsgMasterExt.MsgId FROM MsgDetailExt INNER JOIN MsgMasterExt ON MsgDetailExt.MsgId = MsgMasterExt.MsgId INNER JOIN MsgStatusMasterExt ON MsgDetailExt.MsgStatusId = MsgStatusMasterExt.MsgStatusId where MsgMasterExt.FromEmail='" + ddlempemail.SelectedItem.Text + "' and MsgDetailExt.MsgStatusId in(3) " + mes1 + " " + mes2 + " " + mes3 + " " + mes3 + " " + mes4 + " " + mes5 + " " + mes6 + " " + mes7 + " " + mes8 + " " + mes9 + " " + mes10 + " " + mes11 + " " + mes12 + " " + mes13 + " " + mes14 + " " + mes15 + " " + mes16 + " " + mes17 + " " + mes18 + " " + mes19 + " order by Msgdate desc";
        //    SqlDataAdapter da = new SqlDataAdapter(str, con);
        //    da.Fill(dt);
        ...
        {
            DataTable dt = GetDataPage(gridDraft.PageIndex, gridDraft.PageSize, sortExpression, str);
    ...
    protected void fillddl()
    {
        ...
        //dtempemail = select("  Select Signature,EmailSignatureMaster.Id from InOutCompanyEmail inner join EmailSignatureMaster on EmailSignatureMaster.InoutgoingMasterId=InOutCompanyEmail.ID where EmployeeID='" +  Session["EmployeeIdep"] + "'");
        //if (dtempemail.Rows.Count == 0)
        //{
        //    dtempemail = select("Select Signature,InOutCompanyEmail.Id from InOutCompanyEmail inner join EmailSignatureMaster on EmailSignatureMaster.InoutgoingMasterId=InOutCompanyEmail.ID where Whid in(Select WarehouseId from WarehouseMaster inner join EmployeeMaster on EmployeeMaster.Whid=WarehouseMaster.WarehouseId where EmployeeMaster.EmployeeMasterId= '" +  Session["EmployeeIdep"] + "')");
            ...
            else
            {
                foreach (GridViewRow GR in gridDraft.Rows)
                {
                    ...
                    if (chk.Checked == true)
                    {
                        ...
                        bool UpdateMsgMaster = clsMessage.UpdateMsgMasterforDraftSendExt(MsgId);
                        UpdateMsg = clsMessage.UpdateMsgDetailusingMsgIdExt(MsgId, 1);
                    }
                }
                if (UpdateMsg == true)
                {
        ...
        if (gridDraft.Rows.Count > 0)
        {
            ...
            else
            {
                ...
                foreach (GridViewRow GR in gridDraft.Rows)
                {
                    ...
                    {
                        Int32 MsgId = Convert.ToInt32(gridDraft.DataKeys[GR.RowIndex].Value);
                        bool MsgDetailDelete = clsMessage.DeleteMsgDetailExt(MsgId);
                        bool FileDelete = clsMessage.DeleteMsgFileAttachDetailExt(MsgId);
                        MsgMasterDelete = clsMessage.DeleteMsgMasterExt(MsgId);
                    }
                }
