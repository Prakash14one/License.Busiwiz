<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="FrmProjectMaster23-5NotWork.aspx.cs" Inherits="Admin_Admin_files_FrmProjectMaster"
                ...
                <fieldset>
                    ...
                    <asp:Panel ID="Pnladdnew" runat="server" Visible="false" Width="100%">
                                    ...
                                    <asp:Panel ID="Panel16" runat="server" Width="100%">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td style="width: 30%" align="left">
                                                    <label>
                                                        <asp:Label ID="Label40" runat="server" Text="Department Name: "></asp:Label>
                                                    </label>
                                                </td>
                                                <td style="width: 70%">
                                                    <label>                                                                                                              
                                                          <asp:DropDownList ID="DDLDepartmentfill" runat="server"  Width="250px" OnSelectedIndexChanged="DDLDepartmentfill_SelectedIndexChanged" AutoPostBack="True">
                                                        </asp:DropDownList>
                                                    </label>
                                                    <label>
                        ...
                        <fieldset>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <label style="width:500px;">
                                                            <asp:TextBox ID="txtdoctitle" runat="server" ValidationGroup="1" TabIndex="2" MaxLength="60"
                            ...
                            <td colspan="2">
                                <label style="width:500px;">
                                    <asp:DropDownList ID="ddldt" runat="server" ValidationGroup="1" Width="500px"   AutoPostBack="True" onselectedindexchanged="ddldt_SelectedIndexChanged" >
                                    </asp:DropDownList>
                                </label>
                                <label style="width:25px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                            ...
                                                            <ContentTemplate>
                                                                <label style="width:500px;">
                                                                    <asp:DropDownList ID="ddlpartyname" runat="server" ValidationGroup="1" TabIndex="3" Width="500px" >
                                                                    </asp:DropDownList>
                                                                </label>
                                                                <label style="width:25px;">
