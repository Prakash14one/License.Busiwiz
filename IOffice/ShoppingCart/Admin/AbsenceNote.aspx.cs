...
public partial class BusinessCategory : System.Web.UI.Page
{
    ...
    protected void fillemployee()
    {
        ...
        string str = "select employeemasterid,employeename from employeemaster where whid='" + ddlbusiness.SelectedValue + "' and employeename !='' and Active='1' order by employeename";
