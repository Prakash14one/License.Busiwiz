<%@ Page Title="Attendance Rule Master" Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="AttendenceRule.aspx.cs" Inherits="Add_AttendenceRule_Master" %>
    ...
    <asp:UpdatePanel ID="pnnn1" runat="server">
        <ContentTemplate>
            <div class="products_box">
                        ...
                        <asp:Panel ID="pnlenb" runat="server">
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td valign="top">
                                            ...
                                            <label>
                                                <asp:TextBox ID="TextBox3" runat="server" Visible="true" Width="45px" Text="15" MaxLength="5"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            ...
                                            <label>
                                                <asp:Label ID="Label90" runat="server" Text="Yes"></asp:Label>
                                            </label>
                                            <label class="Attend">
                                        ...
                                        <td valign="top">
                                            <table width="100%">
                                                <tr>
                                                    <td colspan="3">
                                                        <label class="Attend">
                                                            <asp:Label ID="Label16" runat="server" Text="By default the system takes first entry of employee for any day as IN Entry and second entry as OUT Entry."></asp:Label>
                                                            <br />
                                                            <asp:Label ID="Label4" runat="server" Text="The system will not allow any employee to make more than two entries in a day."></asp:Label>
                                                            <br />
                                                            <asp:Label ID="Label29" runat="server" Text="However you can set the rule that system allows multiple entries and consider the latest entry done by any employee in a day as OUT Entry for the day."></asp:Label>
                                                        </label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="width: 250px;" colspan="3">
                                                        <label class="Attend">
                                                            <asp:Label ID="Label91" runat="server" Text="Do you wish to set this rule for latest entry as OUT Entry of the employee from the following pages ? Yes"></asp:Label>
                                                        </label>
                                                        <label class="Attend">
                                                            <asp:CheckBox ID="chkinoutday" Checked="true" runat="server" TextAlign="Left" Text="" />
                                                        </label>
                                                        <label class="Attend">
                                                            Pages : 'Attendance by Employee Number' , 'Attendance by Employee UserID' , 'Attendance
                                                            by click of entry exit'
                                                        </label>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td valign="top">
                                            ...
                                            <label>
                                                ...
                                                <asp:RangeValidator ID="rds" MinimumValue="0" MaximumValue="59" Type="Integer" ControlToValidate="txtblackin"
                                                    Display="Dynamic" runat="server" ErrorMessage="*" SetFocusOnError="true"></asp:RangeValidator>
                                            </label>
                                            <label>
                                            ...
                                            <label>
                                                This will avoid mistake in marking an entry as 'OUT Entry' when any user by mistake
                                                swipes attendance card twice in succession while checking IN.
                                            </label>
                                        </td>
                                    </tr>
                            ...
                            <fieldset>
                                ...
                                <table width="100%">
                                    ...
                                    <asp:Panel ID="pandsdsd" runat="server" Visible="false">
                                        <tr>
                                            <td valign="top">
                                                <label>
                                                    2
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            ...
                                            <label>
                                                <asp:TextBox ID="txtreason" runat="server" Width="45px" MaxLength="3">1</asp:TextBox>
                                            ...
                                            <label>
                                                <asp:TextBox ID="txtempapproal" runat="server" Visible="true" Width="45px" MaxLength="3">3</asp:TextBox>
                                            ...
                                            <label>
                                                ...
                                                <br />
                                                (This will stop abuse by employee to block excessive over time)
                                            </label>
                                            <label>
                                                <asp:TextBox ID="txtouttimegreater" runat="server" Visible="true" Width="45px" Text="1"
                                            ...
                                            <label>
                                                <asp:TextBox ID="txtallowusereg" runat="server" Visible="true" Width="45px" Text="2"
                                                    MaxLength="3"></asp:TextBox>
                            ...
                            <asp:Panel ID="panel2" runat="server" > <%--Visible="false"--%>
                                <fieldset>
                                    <legend>C - Email Notifications</legend>
                                    <table width="100%">
                                        <tr>
                                            <td valign="top">
                                                <label>
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td valign="top" style="width: 25%;">
                                                                <label class="Attend">
                                                                    Select daily time when you wish to send this report.
                                                                </label>
                                                            </td>
                                                            <td style="width: 43%;" rowspan="2">
                                                                <label class="radiobuttonlabel">
                                                                    <asp:RadioButtonList ID="rddreport" runat="server">
                                                                        ...
                                                                        <asp:ListItem Text="End of last batch " Value="3"></asp:ListItem>
                                                                    </asp:RadioButtonList>
                                                                </label>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" colspan="3">
                                                                ...
                                                                <label class="Attend">
                                                                    <asp:CheckBox ID="chkrecreportsuper" runat="server" Checked="false" />
                                                                    <asp:Label ID="dfsg" runat="server" Text="Supervisor of any Employee"></asp:Label>
                                                                </label>
                                                                <label class="Attend">
                                                                    <asp:CheckBox ID="chkrecreportatteadmin" runat="server" Checked="false" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3" valign="top">
                                                                <label>
                                                                    Select Employees to receive report
                                                                </label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                ...
                <fieldset>
                    <legend>List of Attendance and Overtime Rules</legend>
