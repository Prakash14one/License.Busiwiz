<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ShoppingCart/Admin/Master/mp_Admin.master"
    CodeFile="add_building.aspx.cs" Inherits="add_building" Title="Add Building" %>
...
<div class="products_box">
        ...
        <fieldset>
            ...
            <div style="float: right;">
                <asp:Button ID="btnadddd" runat="server" Text="Add New Building" OnClick="btnadddd_Click"
                    ...
                    <tr>
                        <%-- <td style="width: 25%">
                                       ...
                                       <asp:Label ID="Label1" runat="server" Text="*" CssClass="labelstar"></asp:Label>
                                        ...
                                        <asp:RegularExpressionValidator ID="REG1" runat="server" ErrorMessage="Invalid"  
                                            SetFocusOnError="True" ValidationExpression="^[A-Za-z]+$" ControlToValidate="txtGrade"
                        ...
                        <td style="width: 25%">
                            <label>
                                Building Name
                                <asp:Label ID="Label1" runat="server" Text="*" CssClass="labelstar"></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtBuilding"
                                    SetFocusOnError="true" ValidationGroup="save" ErrorMessage="*"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="REG1" runat="server" ErrorMessage="Invalid Character"
                                    SetFocusOnError="True" ValidationExpression="^([a-zA-Z0-9\s]*)" ControlToValidate="txtBuilding"
                                    ValidationGroup="save"></asp:RegularExpressionValidator>
                            </label>
                        </td>
                     ...
                     <td valign="middle">
                            <label>
                                <asp:TextBox ID="txtBuilding" runat="server" MaxLength="25" onKeydown="return mask(event)"
                                    Width="200px" onkeyup="return check(this,/[\\/!._@#$%^'&*()>+:;={}[]|\/]/g,/^[\a-zA-Z0-9\s]+$/,'Span2',25)"
                                    TabIndex="5" OnTextChanged="txtBuilding_TextChanged"></asp:TextBox>
                            </label>
                            <label>
                     ...
                     <tr>
                        <td width="25%">
                            <label style="width: 350px;">
                                Take me to add floor after adding this building</label>
                        </td>
                        <td>
        ...
        <fieldset>
            <legend>
                <asp:Label ID="Label4" runat="server" Text="List of Buildings"></asp:Label>
            </legend>
                                                ...
                                                <table width="850Px">
                                                    <tr align="center">
                                                        <td align="center" style="text-align: center; font-size: 18px; font-weight: bold;">
                                                            <asp:Label ID="Label24" runat="server" Font-Italic="True" Text="List of Buildings"></asp:Label>
                                                        </td>
                                                    </tr>
                                                  <%--  <tr>
