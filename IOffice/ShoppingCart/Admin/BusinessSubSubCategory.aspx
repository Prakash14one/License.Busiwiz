<%@ Page Language="C#" MasterPageFile="~/ShoppingCart/Admin/Master/mp_Admin.master"
    AutoEventWireup="true" CodeFile="BusinessSubSubCategory.aspx.cs" Inherits="BusinessSubSubCategory" %>
            ...
            <div class="products_box">
                ...
                <fieldset>
                    ...
                    <div style="float: right;">
                        <asp:Button ID="btnadddd" runat="server" Text="Add New Business Sub Sub Category" OnClick="btnadddd_Click"
                    ...
                    <asp:Panel runat="server" ID="pnladdd" Visible="false">
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <asp:DropDownList ID="ddlCat" runat="server" AutoPostBack="True" Width="250px" OnSelectedIndexChanged="ddlCat_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 25%">
                                    <label>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlSCat"
                                            ValidationGroup="save" ErrorMessage="*" InitialValue="0"></asp:RequiredFieldValidator>
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <asp:DropDownList ID="ddlSCat" runat="server" Width="250px">
                                        </asp:DropDownList>
                                    </label>
                                    <label>
                            ...
                            <tr>
                                <td style="width: 25%">
                                    <label>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSSC"
                                        ...
                                        <asp:RegularExpressionValidator ID="REG1" runat="server" ErrorMessage="Invalid Character"
                                            SetFocusOnError="True" ValidationExpression="^([a-zA-Z0-9_\s]*)" ControlToValidate="txtSSC"
                                            ValidationGroup="save"></asp:RegularExpressionValidator>
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <asp:TextBox ID="txtSSC" runat="server" MaxLength="50" onKeydown="return mask(event)"
                ...
                <fieldset>
                    <legend>
                        <asp:Label ID="Label4" runat="server" Text="List of Business Sub Sub Categories"></asp:Label>
                    </legend>
                    <div style="float: right">
                            ...
                            <td>
                                <asp:Panel ID="pnlgrid" runat="server" Width="100%">
                                    <table width="100%">
                                                    ...
                                                    <table width="850Px">
                                                        <tr align="center">
                                                            <td align="center" style="text-align: center; font-size: 18px; font-weight: bold;">
                                                                <asp:Label ID="Label24" runat="server" Font-Italic="true" Text="List of Business Sub Sub Categories"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" style="text-align: left; font-size: 14px;">
                                                                ...
                                                                ,
                                                                <asp:Label ID="Label5" runat="server" Font-Italic="true" Text="Sub Category : "></asp:Label>
                                                                <asp:Label ID="lblsubcategory" runat="server" Font-Italic="true"></asp:Label>
                                                                ,
                                                                <asp:Label ID="Label312" runat="server" Font-Italic="true" Text="Status : "></asp:Label>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVSSC" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                                    DataKeyNames="B_SubSubCatID" Width="100%" OnPageIndexChanging="GVSSC_PageIndexChanging"
                                                    EmptyDataText="No Record Found." OnRowDeleting="GVSSC_RowDeleting" OnRowEditing="GVSSC_RowEditing"
                                                    CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                                    OnRowCommand="GVSSC_RowCommand">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Category" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="20%">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblBCat" runat="server" Text='<%# Bind("B_Category") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Sub Category" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="25%">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Sub Sub Category" HeaderStyle-HorizontalAlign="Left"
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblssc" runat="server" Text='<%# Bind("B_SubSubCategory") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Edit" HeaderImageUrl="~/Account/images/edit.gif" HeaderStyle-HorizontalAlign="Left"
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="ImageButton49" ImageUrl="~/Account/images/edit.gif" runat="server"
                                                                    ToolTip="Edit" CommandArgument='<%# Eval("B_SubSubCatID") %>' CommandName="Edit" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Delete" HeaderImageUrl="~/ShoppingCart/images/trash.jpg"
                                                            HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="2%">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="ImageButton48" runat="server" CommandArgument='<%# Eval("B_SubSubCatID") %>'
