<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="MessageSent.aspx.cs" Inherits="Account_MessageSent"
    Title="Untitled Page" %>
    ...
    <div class="products_box">
        ...
        <table width="100%">
            <tr>
                <td style="width: 10%">
                    <label>
                        <asp:Label ID="lblInbox" runat="server" Text="Sent" Font-Size="Large" Font-Bold="false"></asp:Label>
                    </label>
                </td>
                <td>
                            ...
                            <td colspan="2" align="left">
                                <asp:Panel ID="pnlgrid" runat="server">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <table width="100%">
                                                        <tr align="center">
                                                            <td align="center" style="text-align: center; font-size: 18px; font-weight: bold;">
                                                                <asp:Label ID="Label28" runat="server" Font-Italic="True" Text="List of Message Sent"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <cc11:PagingGridView ID="grdSentMailList" runat="server" DataKeyNames="MsgId" AutoGenerateColumns="False"
                                                    OnRowDataBound="grdSentMailList_RowDataBound" GridLines="Both" AllowPaging="True"
                                                    CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                                    OnPageIndexChanging="grdSentMailList_PageIndexChanging" OnRowCommand="grdSentMailList_RowCommand"
                                                    EmptyDataText="There is no Message." AllowSorting="True" OnSorting="grdSentMailList_Sorting"
                                                    Width="100%">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Date" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                            SortExpression="MsgId" ItemStyle-ForeColor="Black" HeaderStyle-Width="11%">
                                                            <ItemTemplate>
