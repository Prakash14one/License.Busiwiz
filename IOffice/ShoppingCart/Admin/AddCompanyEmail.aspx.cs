...
public partial class Account_AddCompanyEmail : System.Web.UI.Page
{
    ...
    protected void imgbtnsubmitCabinetAdd_Click(object sender, EventArgs e)
    {
        ...
        else if (flg == false && flg1 == false)
        {
            ...
            int i = clsDocument.InsertOutgoingCompanyEmail(txtoutserver.Text, txtoutemail.Text, txtoutpass.Text, txtserver.Text, txtuser.Text, txtpass.Text, Convert.ToDateTime("01/01/1980"), indx, chk, ddlstore.SelectedValue, ddlemp.SelectedValue, txtemail.Text, txtport1.Text, txtport2.Text, txtmemailname.Text);
    ...
    public void FillGrid()
    {
        ...
        if (Convert.ToInt32(ddlempfil.SelectedValue) > 0)
        {
        ...
        else if (Convert.ToInt32(ddlbusinessfil.SelectedValue) > 0)
        {
