<%@ Page Language="C#" MasterPageFile="~/MainHome.master" AutoEventWireup="true"
    CodeFile="EmpAttendancewithempcode.aspx.cs" Inherits="productprofile" Title="Untitled Page" %>
   ...
   <%--<script language="javascript" type="text/javascript">
    ...
    <div id="right_content" class="columns_contents_Inner">
                        ...
                        <td>
                            <div style="text-align: center; font-size: 50px; border: 2px solid #416271; padding: 10px;
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always" RenderMode="Block">
                                    <ContentTemplate>
                                        <asp:Timer ID="TimerTime" runat="server" Interval="1000" Enabled="false" OnTick="TimerTime_Tick">
                                        </asp:Timer>
                    ...
                    <tr>
                        <td>
                            <label>
                                ...
                                <asp:Label ID="lbldtate0" runat="server"></asp:Label>
                            </label>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <div id="stylized" class="myform">
                                <table width="100%">
                                    <tr>
                                        <td style="width: 35%">
                                            <label>
                                                <asp:Label ID="Label26" runat="server" Text="Employee Number">
                                                </asp:Label>
                                                <asp:RequiredFieldValidator ID="RequiredFiealidator3" runat="server" ControlToValidate="txtempno"
                                                    ErrorMessage="*" SetFocusOnError="true" ValidationGroup="3">
                                                </asp:RequiredFieldValidator>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <asp:TextBox ID="txtempno" runat="server" BorderWidth="1px" Width="200px"></asp:TextBox>
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 35%">
                                            <label>
                                                <asp:Label ID="Label25" runat="server" Text="Employee Security Code" Width="210px">
                                                </asp:Label>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtemployeecode"
                                                    ErrorMessage="*" SetFocusOnError="true" ValidationGroup="3">
                                                </asp:RequiredFieldValidator>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <asp:TextBox ID="txtemployeecode" runat="server" BorderWidth="1px" Width="200px">
                                                </asp:TextBox>
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnempcode" runat="server" Text="Go" ValidationGroup="3" OnClick="btnempcode_Click"
                        ...
                        <asp:Panel ID="Panel6" runat="server" CssClass="modalPopup" BorderWidth="10px" BackColor="#d1cec5"
                            ...
                            <table cellpadding="2" cellspacing="2" align="center" style="width: 595px">
                                ...
                                <tr>
                                    <td style="width: 50%">
                                        <label>
                                            <asp:Label ID="Label63" runat="server" Font-Bold="false" Text="Current Time" Font-Names="Verdana"
                                ...
                                <tr>
                                    <td style="width: 50%">
                                        <label>
                                            <asp:Label ID="Label64" runat="server" Font-Bold="false" Text="Your Scheduled Entry time is"
                                ...
                                <tr>
                                    <td colspan="2">
                                        <label>
                                            ...
                                            <asp:Label ID="Label46" runat="server" Text="" Font-Names="Verdana" Font-Size="14px"></asp:Label>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <label>
                                            <asp:Label ID="Label28" runat="server" Text="You need to take approval from your Attendance Admin <"
                                                Font-Bold="false"></asp:Label>
                                            <asp:Label ID="Label48" runat="server" Text="" ForeColor="Black" Font-Names="Verdana"
                                                Font-Size="14px"></asp:Label>
                                            <asp:Label ID="Label49" runat="server" Text="> for recording attendance." Font-Bold="false"></asp:Label>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="center" colspan="2">
                                        <asp:Button ID="btnaddlater" runat="server" Text="Submit" OnClick="btnaddlater_Click"
                                            BorderWidth="1px" CssClass="btnSubmit" ValidationGroup="5" />
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center" colspan="2">
                                        <asp:Button ID="btnsubm" runat="server" Text="Submit" ValidationGroup="2a" OnClick="btnsubm_Click"
                                            CssClass="btnSubmit" />
                                        <asp:Button ID="btnsubm0" runat="server" OnClick="btnsubm0_Click" Text="Cancel" CssClass="btnSubmit" />
                                    </td>
                                </tr>
                            </table>
                        ...
                        <asp:Panel ID="Panel2" runat="server" CssClass="modalPopup" BorderWidth="7px" BackColor="#d1cec5"
                            ...
                            <table id="Table1" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <asp:Label ID="lblwelcome" runat="server" Text="Welcome " Font-Size="12px" Font-Bold="false"></asp:Label>
                                            <asp:Label ID="Label1" runat="server" Font-Size="12px" Font-Names="Verdana"></asp:Label>
                                            <asp:Label ID="Label2" runat="server" Text=", you have successfully entered." Font-Size="12px"
                                                Font-Bold="false"></asp:Label>
                                            <br />
                                            <br />
                                            <asp:Label ID="Label5" runat="server" Text="Your entry time : " Font-Size="12px"
                                                Font-Bold="false"></asp:Label>
                        ...
                        <asp:Panel ID="Panel4" runat="server" CssClass="modalPopup" BorderWidth="7px" BackColor="#d1cec5"
                            ...
                            <table id="Table3" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <asp:Label ID="Label111" runat="server" Text="Thank you " Font-Size="12px" Font-Bold="false"></asp:Label>
                                            <asp:Label ID="Label211" runat="server" Font-Size="12px" Font-Names="Verdana"></asp:Label>
                                            <asp:Label ID="Label30" runat="server" Text=", you have successfully checked out."
                                                Font-Bold="false" Font-Size="12px"></asp:Label>
                                            <br />
                                            <br />
                                            <asp:Label ID="Label31" runat="server" Text="Your check out time : " Font-Size="12px"
                                                Font-Bold="false"></asp:Label>
                        ...
                        <asp:Panel ID="Panel9" runat="server" CssClass="modalPopup" BorderWidth="7px" BackColor="#d1cec5"
                            ...
                            <table id="Table4" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <asp:Label ID="Label33" runat="server" Font-Bold="false" Font-Size="12px" Text="Sorry, No Attendance Record can be inserted this time as you have exceeded the allowed number of instances.">
                                            </asp:Label>
                                        </label>
                                    </td>
                                </tr>
                        ...
                        <asp:Panel ID="Panel11" runat="server" CssClass="modalPopup" BorderWidth="7px" BackColor="#d1cec5"
                            ...
                            <table id="Table6" cellpadding="0" cellspacing="0" width="100%" align="center">
                                <tr>
                                    <td align="center">
                                        <label>
                                            <asp:Label ID="Label39" Font-Bold="false" runat="server" Font-Size="12px" Text="Sorry, you are not allowed late entry for rules."></asp:Label>
                                        </label>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <asp:Panel ID="Panel12" runat="server" CssClass="modalPopup" BorderWidth="7px" BackColor="#d1cec5"
                            ...
                            <table id="Table7" cellpadding="0" cellspacing="0" width="100%" align="center">
                                <tr>
                                    <td align="center">
                                        <label>
                                            <asp:Label ID="Label40" Font-Bold="false" runat="server" Font-Size="12px" Text="Sorry, you are not allowed early entry for rules."></asp:Label>
                                        </label>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <asp:Panel ID="Panel13" runat="server" CssClass="modalPopup" BorderWidth="7px" BackColor="#d1cec5"
                            ...
                            <table id="Table8" cellpadding="0" cellspacing="0" width="100%" align="center">
                                <tr>
                                    <td>
                                        <label>
                                            <asp:Label ID="Label52" runat="server" Font-Size="12px" Font-Bold="false" Text="You are not allowed to add your attendance, as today is not a working day in your scheduled batch."></asp:Label>
                                        </label>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <asp:Panel ID="Panel14" runat="server" CssClass="modalPopup" BorderWidth="7px" BackColor="#d1cec5"
                            ...
                            <table id="Table9" cellpadding="0" cellspacing="0" width="100%" align="center">
                                <tr>
                                    <td align="left">
                                        <label>
                                            <asp:Label ID="Label53" runat="server" Font-Bold="false" Font-Size="12px" Text="Sorry, we cannot locate your employee number and employee security code in our system."></asp:Label>
                                            <asp:Label ID="Label54" runat="server" Font-Bold="false" Font-Size="12px" Text="Please try again."></asp:Label>
                                            <br />
                                            <asp:Label ID="Label55" runat="server" Font-Bold="false" Font-Size="12px" Text="If you are a new employee, please consult with your supervisor to ensure that your employee number and barcode are updated in our system."></asp:Label>
                                        </label>
                                    </td>
                                </tr>
                            </table>
        ...
        <div>
                ...
                <table id="Table10" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            <label>
                                <asp:Label ID="Label58" runat="server" Text="" Font-Names="Verdana" Font-Size="12px"></asp:Label>
                                ,
                            </label>
                            <label>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="(Please note that you can do presence entry only once a day)"></asp:Label>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
            ...
            <asp:Panel ID="Panel88" runat="server" BackColor="#d1cec5" BorderWidth="7px" Width="450px">
                <table id="Table22" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            ...
                            <label>
                                <asp:Label ID="Label56" runat="server" Text="" Font-Names="Verdana" Font-Size="12px"></asp:Label>
                            </label>
                            <label>
                    ...
                    <tr>
                        <td>
                            ...
                            <label>
                                <asp:Label ID="Label57" runat="server" Text="" Font-Names="Verdana" Font-Size="12px"></asp:Label>
                                ,
                            </label>
                            <label>
            ...
            <cc1:ModalPopupExtender ID="ModalPopupExtender1223" runat="server" BackgroundCssClass="modalBackground"
                PopupControlID="Panel88" TargetControlID="HiddenButton2222">
                        ...
                        <asp:Panel ID="Panelmsg" runat="server" CssClass="modalPopup" BorderWidth="7px" BackColor="#d1cec5"
                            Width="450px" Height="100px">
                            <table id="Table13" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td>
                                    </td>
                                </tr>
                        ...
                        <cc1:ModalPopupExtender ID="ModalPopupExtender123" runat="server" BackgroundCssClass="modalBackground"
                            PopupControlID="Panelmsg" TargetControlID="btnlblmsg">
                        </cc1:ModalPopupExtender>
