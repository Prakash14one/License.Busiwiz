<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master" AutoEventWireup="true" CodeFile="documentflagmaster.aspx.cs" Inherits="ShoppingCart_Admin_documentflagmaster" Title="Untitled Page" %>
            ...
            <div class="products_box">
                <fieldset>
                    ...
                    <div style="float: right;">
                        <asp:Button ID="btnadddd" runat="server" Text="Add New Document Flag Name" Width="180px" 
                    ...
                    <asp:Panel ID="pnladdd" runat="server" Visible="false">
                        <table width="100%">                           
                            <tr>
                                <td class="style5">
                                    <label>
                                        <asp:Label ID="lbllogo" runat="server" Text="Document Flag Name"></asp:Label>
                                        <asp:Label ID="Label8" runat="server" CssClass="labelstar" Text="*"> </asp:Label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtdocumentflagname"
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server" SetFocusOnError="true"
                                            ErrorMessage="invalid document flag name" ValidationExpression="^([a-zA-Z0-9,.\s]*)"
                                            ControlToValidate="txtdocumentflagname" ValidationGroup="1"></asp:RegularExpressionValidator>
                                    </label>
                                </td>
                                <td style="width: 25%">
                                    <asp:TextBox ID="txtdocumentflagname"  MaxLength="50" runat="server" onKeydown="return mask(event)"
                ...
                <fieldset>
                    <legend>
                        <asp:Label ID="Label44" runat="server" Text="List of Document Flag Name"></asp:Label>
                    </legend>
                         <div style="float: right">
                    ...
                    <asp:Panel ID="pnlgrid" runat="server" Width="100%">
                            ...
                            <table width="850Px">
                                <tr align="center">
                                    <td align="center" style="text-align: center; font-size: 18px; font-weight: bold;">
                                        <asp:Label ID="Label45" runat="server" Font-Italic="true" Text="List of Document Flag Name"></asp:Label>
                                    </td>
                                </tr>                            
                            </table>
                        </div>
                        <table width="100%">
                            <tr>
                                <td>
                                                <asp:GridView ID="grddocumentflagmaster" DataKeyNames="id" runat="server" AlternatingRowStyle-CssClass="alt"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Document Flag Name" HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblsecquestion" runat="server" Text='<%# Eval("documentflagname") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>                                            
