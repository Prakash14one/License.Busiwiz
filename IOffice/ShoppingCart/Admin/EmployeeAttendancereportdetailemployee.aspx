<%@ Page Title="" Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="EmployeeAttendanceReportDetailemployee.aspx.cs"
    Inherits="Add_Employee_Attendance_Report_Detail" %>
            ...
            <div class="products_box">
                <fieldset>
                    ...
                    <label>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txteenddate"
                    ...
                    <label>
                        ...
                        <cc1:CalendarExtender ID="Calendarextender51" runat="server" PopupButtonID="txtenddateto"
                            TargetControlID="txtenddateto" Format="MM/dd/yyyy">
                        </cc1:CalendarExtender>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtenddateto"
                            ErrorMessage="*" ValidationGroup="4"> </asp:RequiredFieldValidator>
                ...
                <fieldset>
                    <legend>
                        <asp:Label ID="Label12" runat="server" Text="List of Employee Attendance"></asp:Label></legend>
                    ...
                    <asp:Panel ID="pnlgrid" runat="server" Width="100%">
                        <table width="100%">
                                ...
                                <td>
                                    <div id="mydiv" class="closed">
                                        <table width="100%" style="color: Black; font-style: italic; text-align: center">
                                            <tr>
                                                <td align="center">
                                                    <asp:Label ID="lblcompanyname" Font-Bold="true" runat="server" Font-Size="20px" Visible="false"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gridattendance" runat="server" AutoGenerateColumns="False" DataKeyNames="AttendanceId"
                                        AllowPaging="True" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                        Width="100%" AllowSorting="True" EmptyDataText="No Record Found." OnRowCommand="gridattendance_RowCommand"
                                        OnPageIndexChanging="gridattendance_PageIndexChanging" PageSize="15" OnSorting="gridattendance_Sorting">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Batch Name" SortExpression="BatchName" HeaderStyle-HorizontalAlign="Left"
                                                ItemStyle-Width="15%">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Employee Name" SortExpression="EmployeeName" ItemStyle-Width="25%"
                                                HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Regular Start Time" ItemStyle-Width="7%" SortExpression="InTime"
                                                HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Late/Early In Time" ItemStyle-Width="7%" SortExpression="LateInMinuts"
                                                HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Regular Out Time" ItemStyle-Width="7%" SortExpression="OutTime"
                                                HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Late/Early Out Time" ItemStyle-Width="7%" SortExpression="OutInMinuts"
                                                HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Total Work Hour" SortExpression="TotalHourWork" ItemStyle-Width="7%"
                                                HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Approved" SortExpression="approve" ItemStyle-Width="3%"
                                                HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderImageUrl="~/Account/images/viewprofile.jpg" ItemStyle-Width="2%"
                                                Visible="False">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="lbladdd" runat="server" CommandArgument='<%# Eval("AttendanceId") %>'
