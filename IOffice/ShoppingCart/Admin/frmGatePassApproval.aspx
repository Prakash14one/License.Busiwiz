<%@ Page Title="" Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="frmGatePassApproval.aspx.cs" Inherits="Add_frmgatepass_approval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="products_box">
        ...
        <fieldset>
            ...
            <asp:Panel ID="panelin" runat="server" Visible="false">
                <label>
        ...
        <fieldset>
            ...
            <asp:GridView ID="GridView1" runat="server" DataKeyNames="Id" GridLines="None" AllowPaging="true"
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="Edit" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="4%" Visible="false">
                        <ItemTemplate>
