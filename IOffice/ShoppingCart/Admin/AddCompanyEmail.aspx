<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="AddCompanyEmail.aspx.cs" Inherits="Account_AddCompanyEmail"
    Title="Untitled Page" %>
            ...
            <div class="products_box">
                <fieldset>
                    ...
                    <div style="float: right;">
                        <asp:Button ID="btnadddd" runat="server" Text="Add New Company Email" CssClass="btnSubmit"
                        ...
                        <table width="100%">
                            ...
                            <asp:Panel ID="pnle" Width="100%" runat="server" Visible="false">
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <label>
                                            <asp:DropDownList ID="ddlemp" runat="server" AutoPostBack="false">
                                            </asp:DropDownList>
                                        </label>
                                    </td>
                                </tr>
                                ...
                                <td colspan="2">
                                    <label>
                                        <asp:TextBox ID="txtuser" runat="server" ValidationGroup="6" onKeydown="return mask(event)"
                                            ...
                                            MaxLength="50" OnTextChanged="txtuser_TextChanged"></asp:TextBox>
                                    </label>
                                    <label>
                ...
                <fieldset>
                    <legend>
                        <asp:Label ID="Label25" runat="server" Text="List of Email Accounts of the Company"></asp:Label>
                    </legend>
                    <table width="100%">
                        <tr>
                            <td>
