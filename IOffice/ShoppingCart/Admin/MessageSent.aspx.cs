...
public partial class Account_MessageSent : System.Web.UI.Page
{
    SqlConnection con;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["PageName"] = "MessageSent.aspx";
    ...
    protected void SelectMsgforSendBox()
    {
        ...
        //dt = clsMessage.SelectMsgforSendBox(Convert.ToInt32(Session["PartyId"].ToString()));
        ...
        if (Convert.ToString(Request.QueryString["partyid"]) != null)
        {
            strff = " and [MsgDetail].[ToPartyId]='" + Request.QueryString["partyid"].ToString() + "'";
        }

        string mes = " " + PageConn.intmsg11 + ".dbo.MsgMaster.MsgDate, " + PageConn.intmsg11 + ".dbo.MsgMaster.MsgSubject, " + PageConn.intmsg11 + ".dbo.MsgMaster.FromPartyId, " + PageConn.intmsg11 + ".dbo.MsgMaster.MsgId, " + PageConn.intmsg11 + ".dbo.MsgMaster.MsgStatus FROM " + PageConn.intmsg11 + ".dbo.MsgDetail INNER JOIN " + PageConn.intmsg11 + ".dbo.MsgMaster ON " + PageConn.intmsg11 + ".dbo.MsgDetail.MsgId = " + PageConn.intmsg11 + ".dbo.MsgMaster.MsgId INNER JOIN " + PageConn.intmsg11 + ".dbo.MsgStatusMaster ON " + PageConn.intmsg11 + ".dbo.MsgDetail.MsgStatusId = " + PageConn.intmsg11 + ".dbo.MsgStatusMaster.MsgStatusId LEFT OUTER JOIN Party_master ON " + PageConn.intmsg11 + ".dbo.MsgDetail.ToPartyId = Party_master.PartyId WHERE (" + PageConn.intmsg11 + ".dbo.MsgMaster.FromPartyId = '" + Convert.ToInt32(Session["PartyId"].ToString()) + "') AND ( " + PageConn.intmsg11 + ".dbo.MsgMaster.MsgStatus != 'Deleted' or " + PageConn.intmsg11 + ".dbo.MsgMaster.MsgStatus is null )and " + PageConn.intmsg11 + ".dbo.MsgDetail.MsgStatusId not in(3) " + mes1 + " " + mes2 + " " + mes3 + " " + mes4 + " " + mes5 + " " + mes6 + " " + mes7 + " " + mes8 + " " + mes9 + " " + mes10 + " " + mes11 + " " + mes12 + " " + mes13 + " " + mes14 + " " + mes15 + " " + mes16 + " " + mes17 + " " + strff + "";
        ...
        {
            DataTable dt = GetDataPage(grdSentMailList.PageIndex, grdSentMailList.PageSize, sortExpression, mes);
