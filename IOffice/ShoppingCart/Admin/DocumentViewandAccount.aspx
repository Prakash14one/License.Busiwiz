<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile ="~/Master/LicenseMaster.master"
    CodeFile="DocumentViewandAccount.aspx.cs" Inherits="DocumentViewandAccount" %>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td>
                                ...
                                <label>
                                    <asp:Label ID="Label4" runat="server" Text=" Top " Visible="False"></asp:Label>
                                </label>
                                <label>
                                    <asp:TextBox ID="TextBox1" runat="server" Width="40px" MaxLength="5" AutoPostBack="True"
                                        OnTextChanged="TextBox1_TextChanged" Visible="False">25</asp:TextBox>
                                </label>
                                <label>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    ...
                                    <label>
                                        <asp:Button ID="btnaccprivi" runat="server" Text="Previous" OnClick="btnaccprivi_Click" />
                                    </label>
                                    <label>
                                        <asp:Button ID="Button1" runat="server" Text="Save & Next" OnClick="Button1_Click" />
                                    </label>
                                    <label>
                                        <asp:Button ID="btnaccnext" runat="server" Text="Next" OnClick="btnaccnext_Click" />
                                    </label>
                                </td>
                            </tr>
                        </table>
