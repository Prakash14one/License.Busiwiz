<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="PolicyCategoryTitle.aspx.cs" Inherits="ShoppingCart_Admin_PolicyCategoryTitle"
    Title="Untitled Page" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="products_box">
                    ...
                    <asp:Panel ID="Pnladdnew" runat="server" Visible="false">
                        <table width="100%">
                                ...
                                <td style="width: 70%">
                                    <label>
                                        <asp:DropDownList ID="ddlWarehouse" runat="server" AutoPostBack="True" ValidationGroup="1"
                                            OnSelectedIndexChanged="ddlWarehouse_SelectedIndexChanged" Width="250px">
                                        </asp:DropDownList>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 30%">
                                    <label>
                                        <asp:Label runat="server" ID="Label2" Text="Policy Category Name"></asp:Label>
                            ...
                            <tr>
                                <td style="width: 30%">
                                    <label>
                                        <asp:Label runat="server" ID="Label3" Text="Policy Title" Visible="true"></asp:Label>
                ...
                <fieldset>
                    <legend>
                        <asp:Label runat="server" ID="Label6" Text="   List of Policy Categories" Visible="true"></asp:Label>
                    </legend>
                    <div style="float: right;">
                    ...
                    <label>
                        <asp:Label runat="server" ID="Label8" Text="Policy Category Name"></asp:Label>
                    </label>
                    <label>
                                        ...
                                        <table width="100%">
                                            ...
                                            <tr align="center">
                                                <td align="center" style="text-align: center; font-size: 18px; font-weight: bold;">
                                                    <asp:Label ID="Label9" runat="server" Font-Italic="True" Text="List of Policy Categories"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                            ...
                            <tr>
                                <td colspan="2">
                                    <cc11:PagingGridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                        ...
                                        OnSorting="GridView1_Sorting" PageSize="10" OnPageIndexChanging="GridView1_PageIndexChanging">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Policy Title ID" SortExpression="Id" ItemStyle-Width="8%"
                                                HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpolicytitleid123" runat="server" Text='<%# Eval("Id") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle Width="8%" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Business Name" SortExpression="WName" ItemStyle-Width="15%"
                                                HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Policy Category" SortExpression="Policyprocedurecategory"
                                            ...
                                            <asp:TemplateField HeaderText="Policy Title" SortExpression="PolicyTitle" ItemStyle-Width="55%"
                                                HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <%--<asp:ButtonField CommandName="Edit" HeaderText="Edit" Visible="false" Text="Edit"
                                                ButtonType="Image" HeaderStyle-HorizontalAlign="Left" HeaderImageUrl="~/Account/images/edit.gif"
                                                ImageUrl="~/Account/images/edit.gif" ItemStyle-Width="2%">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle Width="2%" />
                                            </asp:ButtonField>
                                            <asp:ButtonField CommandName="Delete" HeaderText="Delete" Text="Delete" Visible="false"
                                                ButtonType="Image" HeaderStyle-HorizontalAlign="Left" HeaderImageUrl="~/ShoppingCart/images/trash.jpg"
                                                ImageUrl="~/Account/images/delete.gif" ItemStyle-Width="3%">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle Width="3%" />
                                            </asp:ButtonField>--%>
                                        </Columns>
