<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    AutoEventWireup="true" CodeFile="MessageDraftsExt.aspx.cs" Inherits="Account_MessageDraftsExt"
    Title="Untitled Page" %>
...
function ChangeCheckBoxState(id, checkState)
    ...
    <div class="products_box">
        ...
        <asp:Panel ID="panelemails" runat="server" Height="172px" ScrollBars="Vertical" Width="320px">
            <table>
                <tr>
                    <td>
                        <label>
        ...
        <table width="100%">
            <tr>
                <td style="width: 150px">
                    <label>
                        <asp:Label ID="Label1" runat="server" Text="Draft" Font-Size="Large" Font-Bold="false"></asp:Label>
                    </label>
                </td>
                <td>
                    <table width="100%">
                                    ...
                                    <table width="100%">
                                                    ...
                                                    <table width="100%">
                                                        <tr align="center">
                                                            <td align="center" style="text-align: center; font-size: 18px; font-weight: bold;">
                                                                <asp:Label ID="Label28" runat="server" Font-Italic="True" Text="List of External Message Drafts"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                        ...
                                        <tr>
                                            <asp:Panel ID="Panel2" runat="server">
                                                <td align="left">
                                                    <cc11:PagingGridView ID="gridDraft" runat="server" CssClass="mGrid" PagerStyle-CssClass="pgr"
                                                        AlternatingRowStyle-CssClass="alt" DataKeyNames="MsgId" GridLines="Both" AutoGenerateColumns="False"
                                                        AllowPaging="True" OnPageIndexChanging="gridDraft_PageIndexChanging" OnRowCommand="gridDraft_RowCommand"
                                                        OnRowDataBound="gridDraft_RowDataBound" EmptyDataText="There is no Message."
                                                        Width="100%">
                                                        <Columns>
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                HeaderStyle-Width="5%">
