<%@ Page Title="" Language="C#" MasterPageFile="~/Master/LicenseMaster.master"
    EnableEventValidation="false" AutoEventWireup="true" CodeFile="PolicyaddmanageView.aspx.cs"
            ...
            <div class="products_box">
                <fieldset>
                    ...
                    <div style="float: right;">
                        <asp:Button ID="btnadd" runat="server" CssClass="btnSubmit" Text="Add Policy" OnClick="btnadd_Click" Visible="false"  />
                    </div>
                    <div style="clear: both;">
                    </div>
                        ...
                        <table id="temp1" cellpadding="0" cellspacing="3" style="width: 100%">
                                ...
                                <td style="width: 70%">
                                    ...
                                    <label>
                                        <asp:ImageButton ID="imgadd" runat="server" Height="20px" ImageUrl="~/ShoppingCart/images/AddNewRecord.jpg"
                                           Visible="false" ToolTip="AddNew" Width="20px" ImageAlign="Bottom" OnClick="imgadd_Click" /></label>
                                    <label>
                                ...
                                <td style="width: 70%">
                                    ...
                                    <label>
                                        <asp:ImageButton ID="imgaddtitle" runat="server" Height="20px" ImageUrl="~/ShoppingCart/images/AddNewRecord.jpg"
                                         Visible="false"   ToolTip="AddNew" Width="20px" ImageAlign="Bottom" OnClick="imgaddtitle_Click" /></label>
                                    <label>
                            ...
                            <tr>
                                ...
                                <td style="width: 70%">
                                    ...
                                    <label>
                                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/ShoppingCart/images/cal_actbtn.jpg" Visible="false" />
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 70%">
                                    ...
                                    <label>
                                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/ShoppingCart/images/cal_actbtn.jpg" Visible="false" />
                                    </label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <br />
                               ...
                               <div align="left">
                                ...
                                <td align="left" style="width: 70%;">
                                <label>
                                    <asp:CheckBox ID="CheckBox1" runat="server" Text="Do you wish to attach any audio/Video/Document File "  oncheckedchanged="CheckBox1_CheckedChanged" AutoPostBack="True" Visible="false"   />
                                </label>
                            </td>
                            </tr>
                            <tr>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td align="left" width="25%">
                                                <label>
                                                    <asp:DropDownList ID="ddlfilterstore" runat="server" Width="210px" AutoPostBack="true"  OnSelectedIndexChanged="ddlfilterstore_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </label>
                                            </td>
                                                ...
                                                <cc11:PagingGridView ID="grid" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Policy Name" ItemStyle-Width="30%" SortExpression="PolicyName"
                                                         ...
                                                         <asp:TemplateField HeaderText="Docs" ItemStyle-Width="7%"  HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="#333333"  onclick="LinkButton1_Click"></asp:LinkButton>
                                                        </ItemTemplate>
                                                         <HeaderStyle HorizontalAlign="Left" />
                                                         <ItemStyle Width="7%" />
                                                    </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Version" ItemStyle-Width="6%" SortExpression="Version"  Visible="true" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderImageUrl="~/Account/images/viewprofile.jpg" HeaderStyle-HorizontalAlign="Left"
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="lbladdd" runat="server" CommandArgument='<%# Eval("Id") %>'
                                                                    CommandName="Edit" ToolTip="View Profile" Height="20px" Width="20px" ImageUrl="~/Account/images/viewprofile.jpg">
                                                                </asp:ImageButton>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                            <ItemStyle Width="2%" />
                ...
                <table width="100%">
                    <tr>
                        <td>
                            ...
                            <cc1:ModalPopupExtender ID="ModalPopupExtenderAddnew" runat="server" BackgroundCssClass="modalBackground" Enabled="True" PopupControlID="Panel21" TargetControlID="HiddenButton222" X="700" Y="270">
