<%@ Page Language="C#" MasterPageFile="~/ShoppingCart/Admin/Master/mp_Admin.master"
    AutoEventWireup="true" CodeFile="CandidateApplicationStatus.aspx.cs" Inherits="ShoppingCart_Admin_CandidateApplicationStatus"
    Title="Untitled Page" %>
                                ...
                                <td>
                                    <label>
                                        <asp:TextBox ID="txtshortname" MaxLength="150" runat="server" onKeydown="return mask(event)"
                                            onkeyup="return check(this,/[\\/#?@&$%_^:!*'-<>+;=(){}[]|\/]/g,/^[\a-zA-Z0-9,.\s]+$/,'Span1',150)"></asp:TextBox>
                                    </label>
                                    <label>
                                    ...
                                    <asp:GridView ID="grdsecquestuion" DataKeyNames="id" runat="server" AlternatingRowStyle-CssClass="alt"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Status Short Name" HeaderStyle-Width="30%"
                                                HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblsecdquestion" runat="server" Text='<%# Eval("StatusShortName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
