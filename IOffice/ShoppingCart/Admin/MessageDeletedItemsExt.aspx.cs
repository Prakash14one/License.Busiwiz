...
public partial class Account_MessageDeletedItemsExt : System.Web.UI.Page
{
    SqlConnection con;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["PageName"] = "MessageDeletedItemsExt.aspx";
    ...
    protected void SelectMsgforDeleteBox()
    {
        ...
        if (TextBox1.Text != "")
        {
            mes1 += " and ((" + PageConn.extmsg11 + ".dbo.MsgMasterExt.MsgDate like '%" + TextBox1.Text.Replace("'", "''") + "%') or (" + PageConn.extmsg11 + ".dbo.MsgMasterExt.MsgSubject like '%" + TextBox1.Text.Replace("'", "''") + "%') or (" + PageConn.extmsg11 + ".dbo.MsgDetailExt.ToPartyId like '%" + TextBox1.Text.Replace("'", "''") + "%') or (Party_Master.Compname like '%" + TextBox1.Text.Replace("'", "''") + "%'))";
        }
        ...
        str = " " + PageConn.extmsg11 + ".dbo.MsgMasterExt.MsgDate, " + PageConn.extmsg11 + ".dbo.MsgMasterExt.MsgSubject,Party_Master.Compname," + PageConn.extmsg11 + ".dbo.MsgStatusMasterExt.MsgStatusName, " + PageConn.extmsg11 + ".dbo.MsgDetailExt.MsgDetailId, " + PageConn.extmsg11 + ".dbo.MsgDetailExt.ToPartyId, " + PageConn.extmsg11 + ".dbo.MsgDetailExt.MsgStatusId FROM " + PageConn.extmsg11 + ".dbo.MsgDetailExt INNER JOIN " + PageConn.extmsg11 + ".dbo.MsgMasterExt ON " + PageConn.extmsg11 + ".dbo.MsgDetailExt.MsgId = " + PageConn.extmsg11 + ".dbo.MsgMasterExt.MsgId INNER JOIN " + PageConn.extmsg11 + ".dbo.MsgStatusMasterExt ON " + PageConn.extmsg11 + ".dbo.MsgDetailExt.MsgStatusId = " + PageConn.extmsg11 + ".dbo.MsgStatusMasterExt.MsgStatusId INNER JOIN Party_Master ON " + PageConn.extmsg11 + ".dbo.MsgMasterExt.FromPartyId = Party_Master.PartyId WHERE ((" + PageConn.extmsg11 + ".dbo.MsgMasterExt.FromEmail = '" + ViewState["lb"] + "')) AND (" + PageConn.extmsg11 + ".dbo.MsgDetailExt.MsgStatusId IN (4)) " + mes1 + " " + mes2 + " " + mes3 + " " + mes3 + " " + mes4 + " " + mes5 + " " + mes6 + " " + mes7 + " " + mes8 + " " + mes9 + " " + mes10 + " " + mes11 + " " + mes12 + " " + mes13 + " " + mes14 + " " + mes15 + " " + mes16 + " " + mes17 + " " + mes18 + " " + mes19 + "";
        //ORDER BY MsgMasterExt.MsgDate DESC";
        ...
        //{
        //    //dt = clsMessage.SelectMsgforDeleteBoxExt(Convert.ToInt32(Session["PartyId"].ToString()));

        //    str = "SELECT MsgMasterExt.MsgDate, MsgMasterExt.MsgSubject,Party_Master.Compname,MsgStatusMasterExt.MsgStatusName, MsgDetailExt.MsgDetailId, MsgDetailExt.ToPartyId, MsgDetailExt.MsgStatusId FROM MsgDetailExt INNER JOIN MsgMasterExt ON MsgDetailExt.MsgId = MsgMasterExt.MsgId INNER JOIN MsgStatusMasterExt ON MsgDetailExt.MsgStatusId = MsgStatusMasterExt.MsgStatusId INNER JOIN Party_Master ON MsgMasterExt.FromPartyId = Party_Master.PartyId WHERE (MsgDetailExt.ToPartyId = '" + Convert.ToInt32(Session["PartyId"].ToString()) + "') and MsgMasterExt.FromEmail='" + ddlempemail.SelectedItem.Text + "' AND (MsgDetailExt.MsgStatusId IN (4)) " + mes1 + " " + mes2 + " " + mes3 + " " + mes3 + " " + mes4 + " " + mes5 + " " + mes6 + " " + mes7 + " " + mes8 + " " + mes9 + " " + mes10 + " " + mes11 + " " + mes12 + " " + mes13 + " " + mes14 + " " + mes15 + " " + mes16 + " " + mes17 + " " + mes18 + " " + mes19 + " ORDER BY MsgMasterExt.MsgDate DESC";
        ...
        ////   dt = clsMessage.SelectMsgforDeleteBoxExt(Convert.ToInt32(dtorgeml.Rows[0][1].ToString()));

        //    str = "SELECT MsgMasterExt.MsgDate, MsgMasterExt.MsgSubject,Party_Master.Compname,MsgStatusMasterExt.MsgStatusName, MsgDetailExt.MsgDetailId, MsgDetailExt.ToPartyId, MsgDetailExt.MsgStatusId FROM MsgDetailExt INNER JOIN MsgMasterExt ON MsgDetailExt.MsgId = MsgMasterExt.MsgId INNER JOIN MsgStatusMasterExt ON MsgDetailExt.MsgStatusId = MsgStatusMasterExt.MsgStatusId INNER JOIN Party_Master ON MsgMasterExt.FromPartyId = Party_Master.PartyId WHERE MsgMasterExt.FromEmail='" + ddlempemail.SelectedItem.Text + "' AND (MsgDetailExt.MsgStatusId IN (4)) " + mes1 + " " + mes2 + " " + mes3 + " " + mes3 + " " + mes4 + " " + mes5 + " " + mes6 + " " + mes7 + " " + mes8 + " " + mes9 + " " + mes10 + " " + mes11 + " " + mes12 + " " + mes13 + " " + mes14 + " " + mes15 + " " + mes16 + " " + mes17 + " " + mes18 + " " + mes19 + " ORDER BY MsgMasterExt.MsgDate DESC";
        //    SqlDataAdapter da = new SqlDataAdapter(str, con);
        //    da.Fill(dt);
        ...
        {
            DataTable dt = GetDataPage(gridDelete.PageIndex, gridDelete.PageSize, sortExpression, str);
...
" CompanyEmailAssignAccessRights  on InOutCompanyEmail.ID=CompanyEmailAssignAccessRights.CompanyEmailId  where CompanyEmailAssignAccessRights.CompanyEmailId in(select CompanyEmailAssignAccessRights.CompanyEmailId from CompanyEmailAssignAccessRights where EmployeeId='" + Convert.ToInt32(Session["EmployeeIdep"]) + "' and Viewrights='true' and sendrights='true' and deleterights='true')");
                ...
                if (gridDelete.Rows.Count > 0)
                {
                    foreach (GridViewRow GR in gridDelete.Rows)
                    {
                        ...
                        if (chk.Checked == true)
                        {
                            ...
                            UpdateMsgDetail = clsMessage.UpdateMsgDetailExt(MsgDetailId, 1);
                        }
                    }
        ...
        if (gridDelete.Rows.Count > 0)
        {
            foreach (GridViewRow GR in gridDelete.Rows)
            {
                ...
                if (chk.Checked == true)
                {
                    ...
                    bool MsgMasterDelete = clsMessage.DeleteMsgMasterExt(MsgId);
    ...
    protected void fillextraemail()
    {
        ...
        string str = "select Distinct InOutCompanyEmail.ID as CompanyEmailId,InOutCompanyEmail.InEmailID as EmailId  from InOutCompanyEmail inner join " +
                        ...
                        "where EmployeeId='" + Convert.ToInt32(Session["EmployeeIdep"]) + "' and DeleteRights='true')";
        SqlDataAdapter da = new SqlDataAdapter(str, con);
        DataTable dt = new DataTable();
        da.Fill(dt);
