...
using System.IO;
public partial class ShoppingCart_Admin_EmployeeLogin : System.Web.UI.Page
{
    string timezone = "";
    string plusminus = "";
    //SqlConnection con;
    ...
    SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["LicenseBusiwizConnectionString"].ConnectionString);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //ViewState["Compid"] = "35";// ss.ToString();
            //Session["EmployeeId"] = "31330";
            ...
            txtestartdate.Text = System.DateTime.Now.ToString();
            fillreminderstatus();
            fillreminder();
            BindGrid123();
            fillteryear();
    ...
    protected void FillGrid()
    {
        ...
        string strcln = @"SELECT ProjectMaster.ProjectId as ProjectMaster_Id,Left(ProjectMaster.ProjectName, 50) as ProjectMaster_ProjectTitle ,ProjectMaster.Description as ProjectMaster_ProjectDescription ,ProjectMaster.EmployeeID as ProjectMaster_Employee_Id, 
                         ProjectMaster.Estartdate AS ProjectMaster_StartDate ,ProjectMaster.Eenddate as ProjectMaster_EndDate,ProjectMaster.Eenddate as ProjectMaster_TargetEndDate,ProjectMaster.Status as ProjectMaster_ProjectStatus,
                         EmployeeMaster.EmployeeName FROM ProjectMaster  INNER JOIN EmployeeMaster ON EmployeeMaster.EmployeeMasterID = ProjectMaster.EmployeeID WHERE EmployeeMaster.Active=1  ";

        strcln += "AND ProjectMaster.EmployeeID ='" + Session["EmployeeId"].ToString() + "'";
        strcln += " AND ProjectMaster.Status='Pending'";
        strcln += " ORDER BY Eenddate  desc";
    ...
    protected void grdmonthlygoal_RowCommand1(object sender, GridViewCommandEventArgs e)
    {
            ...
            if (e.CommandName == "View")
            {
                ...
                //Session["proid"] = i;
                //SqlDataAdapter da = new SqlDataAdapter("SELECT * From ProjectMaster inner join DesignationMaster on DesignationMaster.Id = ProjectMaster.ProjectMaster_DeptId inner join EmployeeMaster on EmployeeMaster.Id = ProjectMaster.ProjectMaster_Employee_Id where ProjectMaster.ProjectMaster_Id='" + i + "'", connection);
                //DataTable dt = new DataTable();
                //da.Fill(dt);
                //Session["lbldep"] = dt.Rows[0]["ProjectMaster_DeptId"].ToString();
                //Session["lblemp"] = dt.Rows[0]["ProjectMaster_Employee_Id"].ToString();

                string te = "FrmMyProjectevalution.aspx";
            ...
            if (e.CommandName == "view111")
            {
                ...
                Session["viewid"] = mkl;
                string te = "http://license.busiwiz.com/clientadmin/ViewEmployeeProjectStatusLB.aspx?id=" + mkl;
                ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", "window.open('" + te + "');", true);
            }
    ...
    protected void grdmonthlygoal_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string strcln = " SELECT  * from  ProjectMaster where ProjectId='" + lblproId.Text + "' ";
                SqlCommand cmdcln = new SqlCommand(strcln, con);
                DataTable dtcln = new DataTable();
                SqlDataAdapter adpcln = new SqlDataAdapter(cmdcln);
                adpcln.Fill(dtcln);
                string www = dtcln.Rows[0]["Eenddate"].ToString();
    ...
    protected void BindGrid123()
    {
        ...
        if (dtt2.Rows.Count > 0)
        {
            ...
            str += " and TaskAllocationMaster.TaskAllocationDate='" + txtestartdate.Text + "'";
    ...
    protected void GridView9_RowCommand1(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Send")
        {
            ...
            GridView11.DataSource = dtcrNew11;
            GridView11.DataBind();
    ...
    protected void BindGrid()
    {
        ...
        string strr = "Select WMaster.MasterId,Week.Name as Week,WMaster.title,Year.Id,Month.Id,Week.Id from Week inner join  WMaster on WMaster.Week=Week.Id inner join month on month.id=week.Mid inner join year on year.id=Month.Yid where WMaster.BusinessID='" + Convert.ToString(dtem.Rows[0]["warehouseid"]) + "' and WMaster.EmployeeID='" + Session["EmployeeId"] + "' " + st1 + "";

        SqlDataAdapter dale = new SqlDataAdapter(strr, con);
        DataTable dtle = new DataTable();
        dale.Fill(dtle);

        grid.DataSource = dtle;
        grid.DataBind();
    }
    ...
    protected void currentpayhour()
    {
        ...
        //if (dt11.Rows.Count > 0)
        //{
        //    string str = "select AttendenceEntryMaster.*,Convert(nvarchar,AttendenceEntryMaster.Date,101) as AtDate from AttendenceEntryMaster  where EmployeeID='" + Session["EmployeeId"] + "' and AttendenceEntryMaster.Date between '" + dt11.Rows[0]["PayperiodStartDate"] + "' and '" + dt11.Rows[0]["PayperiodEndDate"] + "' and Varify='1' order by AttendenceEntryMaster.Date Desc";
        ...
        //            DateTime dtdate = Convert.ToDateTime(item["AtDate"].ToString());
    ...
    {
        //DataTable dt11 = (DataTable)select("Select Distinct  Convert(nvarchar,PayperiodStartDate,101) as PayperiodStartDate, Convert(nvarchar,PayperiodEndDate,101) as PayperiodEndDate from  payperiodtype inner join payperiodMaster  on payperiodtype.Id=payperiodMaster.PayperiodTypeID inner join EmployeePayrollMaster on EmployeePayrollMaster.PayPeriodMasterId=payperiodtype.Id where EmployeePayrollMaster.EmpId='" + Session["EmployeeId"] + "' and Whid='" + ddlwarehouse.SelectedValue + "'");
        //if (dt11.Rows.Count > 0)
        //{
    ...
    protected void txtestartdate_TextChanged(object sender, EventArgs e)
    {
        BindGrid123();
    }


    private void BindGridpendingpro()
    {
        ...
        ////{
        ////    if (Convert.ToInt32(DropDownList9.SelectedValue) > 0)
        ////    {
        ////        st1 = " and projectmaster.DeptId='" + DropDownList9.SelectedValue + "' and projectmaster.EmployeeId>'0'";
        ////    }
        ////    else
        ////    {
        ...
        ////else
        ////{
        ////    st1 = " and projectmaster.EmployeeId='" + Session["EmployeeId"].ToString() + "'";
        ////}
        ////if (DropDownList11.SelectedIndex != 0)
        ////{
        ////    st1 += " and projectmaster.Status='Pending'";
        ////}
        ...
        //else
        //{
        //    st1 = " and projectmaster.EmployeeId='" + DropDownList10.SelectedValue + "'";
        //}
        //if (DropDownList11.SelectedIndex > 0)
        //{
        //    st1 += " and projectmaster.Status='Pending'";
        ...
        ////foreach (GridViewRow gvbn in GridView12.Rows)
        ////{

        ////    if (GridView12.Rows.Count > 0)
        ////    {
        ////        Label endadte = (Label)gvbn.FindControl("lbltargetedate");
        ////        if (Convert.ToDateTime(endadte.Text) < System.DateTime.Today)
        ////        {
        ////            endadte.ForeColor = System.Drawing.Color.Red;
        ...
        ////GridViewRow dr = (GridViewRow)GridView8.FooterRow;
    ...
    {
        string te = "Mytodaystask.aspx?ID=" + txtestartdate.Text;
        ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", "window.open('" + te + "');", true);
    }


    protected void ddlgoals_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlgoals.SelectedValue == "0")
        {
            panel45.Visible = true;
            panel777.Visible = false;
        }
        //if (ddlgoals.SelectedValue == "1")
        //{
        //    panel45.Visible = false;
        //    panel777.Visible = true;
        //}
    }
  ...
  DropDownList7_SelectedIndexChanged(sender, e);
    ...
    protected void Filteremployee1()
    {
        //DropDownList2.Items.Clear();

        //if (DropDownList1.SelectedIndex > -1)
        //{
        //    SqlDataAdapter da = new SqlDataAdapter("select employeemasterid,employeename from employeemaster where DeptID='" + DropDownList1.SelectedValue + "' and employeemasterid='" + Convert.ToInt32(Session["EmployeeId"]) + "'", con);
        //    DataTable dt = new DataTable();
        //    da.Fill(dt);

        //    DropDownList5.DataSource = dt;
        //    DropDownList5.DataTextField = "employeename";
        //    DropDownList5.DataValueField = "employeemasterid";
    ...
    private void BindGrid1()
    {
        ...
        {
            st1 += " and year.id='" + DropDownList6.SelectedValue + "'";
        }

        if (DropDownList7.SelectedIndex > 0)
        {
            st1 += " and Month.Monthid='" + DropDownList7.SelectedValue + "'";
        }
        ...
        string strr = "Select MMaster.MasterId,Month.Name as Month,MMaster.title from Month inner join  MMaster on  MMaster.Month=Month.Id inner join year on year.id=Month.Yid where  MMaster.BusinessID='" + Convert.ToString(dtem.Rows[0]["warehouseid"]) + "' and MMaster.EmployeeID='" + Session["EmployeeId"] + "' " + st1 + "";
    ...
    protected void filtermonthly()
    {
        ...
        {
            SqlDataAdapter dafa = new SqlDataAdapter("Select Month.Id,Month.MonthId, Year.Name+ ' -> ' + Month.Name AS yeayrmonth from dbo.Month INNER JOIN dbo.Year ON dbo.Month.Yid = dbo.Year.Id where Year.Name='" + DropDownList4.SelectedItem.Text + "' Order by Year.Name, Month.Id", con);
            DataTable dtfa = new DataTable();
            dafa.Fill(dtfa);

            DropDownList7.DataSource = dtfa;
            DropDownList7.DataMember = "yeayrmonth";
            DropDownList7.DataTextField = "yeayrmonth";
            DropDownList7.DataValueField = "MonthId";
    ...
    protected void Filteremployeepro()
    {
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("select employeemasterid,employeename from employeemaster where DeptID='" + DropDownList10.SelectedValue + "' and employeemasterid='" + Convert.ToInt32(Session["EmployeeId"]) + "'", con);
            DataTable dt = new DataTable();
            da.Fill(dt);

            DropDownList10.DataSource = dt;
            DropDownList10.DataTextField = "employeename";
            DropDownList10.DataValueField = "employeemasterid";
    ...
    protected void ImageButton3_Click111(object sender, ImageClickEventArgs e)
    {
    ...
    {
        string te = "http://license.busiwiz.com/clientadmin/AdminProjectMasterLB.aspx";
        ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", "window.open('" + te + "');", true);
    ...
    //    if (ChckBox1.Checked == true)
    //    {
    //        connection.Open();
    //        try
    //        {
    //            //  DateTime reminderdate = Convert.ToDateTime(txt_reminder.Text);
    //            string strc = "Update ProjectMaster set ProjectMaster_ProjectStatus='Completed' ,ProjectMaster_EndDate='" + System.DateTime.Now.ToShortDateString() + "' where ProjectMaster_Id='" + Session["proid"] + "'";
    //            SqlCommand cmd1 = new SqlCommand(strc, connection);
    ...
    protected void ChckBox1_CheckedChanged1(object sender, EventArgs e)
    {
        if (ChckBox1.Checked == true)
        {
    ...
    protected void Button111_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string audiofile = "";
            //PnlFileAttachLbl.Visible = true;
            if (FileUpload2.HasFile || FileUpload2.HasFile)
            {
                if (FileUpload2.HasFile)
                {
                    filename = FileUpload2.FileName;
                    docfile = FileUpload2.FileName;

                    FileUpload2.PostedFile.SaveAs(Server.MapPath("~\\Clientadmin\\Attach\\") + filename);
                    FileUpload2.PostedFile.SaveAs(Server.MapPath("~/Clientadmin/Uploads/") + filename);
                ...
                {
                    audiofile = FileUpload3.FileName;
                    FileUpload3.PostedFile.SaveAs(Server.MapPath("~\\Clientadmin\\Attach\\") + audiofile);
                    FileUpload3.PostedFile.SaveAs(Server.MapPath("~/Clientadmin/Uploads/") + audiofile);
                }
                //hdnFileName.Value = filename;
    ...
    protected void Button12_Click(object sender, EventArgs e)
    {
        if (ChckBox1.Checked == true)
        {
            ...
            SqlCommand cmd = new SqlCommand(strcln, connection);
            connection.Open();
            cmd.ExecuteNonQuery();
            connection.Close();
            try
        ...
        if (gridstsFileAttach.Rows.Count > 0)
        {
            ...
            foreach (GridViewRow g1 in gridstsFileAttach.Rows)
            {
                ...
                SqlCommand cmd12 = new SqlCommand(str22, connection);
                connection.Open();
