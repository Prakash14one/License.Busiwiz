<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master" AutoEventWireup="true"
    CodeFile="PricePlanCategorySubType.aspx.cs" Inherits="AddProduct" Title="Add Priceplan category type" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <fieldset>
        ...
        <div style="float:right;">
            <asp:Button ID="addnewpanel" runat="server" Text=" Category Sub Type Add / Manage "   CssClass="btnSubmit" onclick="addnewpanel_Click" />
        </div>      
        <asp:Panel ID="pnladdnew" runat="server" Width="100%" Visible="false">
            <table width="100%">               
               <tr>
                    <td style="width: 20%">
                        <label>
                            <asp:Label ID="Label34" runat="server" Text="Unique ID: "></asp:Label>
                            <asp:Label ID="Label35" runat="server" Text="*" CssClass="labelstar"></asp:Label>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtid"  ErrorMessage="*" ValidationGroup="1"></asp:RequiredFieldValidator>
                              <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" Enabled="True"  FilterType="Custom, Numbers" TargetControlID="txtid" ValidChars="012.3456789">
                                        </cc1:FilteredTextBoxExtender>
                        </label>
                    </td>
                    <td colspan="2">
                        <label>
                            <asp:TextBox ID="txtid" runat="server" Width="190px" MaxLength="20"  onkeyup="return check('Span4',20,this)"></asp:TextBox>                               
                        </label>
                        <label>
                         ...
                         <label>
                        <asp:Label ID="lblcatid" runat="server" Visible="false"  ForeColor="Red" Text="You are not allowed to edit this ,first delete child record "></asp:Label>
                        </label> 
                    </td>
                </tr>
                <tr>
                  ...
                  <label>
                            <asp:Label ID="Label2" runat="server" Text="Category Type: "></asp:Label>
                               ...
                               <asp:Label ID="Label16" runat="server" CssClass="labelstar" Text="*"></asp:Label>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlrelatedto"
                ...
                <td>
                          <label>
                                     <asp:DropDownList ID="ddlrelatedto" runat="server"  Width="200PX">
                                            </asp:DropDownList>
                                    </label>
                </td>
                </tr>
                <tr>
                    <td style="width: 20%">
                        <label>
                            <asp:Label ID="Label9" runat="server" Text="Category Sub Type: "></asp:Label>
                            <asp:Label ID="Label51" runat="server" Text="*" CssClass="labelstar"></asp:Label>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtcategorytype"  ErrorMessage="*" ValidationGroup="1"></asp:RequiredFieldValidator>
                            
                        </label>
                    </td>
                    <td colspan="2">
                        <label>
                            <asp:TextBox ID="txtcategorytype" runat="server" Width="190px" MaxLength="50" onKeydown="return mask(event)"
                        ...
                        <label>
                        <asp:Label ID="lblcatetype" runat="server" Visible="false" ForeColor="Red" Text="You are not allowed to edit this ,first delete child record"></asp:Label>
                        </label> 
                    </td>
                </tr>       
                          <tr>
                    ...
                    <td colspan="2">
                        <label style="width:500px">
                            ...
                            <asp:TextBox ID="txtdesc" runat="server" Width="290px" Height="45px" TextMode="MultiLine" MaxLength="500" ></asp:TextBox>
    ...
    <fieldset>
        <legend>
            <asp:Label ID="Label30" runat="server" Text="List of Sub Category Type"></asp:Label>
        </legend>
        <table width="100%">
           
            <tr>
                <td colspan="3" align="right">
                    <asp:Button ID="Button3" runat="server" CssClass="btnSubmit" Text="Printable Version" Visible="false"   OnClick="Button1_Click1" />
            ...
            <tr>
                <td colspan="3">
                        <label>
                          ...
                          <label>
                                     <asp:DropDownList ID="ddltypefilter" runat="server"  Width="200PX" AutoPostBack="True"  OnSelectedIndexChanged="ddlstatus_SelectedIndexChanged" >
                                            </asp:DropDownList>
                                    </label>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" DataKeyNames="UniqueID" AutoGenerateColumns="False"
                                     ...
                                     OnRowDeleting="GridView1_RowDeleting"     AlternatingRowStyle-CssClass="alt" AllowSorting="True" Width="100%" OnSorting="GridView1_Sorting"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="UniqueID" HeaderStyle-HorizontalAlign="Left" HeaderText="Unique ID" SortExpression="ID" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="SunName" HeaderStyle-HorizontalAlign="Left" HeaderText="Category Sub Type" SortExpression="SunName" ItemStyle-Width="25%" />                                           
                                            <asp:BoundField DataField="CategoryType" HeaderStyle-HorizontalAlign="Left" HeaderText="Category Type" SortExpression="CategoryType" ItemStyle-Width="25%" />
                                            <asp:BoundField DataField="Name" HeaderStyle-HorizontalAlign="Left" HeaderText="Category Type RelatedTo" SortExpression="Name" ItemStyle-Width="20%" />
                                            
                                            <asp:BoundField DataField="Description" HeaderStyle-HorizontalAlign="Left" HeaderText="Description" SortExpression="Description" ItemStyle-Width="50%" />
                                            ...
                                            <asp:ButtonField ButtonType="Image" CommandName="edit1" HeaderText="Edit" HeaderStyle-HorizontalAlign="Left" ImageUrl="~/Account/images/edit.gif" Text="Button" HeaderImageUrl="~/Account/images/edit.gif" ItemStyle-Width="4%">
                                              <ItemStyle HorizontalAlign="Left" Width="4%" />
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:ButtonField>
                                               <asp:TemplateField HeaderText="Delete" HeaderImageUrl="~/Account/images/delete.gif" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="4%">
                                                            <ItemTemplate>
