<%@ Page Title="" Language="C#" MasterPageFile="~/Master/LicenseMaster.master" AutoEventWireup="true" CodeFile="TablesandFieldsAutoFetch.aspx.cs" Inherits="Sync_Table_Master" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
 ...
 <ContentTemplate>
     ...
     <asp:Panel ID="Panel2" runat="server">
            ...
            <fieldset><legend>Sync Table Master And Table Detail From SQl Database</legend>
                        ...
                        <label>
                          ...
                          <td style=" width="25%">
                               ...
                               <td style=" width="25%">
                                   ...
                                   <asp:Button ID="Button1" runat="server" Text="Syncronise Tables and Fields" 
                    ...
                    <br />
                     ...
                     <tr>
                         ...
                         <td style="width: 30%; height: 28px;">--%>
                            <label>  
                                 <asp:DropDownList ID="DropDownList3" runat="server" AutoPostBack="True" onselectedindexchanged="DropDownList1_SelectedIndexChanged" Width="200px"
                                 > 
                               </asp:DropDownList>  
                               </label>   
