<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master" AutoEventWireup="true"
    CodeFile="Product_SalesType.aspx.cs" Inherits="AddProduct" Title="Add Product / Version" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <fieldset>
        ...
        <div style="float: right;">
            <asp:Button ID="addnewpanel" runat="server" Text=" Sales Type Add / Manage " 
        ...
        <asp:Panel ID="pnladdnew" runat="server" Width="100%" Visible="false">
            <table width="100%">               
                ...
                <tr>
                    <td style="width: 20%">
                        <label>
                            <asp:Label ID="Label9" runat="server" Text="Sales Type: "></asp:Label>
                            <asp:Label ID="Label51" runat="server" Text="*" CssClass="labelstar"></asp:Label>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSalesType"  ErrorMessage="*" ValidationGroup="1"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="REG1" runat="server" ErrorMessage="Inavalid Character"
                                ...
                                ControlToValidate="txtSalesType" ValidationGroup="1"></asp:RegularExpressionValidator>
                        </label>
                    </td>
                    <td colspan="2">
                        <label>
                            <asp:TextBox ID="txtSalesType" runat="server" Width="190px" MaxLength="50" onKeydown="return mask(event)"
    ...
    <fieldset>
        <legend>
            <asp:Label ID="Label30" runat="server" Text="List of Sales Type"></asp:Label>
        </legend>
        <table width="100%">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="mGrid" PagerStyle-CssClass="pgr"
                                    DataKeyNames="id"  OnRowDeleting="GridView1_RowDeleting" OnRowCommand="GridView1_RowCommand" OnSorting="GridView1_Sorting"    AlternatingRowStyle-CssClass="alt" AllowSorting="True" Width="100%" 
                                        EmptyDataText="No Record Found.">
                                        <Columns>
                                            <asp:BoundField DataField="Name" HeaderStyle-HorizontalAlign="Left" HeaderText="Server Status Name" SortExpression="Name" ItemStyle-Width="90%" />
