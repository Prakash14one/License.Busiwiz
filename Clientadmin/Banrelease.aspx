                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td>
                                    ...
                                    <asp:DropDownList ID="ddlcompanylist" runat="server" Visible="false">
                                    </asp:DropDownList>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                                    ...
                                                    <Columns>
                                                      <asp:TemplateField HeaderText="ID" SortExpression="Id" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Ban Status" SortExpression="BanIsActive" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblbanstatus" runat="server" Visible="false" Text='<%#Bind("BanIsActive") %>'></asp:Label>
                                                                <asp:Label ID="lblbanstatusdisplay" runat="server"  Text='<%#Bind("BanIsActivedisplay") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Remove Ban"  HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
