<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master" AutoEventWireup="true"
    CodeFile="ReprotmasterRecipentEmployeeAddManage1.aspx.cs" Inherits="Page_Master" Title="PageMaster - Add,Manage" %>
                    ...
                    <table width="100%">
                      ...
                      <label style="width:120px">  
                       ...
                       <label>
                        ...
                        <td>
                        <label>
                        Link to Functionality <asp:CheckBox ID="chkuploadFunction" runat="server" AutoPostBack="True" OnCheckedChanged="chkupload_CheckedChanged"></asp:CheckBox>
