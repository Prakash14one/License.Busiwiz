...
public partial class Banrelease : System.Web.UI.Page
{
    ...
    {
        string str = "select *,case when ( bannedmacaddress='0') then 'No' else 'Yes' end as bannedmacaddressdisplay,case when ( bannedipaddress='0') then 'No' else 'Yes' end as bannedipaddressdisplay,case when ( BanIsActive='0') then 'Inactive' else 'Active' end as BanIsActivedisplay from Permenatalybanmacaddressandipadress where Id<>''   ";
        string strcid = "";
        string strcomputer = "";
        string strpubip = "";
        string strpriip = "";
        ...
        string finalstr = str + strcid + strcomputer + strpubip + strpriip + strbanstatus + strdatetime + "Order By Id Desc";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Remove")
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                string strftpdetail = " SELECT    DISTINCT dbo.ServerMasterTbl.* FROM dbo.CompanyMaster INNER JOIN dbo.ServerMasterTbl ON dbo.CompanyMaster.ServerId = dbo.ServerMasterTbl.Id where dbo.ServerMasterTbl.Status='1'  Order By dbo.ServerMasterTbl.id Desc ";
                ...
                {
                    string strlicense = " update Permenatalybanmacaddressandipadress set BanIsActive='0',bannedipaddress='0',bannedmacaddress='0' where  Ipaddress='" + id + "' OR MacAddress='" + MacAddress + "'";// MacAddress='" + MacAddress + "' and Ipaddress='" + Ipaddress + "' and computerip='" + computerip + "' and computername='" + computername + "' and bannedmacaddress='" + bannedmacaddress + "' and bannedipaddress='" + bannedipaddress + "' and BanIsActive='1' ";
                    ...
                    foreach (DataRow dr in dtftpdetail.Rows)
                    {
                        ...
                        string strupdate = "  update Permenatalybanmacaddressandipadress set BanIsActive='0',bannedipaddress='0',bannedmacaddress='0' where  Ipaddress='" + id + "' OR MacAddress='" + MacAddress + "'";// MacAddress='" + MacAddress + "' and Ipaddress='" + Ipaddress + "' and computerip='" + computerip + "' and computername='" + computername + "' and bannedmacaddress='" + bannedmacaddress + "' and bannedipaddress='" + bannedipaddress + "' and BanIsActive='1' ";
