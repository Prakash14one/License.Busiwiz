<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master" AutoEventWireup="true"
    CodeFile="Priceplancategorytype.aspx.cs" Inherits="AddProduct" Title="Add Priceplan category type" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <fieldset>
        ...
        <div style="float: right;">
            <asp:Button ID="addnewpanel" runat="server" Text=" Category Type Add / Manage " 
        ...
        <asp:Panel ID="pnladdnew" runat="server" Width="100%" Visible="false">
            <table width="100%">               
               <tr>
                ...
                <td>
                  <label>
                            <asp:Label ID="Label2" runat="server" Text="Category Related To: "></asp:Label>
                            </label>
                ...
                <tr>
                    <td style="width: 20%">
                        <label>
                            <asp:Label ID="Label9" runat="server" Text="Category Type: "></asp:Label>
    ...
    <fieldset>
        <legend>
            <asp:Label ID="Label30" runat="server" Text="List of Category Type"></asp:Label>
        </legend>
        <table width="100%">
                                ...
                                <td>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" AutoGenerateColumns="False"
                                     ...
                                     OnRowDeleting="GridView1_RowDeleting"     AlternatingRowStyle-CssClass="alt" AllowSorting="True" Width="100%" OnSorting="GridView1_Sorting"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="ID" HeaderStyle-HorizontalAlign="Left" HeaderText="Unique ID" SortExpression="ID" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="Name" HeaderStyle-HorizontalAlign="Left" HeaderText="Name" SortExpression="ID" ItemStyle-Width="10%" />                                           
                                            <asp:BoundField DataField="CategoryType" HeaderStyle-HorizontalAlign="Left" HeaderText="Category Type" SortExpression="CategoryType" ItemStyle-Width="30%" />
