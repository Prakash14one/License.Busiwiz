...
public partial class MainMenuMaster : System.Web.UI.Page
{
    ...
    protected void FilterProduct()
    {
        ...
        FilterProductname.DataValueField = "WebsiteSectionId";
        FilterProductname.DataTextField = "productversion";//MasterPage_Name
    ...
    protected void FillProduct()
    {
        ...
        ddlWebsiteSection.DataValueField = "WebsiteSectionId";//WebsiteSectionId
    ...
    protected void FillCategory()
    {
        try
        {
            string strlan = "select * from Mainmenucategory where MasterPage_Id='" + ddlMaster.SelectedValue + "' and Active=1 ";
            SqlCommand cmdlan = new SqlCommand(strlan, con);
            SqlDataAdapter adplan = new SqlDataAdapter(cmdlan);
            DataSet dslan = new DataSet();
            adplan.Fill(dslan);
    ...
    protected void fillMasterPageSearch()
    {
        ...
        {
            string str = "select * from MasterPageMaster Where WebsiteSectionId='" + FilterProductname.SelectedValue + "' ";
            SqlCommand cmd = new SqlCommand(str, con);
            SqlDataAdapter adp = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            adp.Fill(ds);
            DDLmasterpageL.DataSource = ds;
            ...
            DDLmasterpageL.Items[0].Value = "0";

        }
        else
        {
            DDLmasterpageL.DataSource = null;
            DDLmasterpageL.DataTextField = "MasterPageName";
            DDLmasterpageL.DataValueField = "MasterPageId";
            DDLmasterpageL.DataBind();
            DDLmasterpageL.Items.Insert(0, "-Select-");
    ...
    {
        string str1 = "select * from [MainMenuMaster] where MainMenuName='" + txtMainMenuName.Text + "' and MasterPage_Id='" + ddlMaster.SelectedValue + "' ";
        ...
        else
        {
            ...
            string SubMenuInsert = "Insert Into MainMenuMaster (MainMenuName,BackColour,MainMenuTitle,MasterPage_Id,MainMenuIndex,Active,LanguageId, MainMenucatId) values ('" + txtMainMenuName.Text + "','" + txtBackgroundColor.Text + "','" + txtMainMenuTitle.Text + "','" + ddlMaster.SelectedValue + "','" + txtMenuIndex.Text + "','" + CheckBox1.Checked + "','" + ddlanguage.SelectedValue + "','" + ddlcategory.SelectedValue + "')";
    ...
    protected void Fillgrid()
    {
        ...
        {
            categs = " and MainMenuMaster.MainMenucatId='"+ DDLCategoryS.SelectedValue +"' ";
        }
        if (DDLmasterpageL.SelectedIndex > 0)
        {
          //  categs = " and MainMenuMaster.MainMenucatId='" + DDLmasterpageL.SelectedValue + "' ";
        }

        if (FilterProductname.SelectedIndex > -1)
        {
            str = "select MainMenuMaster.*,MasterPageMaster.MasterPageName,LanguageMaster.Name,LanguageMaster.Id  from MainMenuMaster inner join MasterPageMaster on MasterPageMaster.MasterPageId=MainMenuMaster.MasterPage_Id inner join WebsiteSection on MasterPageMaster.WebsiteSectionId=WebsiteSection.WebsiteSectionId inner join WebsiteMaster on WebsiteMaster.ID=WebsiteSection.WebsiteMasterId inner join VersionInfoMaster on VersionInfoMaster.VersionInfoId=WebsiteMaster.VersionInfoId  inner join ProductMaster on ProductMaster.ProductId=VersionInfoMaster.ProductId inner join ProductDetail on ProductDetail.ProductId=ProductMaster.ProductId  left outer join LanguageMaster on LanguageMaster.Id = MainMenuMaster.LanguageId where dbo.WebsiteSection.WebsiteSectionId='" + FilterProductname.SelectedValue + "' and ProductMaster.ClientMasterId='" + Session["ClientId"] + "' and ProductDetail.Active='1'  ";
        }
        else
        {
        ...
        if (ddlactivestatus.SelectedValue == "0")
        {
            ...
            stractive = "and MainMenuMaster.Active='0'";
        }
        if (ddlactivestatus.SelectedValue == "1")
        {
            stractive = "and MainMenuMaster.Active='1'";
        }

        lblproductname.Text = FilterProductname.SelectedItem.Text;
        lblstatus.Text = ddlactivestatus.SelectedItem.Text;

        string orderby = "order by MainMenuMaster.MainMenuIndex,MainMenuMaster.MainMenuTitle,MasterPageMaster.MasterPageName,LanguageMaster.Name";
    ...
    {
        SqlDataAdapter adp = new SqlDataAdapter("select Count(MainMenuId) as MainMenuId from MainMenuMaster where MasterPage_Id='" + ddlMaster.SelectedValue + "'", con);
        DataTable ds = new DataTable();
        adp.Fill(ds);

        if (ds.Rows.Count > 0)
        {
            int a = Convert.ToInt32(ds.Rows[0]["MainMenuId"].ToString()) + 1;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Delete")
        {
                    ...
                    string stpageall = "select *  from SubMenuMaster  where MainMenuId='" + mm + "'";
                    ...
                    if (iikt == 0)
                    {
                        string st2 = "Delete from MainMenuMaster where MainMenuId=" + mm;
        ...
        if (e.CommandName == "Edit")
        {
            ...
            SqlDataAdapter adp = new SqlDataAdapter("select MainMenuMaster.*,MasterPageMaster.MasterPageId,WebsiteSection.WebsiteSectionId,MasterPageMaster.MasterPageName,LanguageMaster.Name,LanguageMaster.Id  from MainMenuMaster inner join MasterPageMaster on MasterPageMaster.MasterPageId=MainMenuMaster.MasterPage_Id inner join WebsiteSection on MasterPageMaster.WebsiteSectionId=WebsiteSection.WebsiteSectionId inner join WebsiteMaster on WebsiteMaster.ID=WebsiteSection.WebsiteMasterId inner join VersionInfoMaster on VersionInfoMaster.VersionInfoId=WebsiteMaster.VersionInfoId  inner join ProductMaster on ProductMaster.ProductId=VersionInfoMaster.ProductId left outer join LanguageMaster on LanguageMaster.Id = MainMenuMaster.LanguageId  where ProductMaster.ClientMasterId='" + Session["ClientId"] + "' and MainMenuId='" + mm1 + "'", con);
            DataTable ds = new DataTable();
            adp.Fill(ds);
            ...
            try
            {
                ddlcategory.SelectedValue  = ds.Rows[0]["MainMenucatId"].ToString();
            }
            catch (Exception ex)
            {
            }           
            ...
            txtMainMenuName.Text = ds.Rows[0]["MainMenuName"].ToString();
            txtBackgroundColor.Text = ds.Rows[0]["BackColour"].ToString();
            txtMainMenuTitle.Text = ds.Rows[0]["MainMenuTitle"].ToString();
            txtMenuIndex.Text = ds.Rows[0]["MainMenuIndex"].ToString();
            FillCategory(); 
            ddlanguage.SelectedIndex = ddlanguage.Items.IndexOf(ddlcategory.Items.FindByValue(ds.Rows[0]["MainMenuIndex"].ToString()));            
        }
    }
    ...
    {
        string str1 = "select * from [MainMenuMaster] where MainMenuName='" + txtMainMenuName.Text + "' and MasterPage_Id='" + ddlMaster.SelectedValue + "' and MainMenuId<>'" + ViewState["MasterId"].ToString() + "' ";
        ...
        else
        {
            ...
            string sr51 = ("update MainMenuMaster set MainMenuName='" + txtMainMenuName.Text + "',BackColour='" + txtBackgroundColor.Text + "',MainMenuTitle='" + txtMainMenuTitle.Text + "',MasterPage_Id='" + ddlMaster.SelectedValue + "',MainMenuIndex='" + txtMenuIndex.Text + "', LanguageId = '" + ddlanguage.SelectedValue + "' ,Active='" + CheckBox1.Checked + "' ,MainMenucatId='"+ ddlcategory.SelectedValue +"' where MainMenuId='" + ViewState["MasterId"].ToString() + "' ");
            SqlCommand cmd801 = new SqlCommand(sr51, con);
    ...
    protected void btndosyncro_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt1 = select("SELECT DISTINCT SatelliteSyncronisationrequiringTablesMaster.Id FROM ClientProductTableMaster INNER JOIN SatelliteSyncronisationrequiringTablesMaster ON ClientProductTableMaster.Id = SatelliteSyncronisationrequiringTablesMaster.TableID where SatelliteSyncronisationrequiringTablesMaster.Status='1' ");//and ClientProductTableMaster.TableName='MainMenuMaster' 
        if (dt1.Rows.Count > 0)
        {
