...
public partial class ShoppingCart_Admin_ForgotPassword : System.Web.UI.Page
{
            ...
            if (ans1 == txtans1.Text && ans2 == txtans2.Text && ans3 == txtans3.Text)
            {
                ...
                else
                {
                    ...
                    if (email != "")
                    {
                        ...
                        Response.Redirect("http://" + Request.Url.Host.ToString() + "/Shoppingcart/admin/ResetPasswordUser.aspx?to=" + ClsEncDesc.Encrypted(ViewState["maxid"].ToString()) + "");
    ...
    public void sendmail(string To)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            body = body + "<br><span style=\"font-size:14px; font-family:Calibri; text-align:left\">You have requested to Reset your Login information in the following account:</span><br><br> ";
