<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master" AutoEventWireup="true"
    CodeFile="MainMenuMasterCategory.aspx.cs" Inherits="MainMenuMaster" Title="Product Main Menu-Add,Manage" %>
            ...
            <div class="products_box">
                ...
                <fieldset>
                    ...
                    <div style="float: right;">
                        <asp:Button ID="addnewpanel" runat="server" Text="Add Main Menu Category" CssClass="btnSubmit" OnClick="addnewpanel_Click" />
                    ...
                    <asp:Panel ID="pnladdnew" runat="server" Width="100%" Visible="false">
                        <table width="100%">
                            ...
                            <tr>
                                <td style="width: 30%">
                                    <label>
                                        <asp:Label ID="Label6" runat="server" Text="Menu Category Title"></asp:Label>
                            ...
                            <tr>
                                <td style="width: 30%">
                                    <label>
                                        <asp:Label ID="Label7" runat="server" Text="Menu Category index"></asp:Label>
                            ...
                            <tr>
                                <td style="width: 30%">
                                    <label>
                                        <asp:Label ID="Label26" runat="server" Text="Menu Category Description"></asp:Label>
                                        <asp:Label ID="Label27" runat="server" Text="*" CssClass="labelstar"></asp:Label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtMenuIndex"
                                            ErrorMessage="*" ValidationGroup="1" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </label>
                                </td>
                                <td style="width: 70%">
                                    <label>
                                        <asp:TextBox ID="txt_desc" runat="server" Width="170px" 
                ...
                <fieldset>
                    <legend>
                        <asp:Label ID="Label10" runat="server" Text="List Of Main Menu Category"></asp:Label>
                    </legend>
                    <table width="100%">
                        <tr>
                            <td align="right">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                                    ...
                                                    DataKeyNames="MainMenucatId" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing"
                                                    OnRowUpdating="GridView1_RowUpdating" OnRowCommand="GridView1_RowCommand" EmptyDataText="No Record Found."
                                                    AllowSorting="True" OnSorting="GridView1_Sorting">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Category Title" SortExpression="MainMenuCatName" HeaderStyle-HorizontalAlign="Left"
                                                            ItemStyle-Width="17%" >
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblmainmenuName" runat="server" Text='<%#Bind("MainMenuCatName") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <%--<EditItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Category Title" SortExpression="MainMenuCatTitle" HeaderStyle-HorizontalAlign="Left"
                                                            ItemStyle-Width="17%" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblMainMenuTitle" runat="server" Text='<%#Bind("MainMenuCatTitle") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <%--<EditItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Category Index" SortExpression="MainMenuCatIndex" HeaderStyle-HorizontalAlign="Left"
                                                            ItemStyle-HorizontalAlign="Left" ItemStyle-Width="12%">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblMenuIn" Width="30px" runat="server" Text='<%#Bind("MainMenuCatIndex") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <%--<EditItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Edit" HeaderImageUrl="~/Account/images/edit.gif" HeaderStyle-HorizontalAlign="Left"
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Account/images/edit.gif"
                                                                    CommandName="Edit" CommandArgument='<%# Eval("MainMenucatId") %>' ToolTip="Edit" />
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Delete" HeaderImageUrl="~/images/trash.jpg" HeaderStyle-HorizontalAlign="Left"
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="llinkbb" runat="server" CommandName="Delete" ImageUrl="~/Account/images/delete.gif"
                                                                    OnClientClick="return confirm('Do you wish to delete this record?');" CommandArgument='<%# Eval("MainMenucatId") %>'
