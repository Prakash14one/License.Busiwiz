<%@ Page Language="C#" MasterPageFile="~/Master/LicenseMaster.master" AutoEventWireup="true"
    CodeFile="WebsitePublish.aspx.cs" Inherits="WesitePublish" Title="Untitled Page" %>
        ...
        <ContentTemplate>
            <div style="float: left;">
                <asp:Label ID="lblmsg" runat="server" ForeColor="Red" Font-Size="16px"></asp:Label>
                  <asp:Label ID="lblfolder" runat="server" ForeColor="Red" Font-Size="16px" Text=" The files from the following folders were not deleted as the folders were not found. Please check whether the folder exists : " Visible="false"></asp:Label>
            </div>
