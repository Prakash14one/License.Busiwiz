...
public partial class Page_Master : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       Session["ClientId"] = "35";
        ...
        if (!IsPostBack)
        {
            lblVersion.Text = "This PageVersion Is V4  Date:3March2016 Develop By @pk";
            lblpagename.Text = "";
            ...
            try
            {
                ...
                if (btnSubmit.Text == "Update")
                {
                    ...
                    if (dtall.Rows.Count == 0)
                    {
                        ...
                        {
                            string str = "update   PageMaster set  LanguageId = '" + ddlanguage.SelectedValue + "',PageName= '" + txtpagename.Text + "' ,PageTitle='" + txtpagetitle.Text + "', PageDescription='" + txtpagedescriptin.Text + "',pageIndex='" + txtpageindex.Text + "',VersionInfoMasterId='" + ViewState["VersionInfoId"].ToString() + "',MainMenuId='" + ddlMainMenu.SelectedValue + "',FolderName='" + txtFolderName.Text + "',Active='" + chkactive.Checked + "',SubMenuId='0',ManuAccess='" + chkmanuaccess.Checked + "',labelimage='" + Label37.Text + "' where pageid='" + ViewState["pageid"] + "'";
                            SqlCommand cmd = new SqlCommand(str, con);
                            con.Open();
                            cmd.ExecuteNonQuery();
                            con.Close();
                    ...
                    if (dtall.Rows.Count == 0)
                    {
                        ...
                        else
                        {
                            string str = "INSERT INTO PageMaster(PageName,PageTitle,PageDescription,PageIndex,VersionInfoMasterId,MainMenuId,FolderName,Active,LanguageId,ManuAccess,labelimage) " +
                                      "VALUES('" + txtpagename.Text + "','" + txtpagetitle.Text + "','" + txtpagedescriptin.Text + "','" + txtpageindex.Text + "','" + ViewState["VersionInfoId"].ToString() + "','" + ddlMainMenu.SelectedValue + "','" + txtFolderName.Text + "','" + chkactive.Checked + "','" + ddlanguage.SelectedValue + "','" + chkmanuaccess.Checked + "','"+Label37.Text+"')";
                            SqlCommand cmd = new SqlCommand(str, con);
                            con.Open();
                            cmd.ExecuteNonQuery();
                            con.Close();
