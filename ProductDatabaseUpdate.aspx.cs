        ...
        int stepcount = 0;
          try
          {
                 ...
                 if (Bool_DetachDAtabase == true)
                 {
                     ...
                     try
                     {
                         File.Copy(MDF_OriginalPath, MDF_Temppathforcopy, true);
                         File.Copy(LDF_OriginalPath, LDF_Temppathforcopy, true);
                         stepcount++;
                     }
                     catch
                     {
                     ...
                     try
                     {
                           if(stepcount==4)
                         {
                         File.Copy(MDF_Temppathforcopy, MDF_OutputPath, true);
                         File.Copy(LDF_Temppathforcopy, LDF_OutputPath, true);
                         stepcount++;
                           }
                     }
                     catch
